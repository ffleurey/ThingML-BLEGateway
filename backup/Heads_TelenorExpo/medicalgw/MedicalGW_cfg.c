...
case 2:
if(msgSize == 2) {
dispatch_MqttRequestWeightMeasurement(listener_id
);
}
break;
case 3:
if(msgSize == 2) {
dispatch_MqttConfirmWeightMeasurement(listener_id
);
}
break;
}
...
enqueue_ANDUC352BLEImpl_Tellu_MqttRequestWeightMeasurement(&weightscale_var);
...
if (sender == hci_var.id_ATT) {
enqueue_ANDUA651BLEImpl_ATT_ATTWriteResponse(&bloodpressure_var, ConnectionHandle);
...
if (sender == MQTT2_instance.listener_id) {
enqueue_ANDUC352BLEImpl_Tellu_MqttConfirmWeightMeasurement(&weightscale_var);
...
//bloodpressure_var.ANDUA651BLEImpl_Address_var = "5C:31:3E:00:4E:4A";
bloodpressure_var.ANDUA651BLEImpl_Address_var = "5C:31:3E:03:54:2F";
bloodpressure_var.ANDUA651BLEImpl_NotifierAddressType_var = BLEADDRESSTYPE_RANDOM;
bloodpressure_var.ANDUA651BLEImpl_NotifierAddress_var = "FF:A5:75:4E:6F:08";
