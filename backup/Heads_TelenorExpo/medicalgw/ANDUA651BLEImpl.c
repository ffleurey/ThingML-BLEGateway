...
/*
  static ble_random_number_t peer_ltk = { 0xD2, 0x3F, 0xCA, 0x1C, 0xEF, 0x96, 0x15, 0xCE, 0x76, 0x4F, 0x28, 0x67, 0x09, 0x1D, 0xE3, 0x86, };
  static uint16_t peer_ediv = 0x95CB;
  static ble_random_part_t peer_random = { 0xEE, 0x6F, 0xF5, 0x4D, 0x10, 0xC7, 0x06, 0x0F, };
*/
  ble_random_number_t peer_ltk = { 0x34, 0xB1, 0x3C, 0x54, 0xFC, 0x52, 0xD0, 0xC2, 0x7A, 0x5F, 0x68, 0x62, 0x3D, 0xAD, 0xFC, 0x51, };
  uint16_t peer_ediv = 0xE082;
  ble_random_part_t peer_random = { 0xB5, 0x4B, 0xA4, 0x77, 0x81, 0xF8, 0xFB, 0xA0, };
...
//End Region Notify
ANDUA651BLEImpl_States_State_event_consumed = 0 | ANDUA651BLEImpl_States_Notify_State_event_consumed ;
//End dsregion Notify
if (ANDUA651BLEImpl_States_State_event_consumed == 0 && 1) {
...
//End Region Sync
ANDUA651BLEImpl_States_State_event_consumed = 0 | ANDUA651BLEImpl_States_Sync_State_event_consumed ;
//End dsregion Sync
if (ANDUA651BLEImpl_States_State_event_consumed == 0 && 1) {
...
void enqueue_ANDUA651BLEImpl_Tellu_MqttConfirmBloodPressureMeasurement(struct ANDUA651BLEImpl_Instance * inst) {
    ...
    if ( fifo_byte_available(&(inst->fifo)) > 4 ) {
        ...
        _fifo_enqueue(&(inst->fifo), (99 >> 8) & 0xFF );
        _fifo_enqueue(&(inst->fifo), 99 & 0xFF );
...
void enqueue_ANDUA651BLEImpl_ATT_ATTWriteResponse(struct ANDUA651BLEImpl_Instance * inst, uint16_t ConnectionHandle) {
    fifo_lock(&(inst->fifo));
...
switch(portID) {
case 5:{
ANDUA651BLEImpl_handle_ATT_ATTWriteResponse(_instance,
