...
u_Rand.p = Rand;
_fifo_enqueue(&(inst->fifo), u_Rand.bytebuffer[15] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Rand.bytebuffer[14] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Rand.bytebuffer[13] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Rand.bytebuffer[12] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Rand.bytebuffer[11] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Rand.bytebuffer[10] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Rand.bytebuffer[9] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Rand.bytebuffer[8] & 0xFF );
...
u_IAT.p = IAT;
_fifo_enqueue(&(inst->fifo), u_IAT.bytebuffer[0] & 0xFF );
...
u_IA.p = IA;
_fifo_enqueue(&(inst->fifo), u_IA.bytebuffer[5] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_IA.bytebuffer[4] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_IA.bytebuffer[3] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_IA.bytebuffer[2] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_IA.bytebuffer[1] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_IA.bytebuffer[0] & 0xFF );
...
u_RAT.p = RAT;
_fifo_enqueue(&(inst->fifo), u_RAT.bytebuffer[0] & 0xFF );
...
u_RA.p = RA;
_fifo_enqueue(&(inst->fifo), u_RA.bytebuffer[5] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_RA.bytebuffer[4] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_RA.bytebuffer[3] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_RA.bytebuffer[2] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_RA.bytebuffer[1] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_RA.bytebuffer[0] & 0xFF );
    }
    fifo_unlock_and_notify(&(inst->fifo));
}
...
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[15] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[14] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[13] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[12] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[11] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[10] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[9] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[8] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[7] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[6] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[5] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[4] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[3] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[2] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[1] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Received.bytebuffer[0] & 0xFF );
...
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[15] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[14] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[13] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[12] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[11] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[10] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[9] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[8] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[7] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[6] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[5] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[4] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[3] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[2] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[1] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Calculated.bytebuffer[0] & 0xFF );
    }
    fifo_unlock_and_notify(&(inst->fifo));
}
...
u_Srand.p = Srand;
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[15] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[14] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[13] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[12] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[11] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[10] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[9] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[8] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[7] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[6] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[5] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[4] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[3] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[2] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[1] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Srand.bytebuffer[0] & 0xFF );
...
u_Mrand.p = Mrand;
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[15] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[14] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[13] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[12] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[11] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[10] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[9] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[8] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[7] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[6] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[5] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[4] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[3] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[2] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[1] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Mrand.bytebuffer[0] & 0xFF );
    }
    fifo_unlock_and_notify(&(inst->fifo));
}
...
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[15] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[14] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[13] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[12] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[11] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[10] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[9] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[8] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[7] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[6] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[5] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[4] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[3] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[2] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[1] & 0xFF );
_fifo_enqueue(&(inst->fifo), u_Encrypted.bytebuffer[0] & 0xFF );
    }
    fifo_unlock_and_notify(&(inst->fifo));
}
...
switch(portID) {
case 0:{
BLEEncryptionImpl_handle_Encrypter_Start(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 0:{
BLEEncryptionImpl_handle_Encrypter_GenerateRandomNumber(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 0:{
BLEEncryptionImpl_handle_Encrypter_GenerateConfirm(_instance,
...
switch(portID) {
case 0:{
BLEEncryptionImpl_handle_Encrypter_CheckConfirm(_instance,
...
switch(portID) {
case 0:{
BLEEncryptionImpl_handle_Encrypter_GenerateSTK(_instance,
...
switch(portID) {
case 1:{
BLEEncryptionImpl_handle_Socket_Opened(_instance,
...
switch(portID) {
case 1:{
BLEEncryptionImpl_handle_Socket_Closed(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 2:{
BLEEncryptionImpl_handle_HCIEvents_LERandCompleted(_instance,
...
switch(portID) {
case 2:{
BLEEncryptionImpl_handle_HCIEvents_LEEncryptCompleted(_instance,
...
BLEEncryptionImpl_States_OnEntry(_instance->initState, _instance);
}
    while(1){
        BLEEncryptionImpl_processMessageQueue(_instance);
    }
}
