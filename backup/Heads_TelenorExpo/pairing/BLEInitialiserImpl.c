...
switch(portID) {
case 0:{
BLEInitialiserImpl_handle_Initialiser_Start(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 0:{
BLEInitialiserImpl_handle_Initialiser_Stop(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 1:{
BLEInitialiserImpl_handle_Socket_Opened(_instance,
...
switch(portID) {
case 1:{
BLEInitialiserImpl_handle_Socket_Closed(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 2:{
BLEInitialiserImpl_handle_HCIEvents_ResetCompleted(_instance,
...
switch(portID) {
case 2:{
BLEInitialiserImpl_handle_HCIEvents_SetEventMaskCompleted(_instance,
...
switch(portID) {
case 2:{
BLEInitialiserImpl_handle_HCIEvents_SetLEEventMaskCompleted(_instance,
...
BLEInitialiserImpl_States_OnEntry(_instance->initState, _instance);
}
    while(1){
        BLEInitialiserImpl_processMessageQueue(_instance);
    }
}
