...
uint8_t BLEConnecterImpl_ConnectToAddressType_var;
bdaddr_t BLEConnecterImpl_ConnectToAddress_var;
...
#define BLECONNECTERIMPL_STATES_CONNECTED_STATE 3
#define BLECONNECTERIMPL_STATES_DISCONNECTING_STATE 4
#define BLECONNECTERIMPL_STATES_CLOSED_STATE 5
#define BLECONNECTERIMPL_STATES_FAILURE_STATE 6
