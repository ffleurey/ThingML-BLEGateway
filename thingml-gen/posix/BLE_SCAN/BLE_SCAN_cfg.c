 ...
 *      Implementation for Application BLE_SCAN
...
/*****************************************************************************
 * Definitions for configuration : BLE_SCAN
 *****************************************************************************/
...
//Instance scanner
// Variables for the properties of the instance
struct Scanner_Instance scanner_var;
// Variables for the sessions of the instance
//Instance handler
// Variables for the properties of the instance
...
// Enqueue of messages Scanner::Signals::Quit
void enqueue_Scanner_send_Signals_Quit(struct Scanner_Instance *_instance, int16_t code){
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
// Enqueue of messages Scanner::Socket::Open
void enqueue_Scanner_send_Socket_Open(struct Scanner_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Scanner::Socket::Close
void enqueue_Scanner_send_Socket_Close(struct Scanner_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Scanner::HCICommands::LERand
void enqueue_Scanner_send_HCICommands_LERand(struct Scanner_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Scanner::HCICommands::LECreateConnectionCancel
void enqueue_Scanner_send_HCICommands_LECreateConnectionCancel(struct Scanner_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Scanner::HCICommands::SetEventMaskAll
void enqueue_Scanner_send_HCICommands_SetEventMaskAll(struct Scanner_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Scanner::HCICommands::SetLEAdvertisingData
void enqueue_Scanner_send_HCICommands_SetLEAdvertisingData(struct Scanner_Instance *_instance, uint8_t Length, ble_adv_data_t Data){
fifo_lock();
...
// Enqueue of messages Scanner::HCICommands::SetLEScanParameters
void enqueue_Scanner_send_HCICommands_SetLEScanParameters(struct Scanner_Instance *_instance, uint8_t Type, uint16_t Interval, uint16_t Window, uint8_t OwnAddressType, uint8_t FilterPolicy){
fifo_lock();
...
// Enqueue of messages Scanner::HCICommands::SetEventMask
void enqueue_Scanner_send_HCICommands_SetEventMask(struct Scanner_Instance *_instance, set_event_mask_cp Mask){
fifo_lock();
...
// Enqueue of messages Scanner::HCICommands::SetLEAdvertiseEnable
void enqueue_Scanner_send_HCICommands_SetLEAdvertiseEnable(struct Scanner_Instance *_instance, uint8_t Enable){
fifo_lock();
...
// Enqueue of messages Scanner::HCICommands::SetLEEventMaskAll
void enqueue_Scanner_send_HCICommands_SetLEEventMaskAll(struct Scanner_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Scanner::HCICommands::Reset
void enqueue_Scanner_send_HCICommands_Reset(struct Scanner_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Scanner::HCICommands::SetLEScanResponseData
void enqueue_Scanner_send_HCICommands_SetLEScanResponseData(struct Scanner_Instance *_instance, uint8_t Length, ble_adv_data_t Data){
fifo_lock();
if ( fifo_byte_available() > 36 ) {
...
// Enqueue of messages Scanner::HCICommands::LEEncrypt
void enqueue_Scanner_send_HCICommands_LEEncrypt(struct Scanner_Instance *_instance, ble_random_number_t Key, ble_random_number_t Plaintext){
fifo_lock();
if ( fifo_byte_available() > 36 ) {
...
// Enqueue of messages Scanner::HCICommands::Disconnect
void enqueue_Scanner_send_HCICommands_Disconnect(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint8_t Reason){
fifo_lock();
if ( fifo_byte_available() > 7 ) {
...
// Enqueue of messages Scanner::HCICommands::SetLEAdvertisementParameters
void enqueue_Scanner_send_HCICommands_SetLEAdvertisementParameters(struct Scanner_Instance *_instance, uint16_t MinInterval, uint16_t MaxInterval, uint8_t Type, uint8_t OwnAddressType, uint8_t PeerAddressType, bdaddr_t PeerAddress, uint8_t Channel, uint8_t FilterPolicy){
fifo_lock();
...
// Enqueue of messages Scanner::HCICommands::SetLEEventMask
void enqueue_Scanner_send_HCICommands_SetLEEventMask(struct Scanner_Instance *_instance, set_event_mask_cp Mask){
fifo_lock();
if ( fifo_byte_available() > 12 ) {
...
// Enqueue of messages Scanner::HCICommands::SetLEScanEnable
void enqueue_Scanner_send_HCICommands_SetLEScanEnable(struct Scanner_Instance *_instance, uint8_t Enable, uint8_t FilterDuplicates){
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
// Enqueue of messages Scanner::HCICommands::LEStartEncryption
void enqueue_Scanner_send_HCICommands_LEStartEncryption(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, ble_random_part_t Random, uint16_t EDIV, ble_random_number_t LTK){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages Scanner::HCICommands::SetLocalName
void enqueue_Scanner_send_HCICommands_SetLocalName(struct Scanner_Instance *_instance, change_local_name_cp Name){
fifo_lock();
...
// Enqueue of messages Scanner::SMP::SMPPairingResponse
void enqueue_Scanner_send_SMP_SMPPairingResponse(struct Scanner_Instance *_instance, uint16_t Handle, uint8_t IOCapability, uint8_t OOBDataPresent, uint8_t Bonding, uint8_t MITM, uint8_t SecureConnection, uint8_t Keypress, uint8_t MaximumEncryptionKeySize, uint8_t InitiatorKeyDistribution, uint8_t ResponderKeyDistribution){
fifo_lock();
if ( fifo_byte_available() > 15 ) {
...
// Enqueue of messages Scanner::SMP::SMPPairingPublicKey
void enqueue_Scanner_send_SMP_SMPPairingPublicKey(struct Scanner_Instance *_instance, uint16_t Handle, smp_public_key_t KeyX, smp_public_key_t KeyY){
fifo_lock();
if ( fifo_byte_available() > 70 ) {
...
// Enqueue of messages Scanner::SMP::SMPMasterIdentification
void enqueue_Scanner_send_SMP_SMPMasterIdentification(struct Scanner_Instance *_instance, uint16_t Handle, uint16_t EDIV, ble_random_part_t Rand){
fifo_lock();
if ( fifo_byte_available() > 16 ) {
...
// Enqueue of messages Scanner::SMP::SMPIdentityInformation
void enqueue_Scanner_send_SMP_SMPIdentityInformation(struct Scanner_Instance *_instance, uint16_t Handle, ble_random_number_t IdentityResolvingKey){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages Scanner::SMP::SMPSigningInformation
void enqueue_Scanner_send_SMP_SMPSigningInformation(struct Scanner_Instance *_instance, uint16_t Handle, ble_random_number_t SignatureKey){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages Scanner::SMP::SMPPairingDHKeyCheck
void enqueue_Scanner_send_SMP_SMPPairingDHKeyCheck(struct Scanner_Instance *_instance, uint16_t Handle, ble_random_number_t DHKeyCheck){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages Scanner::SMP::SMPKeypressNotification
void enqueue_Scanner_send_SMP_SMPKeypressNotification(struct Scanner_Instance *_instance, uint16_t Handle, uint8_t Type){
fifo_lock();
if ( fifo_byte_available() > 7 ) {
...
// Enqueue of messages Scanner::SMP::SMPEncryptionInformation
void enqueue_Scanner_send_SMP_SMPEncryptionInformation(struct Scanner_Instance *_instance, uint16_t Handle, ble_random_number_t LongTermKey){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages Scanner::SMP::SMPSecurityRequest
void enqueue_Scanner_send_SMP_SMPSecurityRequest(struct Scanner_Instance *_instance, uint16_t Handle, uint8_t Bonding, uint8_t MITM, uint8_t SecureConnection, uint8_t Keypress){
fifo_lock();
if ( fifo_byte_available() > 10 ) {
...
// Enqueue of messages Scanner::SMP::SMPIdentityAddressInformation
void enqueue_Scanner_send_SMP_SMPIdentityAddressInformation(struct Scanner_Instance *_instance, uint16_t Handle, uint8_t AddressType, bdaddr_t Address){
fifo_lock();
if ( fifo_byte_available() > 13 ) {
...
// Enqueue of messages Scanner::SMP::SMPPairingFailed
void enqueue_Scanner_send_SMP_SMPPairingFailed(struct Scanner_Instance *_instance, uint16_t Handle, uint8_t Reason){
fifo_lock();
if ( fifo_byte_available() > 7 ) {
...
// Enqueue of messages Scanner::SMP::SMPPairingConfirm
void enqueue_Scanner_send_SMP_SMPPairingConfirm(struct Scanner_Instance *_instance, uint16_t Handle, ble_random_number_t ConfirmValue){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages Scanner::SMP::SMPPairingRandom
void enqueue_Scanner_send_SMP_SMPPairingRandom(struct Scanner_Instance *_instance, uint16_t Handle, ble_random_number_t RandomValue){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages Scanner::SMP::SMPPairingRequest
void enqueue_Scanner_send_SMP_SMPPairingRequest(struct Scanner_Instance *_instance, uint16_t Handle, uint8_t IOCapability, uint8_t OOBDataPresent, uint8_t Bonding, uint8_t MITM, uint8_t SecureConnection, uint8_t Keypress, uint8_t MaximumEncryptionKeySize, uint8_t InitiatorKeyDistribution, uint8_t ResponderKeyDistribution){
fifo_lock();
if ( fifo_byte_available() > 15 ) {
...
// Enqueue of messages Scanner::ATT::ATTReadError
void enqueue_Scanner_send_ATT_ATTReadError(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages Scanner::ATT::ATTReadByGroupTypeResponse
void enqueue_Scanner_send_ATT_ATTReadByGroupTypeResponse(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint8_t Length, ble_gatt_data_t AttributeDataList){
fifo_lock();
if ( fifo_byte_available() > 31 ) {
...
// Enqueue of messages Scanner::ATT::ATTFindInformationError
void enqueue_Scanner_send_ATT_ATTFindInformationError(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages Scanner::ATT::ATTWriteError
void enqueue_Scanner_send_ATT_ATTWriteError(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages Scanner::ATT::ATTReadByTypeRequest
void enqueue_Scanner_send_ATT_ATTReadByTypeRequest(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t StartingHandle, uint16_t EndingHandle, ble_uuid_t AttributeType){
fifo_lock();
if ( fifo_byte_available() > 26 ) {
...
// Enqueue of messages Scanner::ATT::ATTReadRequest
void enqueue_Scanner_send_ATT_ATTReadRequest(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle){
fifo_lock();
if ( fifo_byte_available() > 8 ) {
...
// Enqueue of messages Scanner::ATT::ATTReadByTypeError
void enqueue_Scanner_send_ATT_ATTReadByTypeError(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages Scanner::ATT::ATTFindInformationRequest
void enqueue_Scanner_send_ATT_ATTFindInformationRequest(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t StartingHandle, uint16_t EndingHandle){
fifo_lock();
if ( fifo_byte_available() > 10 ) {
...
// Enqueue of messages Scanner::ATT::ATTWriteResponse
void enqueue_Scanner_send_ATT_ATTWriteResponse(struct Scanner_Instance *_instance, uint16_t ConnectionHandle){
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
// Enqueue of messages Scanner::ATT::ATTReadByGroupTypeRequest
void enqueue_Scanner_send_ATT_ATTReadByGroupTypeRequest(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t StartingHandle, uint16_t EndingHandle, ble_uuid_t AttributeGroupType){
fifo_lock();
if ( fifo_byte_available() > 26 ) {
...
// Enqueue of messages Scanner::ATT::ATTHandleValueIndication
void enqueue_Scanner_send_ATT_ATTHandleValueIndication(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages Scanner::ATT::ATTReadByTypeResponse
void enqueue_Scanner_send_ATT_ATTReadByTypeResponse(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint8_t Length, ble_gatt_data_t AttributeDataList){
fifo_lock();
if ( fifo_byte_available() > 31 ) {
...
// Enqueue of messages Scanner::ATT::ATTFindInformationResponse
void enqueue_Scanner_send_ATT_ATTFindInformationResponse(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint8_t Format, ble_gatt_data_t InformationData){
fifo_lock();
if ( fifo_byte_available() > 31 ) {
...
// Enqueue of messages Scanner::ATT::ATTReadResponse
void enqueue_Scanner_send_ATT_ATTReadResponse(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 30 ) {
...
// Enqueue of messages Scanner::ATT::ATTReadByGroupTypeError
void enqueue_Scanner_send_ATT_ATTReadByGroupTypeError(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages Scanner::ATT::ATTHandleValueConfirmation
void enqueue_Scanner_send_ATT_ATTHandleValueConfirmation(struct Scanner_Instance *_instance, uint16_t ConnectionHandle){
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
// Enqueue of messages Scanner::ATT::ATTHandleValueNotification
void enqueue_Scanner_send_ATT_ATTHandleValueNotification(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages Scanner::ATT::ATTWriteRequest
void enqueue_Scanner_send_ATT_ATTWriteRequest(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages Scanner::ATT::ATTWriteCommand
void enqueue_Scanner_send_ATT_ATTWriteCommand(struct Scanner_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
if (sender == hci_var.id_Events) {
Scanner_handle_HCIEvents_SetLEScanEnableCompleted(&scanner_var, param_NumberAllowedCommandPackets, param_Status);
...
Scanner_handle_Signals_Interrupt(&scanner_var);
...
if (sender == hci_var.id_Events) {
Scanner_handle_HCIEvents_SetLEEventMaskCompleted(&scanner_var, param_NumberAllowedCommandPackets, param_Status);
...
if (sender == scanner_var.id_Signals) {
...
if (sender == hci_var.id_Events) {
Scanner_handle_HCIEvents_LEAdvertisementReport(&scanner_var, param_Type, param_AddressType, param_Address, param_Length, param_Data);
...
if (sender == hci_var.id_Events) {
Scanner_handle_HCIEvents_ResetCompleted(&scanner_var, param_NumberAllowedCommandPackets, param_Status);
...
if (sender == hci_var.id_Events) {
Scanner_handle_HCIEvents_SetLEScanParametersCompleted(&scanner_var, param_NumberAllowedCommandPackets, param_Status);
...
if (sender == hci_var.id_Events) {
Scanner_handle_HCIEvents_SetEventMaskCompleted(&scanner_var, param_NumberAllowedCommandPackets, param_Status);
...
Scanner_handle_Socket_Opened(&scanner_var, param_Address);
...
if (sender == hci_var.id_Socket) {
Scanner_handle_Socket_Closed(&scanner_var);
...
void initialize_configuration_BLE_SCAN() {
...
register_Scanner_send_Signals_Quit_listener(&enqueue_Scanner_send_Signals_Quit);
register_Scanner_send_Socket_Open_listener(&enqueue_Scanner_send_Socket_Open);
register_Scanner_send_Socket_Close_listener(&enqueue_Scanner_send_Socket_Close);
register_Scanner_send_HCICommands_Reset_listener(&enqueue_Scanner_send_HCICommands_Reset);
register_Scanner_send_HCICommands_SetEventMask_listener(&enqueue_Scanner_send_HCICommands_SetEventMask);
register_Scanner_send_HCICommands_SetEventMaskAll_listener(&enqueue_Scanner_send_HCICommands_SetEventMaskAll);
register_Scanner_send_HCICommands_SetLocalName_listener(&enqueue_Scanner_send_HCICommands_SetLocalName);
register_Scanner_send_HCICommands_Disconnect_listener(&enqueue_Scanner_send_HCICommands_Disconnect);
register_Scanner_send_HCICommands_SetLEEventMask_listener(&enqueue_Scanner_send_HCICommands_SetLEEventMask);
register_Scanner_send_HCICommands_SetLEEventMaskAll_listener(&enqueue_Scanner_send_HCICommands_SetLEEventMaskAll);
register_Scanner_send_HCICommands_SetLEAdvertisementParameters_listener(&enqueue_Scanner_send_HCICommands_SetLEAdvertisementParameters);
register_Scanner_send_HCICommands_SetLEAdvertiseEnable_listener(&enqueue_Scanner_send_HCICommands_SetLEAdvertiseEnable);
register_Scanner_send_HCICommands_SetLEAdvertisingData_listener(&enqueue_Scanner_send_HCICommands_SetLEAdvertisingData);
register_Scanner_send_HCICommands_SetLEScanResponseData_listener(&enqueue_Scanner_send_HCICommands_SetLEScanResponseData);
register_Scanner_send_HCICommands_SetLEScanParameters_listener(&enqueue_Scanner_send_HCICommands_SetLEScanParameters);
register_Scanner_send_HCICommands_SetLEScanEnable_listener(&enqueue_Scanner_send_HCICommands_SetLEScanEnable);
register_Scanner_send_HCICommands_LECreateConnection_listener(&enqueue_Scanner_send_HCICommands_LECreateConnection);
register_Scanner_send_HCICommands_LECreateConnectionCancel_listener(&enqueue_Scanner_send_HCICommands_LECreateConnectionCancel);
register_Scanner_send_HCICommands_LERand_listener(&enqueue_Scanner_send_HCICommands_LERand);
register_Scanner_send_HCICommands_LEEncrypt_listener(&enqueue_Scanner_send_HCICommands_LEEncrypt);
register_Scanner_send_HCICommands_LEStartEncryption_listener(&enqueue_Scanner_send_HCICommands_LEStartEncryption);
register_Scanner_send_SMP_SMPPairingRequest_listener(&enqueue_Scanner_send_SMP_SMPPairingRequest);
register_Scanner_send_SMP_SMPPairingResponse_listener(&enqueue_Scanner_send_SMP_SMPPairingResponse);
register_Scanner_send_SMP_SMPPairingConfirm_listener(&enqueue_Scanner_send_SMP_SMPPairingConfirm);
register_Scanner_send_SMP_SMPPairingRandom_listener(&enqueue_Scanner_send_SMP_SMPPairingRandom);
register_Scanner_send_SMP_SMPPairingFailed_listener(&enqueue_Scanner_send_SMP_SMPPairingFailed);
register_Scanner_send_SMP_SMPPairingPublicKey_listener(&enqueue_Scanner_send_SMP_SMPPairingPublicKey);
register_Scanner_send_SMP_SMPPairingDHKeyCheck_listener(&enqueue_Scanner_send_SMP_SMPPairingDHKeyCheck);
register_Scanner_send_SMP_SMPKeypressNotification_listener(&enqueue_Scanner_send_SMP_SMPKeypressNotification);
register_Scanner_send_SMP_SMPEncryptionInformation_listener(&enqueue_Scanner_send_SMP_SMPEncryptionInformation);
register_Scanner_send_SMP_SMPMasterIdentification_listener(&enqueue_Scanner_send_SMP_SMPMasterIdentification);
register_Scanner_send_SMP_SMPIdentityInformation_listener(&enqueue_Scanner_send_SMP_SMPIdentityInformation);
register_Scanner_send_SMP_SMPIdentityAddressInformation_listener(&enqueue_Scanner_send_SMP_SMPIdentityAddressInformation);
register_Scanner_send_SMP_SMPSigningInformation_listener(&enqueue_Scanner_send_SMP_SMPSigningInformation);
register_Scanner_send_SMP_SMPSecurityRequest_listener(&enqueue_Scanner_send_SMP_SMPSecurityRequest);
register_Scanner_send_ATT_ATTFindInformationRequest_listener(&enqueue_Scanner_send_ATT_ATTFindInformationRequest);
register_Scanner_send_ATT_ATTFindInformationResponse_listener(&enqueue_Scanner_send_ATT_ATTFindInformationResponse);
register_Scanner_send_ATT_ATTFindInformationError_listener(&enqueue_Scanner_send_ATT_ATTFindInformationError);
register_Scanner_send_ATT_ATTReadByTypeRequest_listener(&enqueue_Scanner_send_ATT_ATTReadByTypeRequest);
register_Scanner_send_ATT_ATTReadByTypeResponse_listener(&enqueue_Scanner_send_ATT_ATTReadByTypeResponse);
register_Scanner_send_ATT_ATTReadByTypeError_listener(&enqueue_Scanner_send_ATT_ATTReadByTypeError);
register_Scanner_send_ATT_ATTReadRequest_listener(&enqueue_Scanner_send_ATT_ATTReadRequest);
register_Scanner_send_ATT_ATTReadResponse_listener(&enqueue_Scanner_send_ATT_ATTReadResponse);
register_Scanner_send_ATT_ATTReadError_listener(&enqueue_Scanner_send_ATT_ATTReadError);
register_Scanner_send_ATT_ATTReadByGroupTypeRequest_listener(&enqueue_Scanner_send_ATT_ATTReadByGroupTypeRequest);
register_Scanner_send_ATT_ATTReadByGroupTypeResponse_listener(&enqueue_Scanner_send_ATT_ATTReadByGroupTypeResponse);
register_Scanner_send_ATT_ATTReadByGroupTypeError_listener(&enqueue_Scanner_send_ATT_ATTReadByGroupTypeError);
register_Scanner_send_ATT_ATTWriteRequest_listener(&enqueue_Scanner_send_ATT_ATTWriteRequest);
register_Scanner_send_ATT_ATTWriteResponse_listener(&enqueue_Scanner_send_ATT_ATTWriteResponse);
register_Scanner_send_ATT_ATTWriteError_listener(&enqueue_Scanner_send_ATT_ATTWriteError);
register_Scanner_send_ATT_ATTWriteCommand_listener(&enqueue_Scanner_send_ATT_ATTWriteCommand);
register_Scanner_send_ATT_ATTHandleValueNotification_listener(&enqueue_Scanner_send_ATT_ATTHandleValueNotification);
register_Scanner_send_ATT_ATTHandleValueIndication_listener(&enqueue_Scanner_send_ATT_ATTHandleValueIndication);
register_Scanner_send_ATT_ATTHandleValueConfirmation_listener(&enqueue_Scanner_send_ATT_ATTHandleValueConfirmation);
...
scanner_var.id_Signals = add_instance( (void*) &scanner_var);
...
scanner_var.Scanner_States_State = SCANNER_STATES_OPEN_STATE;

Scanner_States_OnEntry(SCANNER_STATES_STATE, &scanner_var);
}
...
int main(int argc, char *argv[]) {
    ...
    initialize_configuration_BLE_SCAN();
