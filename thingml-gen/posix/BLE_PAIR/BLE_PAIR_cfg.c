...
// Enqueue of messages Main::Encrypter::CheckConfirm
void enqueue_Main_send_Encrypter_CheckConfirm(struct Main_Instance *_instance, ble_random_number_t Received, ble_random_number_t Calculated){
fifo_lock();
if ( fifo_byte_available() > 36 ) {
...
// ID of the source port of the instance
_fifo_enqueue( (_instance->id_Encrypter >> 8) & 0xFF );
_fifo_enqueue( _instance->id_Encrypter & 0xFF );
...
u_Received.p = Received;
_fifo_enqueue(u_Received.bytebuffer[15] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[14] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[13] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[12] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[11] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[10] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[9] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[8] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[7] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[6] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[5] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[4] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[3] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[2] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[1] & 0xFF );
_fifo_enqueue(u_Received.bytebuffer[0] & 0xFF );

// parameter Calculated
union u_Calculated_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_Calculated;
u_Calculated.p = Calculated;
_fifo_enqueue(u_Calculated.bytebuffer[15] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[14] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[13] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[12] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[11] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[10] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[9] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[8] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[7] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[6] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[5] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[4] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[3] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[2] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[1] & 0xFF );
_fifo_enqueue(u_Calculated.bytebuffer[0] & 0xFF );
}
fifo_unlock_and_notify();
}
// Enqueue of messages Main::Encrypter::Start
void enqueue_Main_send_Encrypter_Start(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::Encrypter::GenerateConfirm
void enqueue_Main_send_Encrypter_GenerateConfirm(struct Main_Instance *_instance, ble_random_number_t Rand, uint8_t IAT, bdaddr_t IA, uint8_t RAT, bdaddr_t RA){
fifo_lock();
if ( fifo_byte_available() > 34 ) {
...
u_Rand.p = Rand;
_fifo_enqueue(u_Rand.bytebuffer[15] & 0xFF );
_fifo_enqueue(u_Rand.bytebuffer[14] & 0xFF );
_fifo_enqueue(u_Rand.bytebuffer[13] & 0xFF );
_fifo_enqueue(u_Rand.bytebuffer[12] & 0xFF );
_fifo_enqueue(u_Rand.bytebuffer[11] & 0xFF );
_fifo_enqueue(u_Rand.bytebuffer[10] & 0xFF );
_fifo_enqueue(u_Rand.bytebuffer[9] & 0xFF );
_fifo_enqueue(u_Rand.bytebuffer[8] & 0xFF );
_fifo_enqueue(u_Rand.bytebuffer[7] & 0xFF );
_fifo_enqueue(u_Rand.bytebuffer[6] & 0xFF );
_fifo_enqueue(u_Rand.bytebuffer[5] & 0xFF );
_fifo_enqueue(u_Rand.bytebuffer[4] & 0xFF );
...
u_IAT.p = IAT;
_fifo_enqueue(u_IAT.bytebuffer[0] & 0xFF );
...
u_IA.p = IA;
_fifo_enqueue(u_IA.bytebuffer[5] & 0xFF );
_fifo_enqueue(u_IA.bytebuffer[4] & 0xFF );
_fifo_enqueue(u_IA.bytebuffer[3] & 0xFF );
_fifo_enqueue(u_IA.bytebuffer[2] & 0xFF );
_fifo_enqueue(u_IA.bytebuffer[1] & 0xFF );
_fifo_enqueue(u_IA.bytebuffer[0] & 0xFF );
...
u_RAT.p = RAT;
_fifo_enqueue(u_RAT.bytebuffer[0] & 0xFF );
...
u_RA.p = RA;
_fifo_enqueue(u_RA.bytebuffer[5] & 0xFF );
_fifo_enqueue(u_RA.bytebuffer[4] & 0xFF );
_fifo_enqueue(u_RA.bytebuffer[3] & 0xFF );
_fifo_enqueue(u_RA.bytebuffer[2] & 0xFF );
_fifo_enqueue(u_RA.bytebuffer[1] & 0xFF );
_fifo_enqueue(u_RA.bytebuffer[0] & 0xFF );
}
fifo_unlock_and_notify();
}
// Enqueue of messages Main::Encrypter::GenerateRandomNumber
void enqueue_Main_send_Encrypter_GenerateRandomNumber(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::Encrypter::GenerateSTK
void enqueue_Main_send_Encrypter_GenerateSTK(struct Main_Instance *_instance, ble_random_number_t Srand, ble_random_number_t Mrand){
fifo_lock();
if ( fifo_byte_available() > 36 ) {
...
u_Srand.p = Srand;
_fifo_enqueue(u_Srand.bytebuffer[15] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[14] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[13] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[12] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[11] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[10] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[9] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[8] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[7] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[6] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[5] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[4] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[3] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[2] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[1] & 0xFF );
_fifo_enqueue(u_Srand.bytebuffer[0] & 0xFF );
...
u_Mrand.p = Mrand;
_fifo_enqueue(u_Mrand.bytebuffer[15] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[14] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[13] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[12] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[11] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[10] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[9] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[8] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[7] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[6] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[5] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[4] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[3] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[2] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[1] & 0xFF );
_fifo_enqueue(u_Mrand.bytebuffer[0] & 0xFF );
}
fifo_unlock_and_notify();
}
// Enqueue of messages Main::Socket::Open
void enqueue_Main_send_Socket_Open(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::Socket::Close
void enqueue_Main_send_Socket_Close(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::HCICommands::Reset
void enqueue_Main_send_HCICommands_Reset(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::HCICommands::LECreateConnection
void enqueue_Main_send_HCICommands_LECreateConnection(struct Main_Instance *_instance, uint16_t Interval, uint16_t Window, uint8_t FilterPolicy, uint8_t PeerAddressType, bdaddr_t PeerAddress, uint8_t OwnAddressType, uint16_t ConnIntervalMin, uint16_t ConnIntervalMax, uint16_t ConnLatency, uint16_t SupervisionTimeout, uint16_t CELengthMin, uint16_t CELengthMax){
fifo_lock();
if ( fifo_byte_available() > 29 ) {
...
// Enqueue of messages Main::HCICommands::LECreateConnectionCancel
void enqueue_Main_send_HCICommands_LECreateConnectionCancel(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::HCICommands::SetLEEventMaskAll
void enqueue_Main_send_HCICommands_SetLEEventMaskAll(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::HCICommands::SetLEAdvertiseEnable
void enqueue_Main_send_HCICommands_SetLEAdvertiseEnable(struct Main_Instance *_instance, uint8_t Enable){
fifo_lock();
if ( fifo_byte_available() > 5 ) {
...
// Enqueue of messages Main::HCICommands::SetLEAdvertisingData
void enqueue_Main_send_HCICommands_SetLEAdvertisingData(struct Main_Instance *_instance, uint8_t Length, ble_adv_data_t Data){
fifo_lock();
if ( fifo_byte_available() > 36 ) {
...
// Enqueue of messages Main::HCICommands::LERand
void enqueue_Main_send_HCICommands_LERand(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::HCICommands::SetLocalName
void enqueue_Main_send_HCICommands_SetLocalName(struct Main_Instance *_instance, change_local_name_cp Name){
fifo_lock();
if ( fifo_byte_available() > 252 ) {
...
// Enqueue of messages Main::HCICommands::SetLEScanResponseData
void enqueue_Main_send_HCICommands_SetLEScanResponseData(struct Main_Instance *_instance, uint8_t Length, ble_adv_data_t Data){
fifo_lock();
if ( fifo_byte_available() > 36 ) {
...
// Enqueue of messages Main::HCICommands::LEStartEncryption
void enqueue_Main_send_HCICommands_LEStartEncryption(struct Main_Instance *_instance, uint16_t ConnectionHandle, ble_random_part_t Random, uint16_t EDIV, ble_random_number_t LTK){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages Main::HCICommands::SetLEEventMask
void enqueue_Main_send_HCICommands_SetLEEventMask(struct Main_Instance *_instance, set_event_mask_cp Mask){
fifo_lock();
if ( fifo_byte_available() > 12 ) {
...
// Enqueue of messages Main::HCICommands::SetEventMask
void enqueue_Main_send_HCICommands_SetEventMask(struct Main_Instance *_instance, set_event_mask_cp Mask){
fifo_lock();
if ( fifo_byte_available() > 12 ) {
...
// Enqueue of messages Main::HCICommands::Disconnect
void enqueue_Main_send_HCICommands_Disconnect(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint8_t Reason){
fifo_lock();
if ( fifo_byte_available() > 7 ) {
...
// Enqueue of messages Main::HCICommands::SetLEScanEnable
void enqueue_Main_send_HCICommands_SetLEScanEnable(struct Main_Instance *_instance, uint8_t Enable, uint8_t FilterDuplicates){
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
// Enqueue of messages Main::HCICommands::SetLEAdvertisementParameters
void enqueue_Main_send_HCICommands_SetLEAdvertisementParameters(struct Main_Instance *_instance, uint16_t MinInterval, uint16_t MaxInterval, uint8_t Type, uint8_t OwnAddressType, uint8_t PeerAddressType, bdaddr_t PeerAddress, uint8_t Channel, uint8_t FilterPolicy){
fifo_lock();
if ( fifo_byte_available() > 19 ) {
...
// Enqueue of messages Main::HCICommands::SetEventMaskAll
void enqueue_Main_send_HCICommands_SetEventMaskAll(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::HCICommands::SetLEScanParameters
void enqueue_Main_send_HCICommands_SetLEScanParameters(struct Main_Instance *_instance, uint8_t Type, uint16_t Interval, uint16_t Window, uint8_t OwnAddressType, uint8_t FilterPolicy){
fifo_lock();
if ( fifo_byte_available() > 11 ) {
...
// Enqueue of messages Main::HCICommands::LEEncrypt
void enqueue_Main_send_HCICommands_LEEncrypt(struct Main_Instance *_instance, ble_random_number_t Key, ble_random_number_t Plaintext){
fifo_lock();
if ( fifo_byte_available() > 36 ) {
...
// Enqueue of messages Main::SMP::SMPPairingDHKeyCheck
void enqueue_Main_send_SMP_SMPPairingDHKeyCheck(struct Main_Instance *_instance, uint16_t Handle, ble_random_number_t DHKeyCheck){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages Main::SMP::SMPSecurityRequest
void enqueue_Main_send_SMP_SMPSecurityRequest(struct Main_Instance *_instance, uint16_t Handle, uint8_t Bonding, uint8_t MITM, uint8_t SecureConnection, uint8_t Keypress){
fifo_lock();
if ( fifo_byte_available() > 10 ) {
...
// Enqueue of messages Main::SMP::SMPSigningInformation
void enqueue_Main_send_SMP_SMPSigningInformation(struct Main_Instance *_instance, uint16_t Handle, ble_random_number_t SignatureKey){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages Main::SMP::SMPKeypressNotification
void enqueue_Main_send_SMP_SMPKeypressNotification(struct Main_Instance *_instance, uint16_t Handle, uint8_t Type){
fifo_lock();
if ( fifo_byte_available() > 7 ) {
...
// Enqueue of messages Main::SMP::SMPPairingResponse
void enqueue_Main_send_SMP_SMPPairingResponse(struct Main_Instance *_instance, uint16_t Handle, uint8_t IOCapability, uint8_t OOBDataPresent, uint8_t Bonding, uint8_t MITM, uint8_t SecureConnection, uint8_t Keypress, uint8_t MaximumEncryptionKeySize, uint8_t InitiatorKeyDistribution, uint8_t ResponderKeyDistribution){
fifo_lock();
if ( fifo_byte_available() > 15 ) {
...
// Enqueue of messages Main::SMP::SMPPairingRandom
void enqueue_Main_send_SMP_SMPPairingRandom(struct Main_Instance *_instance, uint16_t Handle, ble_random_number_t RandomValue){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages Main::SMP::SMPPairingPublicKey
void enqueue_Main_send_SMP_SMPPairingPublicKey(struct Main_Instance *_instance, uint16_t Handle, smp_public_key_t KeyX, smp_public_key_t KeyY){
fifo_lock();
if ( fifo_byte_available() > 70 ) {
...
// Enqueue of messages Main::SMP::SMPPairingConfirm
void enqueue_Main_send_SMP_SMPPairingConfirm(struct Main_Instance *_instance, uint16_t Handle, ble_random_number_t ConfirmValue){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages Main::SMP::SMPEncryptionInformation
void enqueue_Main_send_SMP_SMPEncryptionInformation(struct Main_Instance *_instance, uint16_t Handle, ble_random_number_t LongTermKey){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages Main::SMP::SMPMasterIdentification
void enqueue_Main_send_SMP_SMPMasterIdentification(struct Main_Instance *_instance, uint16_t Handle, uint16_t EDIV, ble_random_part_t Rand){
fifo_lock();
if ( fifo_byte_available() > 16 ) {
...
// Enqueue of messages Main::SMP::SMPPairingRequest
void enqueue_Main_send_SMP_SMPPairingRequest(struct Main_Instance *_instance, uint16_t Handle, uint8_t IOCapability, uint8_t OOBDataPresent, uint8_t Bonding, uint8_t MITM, uint8_t SecureConnection, uint8_t Keypress, uint8_t MaximumEncryptionKeySize, uint8_t InitiatorKeyDistribution, uint8_t ResponderKeyDistribution){
fifo_lock();
if ( fifo_byte_available() > 15 ) {
...
// Enqueue of messages Main::SMP::SMPIdentityAddressInformation
void enqueue_Main_send_SMP_SMPIdentityAddressInformation(struct Main_Instance *_instance, uint16_t Handle, uint8_t AddressType, bdaddr_t Address){
fifo_lock();
if ( fifo_byte_available() > 13 ) {
...
// Enqueue of messages Main::SMP::SMPPairingFailed
void enqueue_Main_send_SMP_SMPPairingFailed(struct Main_Instance *_instance, uint16_t Handle, uint8_t Reason){
fifo_lock();
if ( fifo_byte_available() > 7 ) {
...
// Enqueue of messages Main::SMP::SMPIdentityInformation
void enqueue_Main_send_SMP_SMPIdentityInformation(struct Main_Instance *_instance, uint16_t Handle, ble_random_number_t IdentityResolvingKey){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages BLEEncryptionImpl::Encrypter::CheckConfirmCompleted
void enqueue_BLEEncryptionImpl_send_Encrypter_CheckConfirmCompleted(struct BLEEncryptionImpl_Instance *_instance, uint8_t Correct){
fifo_lock();
if ( fifo_byte_available() > 5 ) {
...
u_Correct.p = Correct;
_fifo_enqueue(u_Correct.bytebuffer[0] & 0xFF );
}
fifo_unlock_and_notify();
}
// Enqueue of messages BLEEncryptionImpl::Encrypter::GenerateConfirmCompleted
void enqueue_BLEEncryptionImpl_send_Encrypter_GenerateConfirmCompleted(struct BLEEncryptionImpl_Instance *_instance, ble_random_number_t Confirm){
fifo_lock();
...
u_Confirm.p = Confirm;
_fifo_enqueue(u_Confirm.bytebuffer[15] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[14] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[13] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[12] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[11] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[10] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[9] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[8] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[7] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[6] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[5] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[4] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[3] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[2] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[1] & 0xFF );
_fifo_enqueue(u_Confirm.bytebuffer[0] & 0xFF );
}
fifo_unlock_and_notify();
}
// Enqueue of messages BLEEncryptionImpl::Encrypter::Failure
void enqueue_BLEEncryptionImpl_send_Encrypter_Failure(struct BLEEncryptionImpl_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages BLEEncryptionImpl::Encrypter::Started
void enqueue_BLEEncryptionImpl_send_Encrypter_Started(struct BLEEncryptionImpl_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages BLEEncryptionImpl::Encrypter::GenerateSTKCompleted
void enqueue_BLEEncryptionImpl_send_Encrypter_GenerateSTKCompleted(struct BLEEncryptionImpl_Instance *_instance, ble_random_number_t STK){
fifo_lock();
if ( fifo_byte_available() > 20 ) {
...
u_STK.p = STK;
_fifo_enqueue(u_STK.bytebuffer[15] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[14] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[13] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[12] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[11] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[10] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[9] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[8] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[7] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[6] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[5] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[4] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[3] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[2] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[1] & 0xFF );
_fifo_enqueue(u_STK.bytebuffer[0] & 0xFF );
}
fifo_unlock_and_notify();
}
// Enqueue of messages BLEEncryptionImpl::Encrypter::GenerateRandomNumberCompleted
void enqueue_BLEEncryptionImpl_send_Encrypter_GenerateRandomNumberCompleted(struct BLEEncryptionImpl_Instance *_instance, ble_random_number_t Random){
fifo_lock();
if ( fifo_byte_available() > 20 ) {
...
u_Random.p = Random;
_fifo_enqueue(u_Random.bytebuffer[15] & 0xFF );
_fifo_enqueue(u_Random.bytebuffer[14] & 0xFF );
_fifo_enqueue(u_Random.bytebuffer[13] & 0xFF );
_fifo_enqueue(u_Random.bytebuffer[12] & 0xFF );
_fifo_enqueue(u_Random.bytebuffer[11] & 0xFF );
_fifo_enqueue(u_Random.bytebuffer[10] & 0xFF );
_fifo_enqueue(u_Random.bytebuffer[9] & 0xFF );
_fifo_enqueue(u_Random.bytebuffer[8] & 0xFF );
_fifo_enqueue(u_Random.bytebuffer[7] & 0xFF );
_fifo_enqueue(u_Random.bytebuffer[6] & 0xFF );
_fifo_enqueue(u_Random.bytebuffer[5] & 0xFF );
_fifo_enqueue(u_Random.bytebuffer[4] & 0xFF );
...
// Enqueue of messages BLEEncryptionImpl::Socket::Open
void enqueue_BLEEncryptionImpl_send_Socket_Open(struct BLEEncryptionImpl_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages BLEEncryptionImpl::Socket::Close
void enqueue_BLEEncryptionImpl_send_Socket_Close(struct BLEEncryptionImpl_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::Reset
void enqueue_BLEEncryptionImpl_send_HCICommands_Reset(struct BLEEncryptionImpl_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::LECreateConnection
void enqueue_BLEEncryptionImpl_send_HCICommands_LECreateConnection(struct BLEEncryptionImpl_Instance *_instance, uint16_t Interval, uint16_t Window, uint8_t FilterPolicy, uint8_t PeerAddressType, bdaddr_t PeerAddress, uint8_t OwnAddressType, uint16_t ConnIntervalMin, uint16_t ConnIntervalMax, uint16_t ConnLatency, uint16_t SupervisionTimeout, uint16_t CELengthMin, uint16_t CELengthMax){
fifo_lock();
if ( fifo_byte_available() > 29 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::LECreateConnectionCancel
void enqueue_BLEEncryptionImpl_send_HCICommands_LECreateConnectionCancel(struct BLEEncryptionImpl_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::SetLEEventMaskAll
void enqueue_BLEEncryptionImpl_send_HCICommands_SetLEEventMaskAll(struct BLEEncryptionImpl_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::SetLEAdvertiseEnable
void enqueue_BLEEncryptionImpl_send_HCICommands_SetLEAdvertiseEnable(struct BLEEncryptionImpl_Instance *_instance, uint8_t Enable){
fifo_lock();
if ( fifo_byte_available() > 5 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::SetLEAdvertisingData
void enqueue_BLEEncryptionImpl_send_HCICommands_SetLEAdvertisingData(struct BLEEncryptionImpl_Instance *_instance, uint8_t Length, ble_adv_data_t Data){
fifo_lock();
if ( fifo_byte_available() > 36 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::LERand
void enqueue_BLEEncryptionImpl_send_HCICommands_LERand(struct BLEEncryptionImpl_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::SetLocalName
void enqueue_BLEEncryptionImpl_send_HCICommands_SetLocalName(struct BLEEncryptionImpl_Instance *_instance, change_local_name_cp Name){
fifo_lock();
if ( fifo_byte_available() > 252 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::SetLEScanResponseData
void enqueue_BLEEncryptionImpl_send_HCICommands_SetLEScanResponseData(struct BLEEncryptionImpl_Instance *_instance, uint8_t Length, ble_adv_data_t Data){
fifo_lock();
if ( fifo_byte_available() > 36 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::LEStartEncryption
void enqueue_BLEEncryptionImpl_send_HCICommands_LEStartEncryption(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, ble_random_part_t Random, uint16_t EDIV, ble_random_number_t LTK){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::SetLEEventMask
void enqueue_BLEEncryptionImpl_send_HCICommands_SetLEEventMask(struct BLEEncryptionImpl_Instance *_instance, set_event_mask_cp Mask){
fifo_lock();
if ( fifo_byte_available() > 12 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::SetEventMask
void enqueue_BLEEncryptionImpl_send_HCICommands_SetEventMask(struct BLEEncryptionImpl_Instance *_instance, set_event_mask_cp Mask){
fifo_lock();
if ( fifo_byte_available() > 12 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::Disconnect
void enqueue_BLEEncryptionImpl_send_HCICommands_Disconnect(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint8_t Reason){
fifo_lock();
if ( fifo_byte_available() > 7 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::SetLEScanEnable
void enqueue_BLEEncryptionImpl_send_HCICommands_SetLEScanEnable(struct BLEEncryptionImpl_Instance *_instance, uint8_t Enable, uint8_t FilterDuplicates){
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::SetLEAdvertisementParameters
void enqueue_BLEEncryptionImpl_send_HCICommands_SetLEAdvertisementParameters(struct BLEEncryptionImpl_Instance *_instance, uint16_t MinInterval, uint16_t MaxInterval, uint8_t Type, uint8_t OwnAddressType, uint8_t PeerAddressType, bdaddr_t PeerAddress, uint8_t Channel, uint8_t FilterPolicy){
fifo_lock();
if ( fifo_byte_available() > 19 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::SetEventMaskAll
void enqueue_BLEEncryptionImpl_send_HCICommands_SetEventMaskAll(struct BLEEncryptionImpl_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::SetLEScanParameters
void enqueue_BLEEncryptionImpl_send_HCICommands_SetLEScanParameters(struct BLEEncryptionImpl_Instance *_instance, uint8_t Type, uint16_t Interval, uint16_t Window, uint8_t OwnAddressType, uint8_t FilterPolicy){
fifo_lock();
if ( fifo_byte_available() > 11 ) {
...
// Enqueue of messages BLEEncryptionImpl::HCICommands::LEEncrypt
void enqueue_BLEEncryptionImpl_send_HCICommands_LEEncrypt(struct BLEEncryptionImpl_Instance *_instance, ble_random_number_t Key, ble_random_number_t Plaintext){
fifo_lock();
if ( fifo_byte_available() > 36 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPPairingDHKeyCheck
void enqueue_BLEEncryptionImpl_send_SMP_SMPPairingDHKeyCheck(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, ble_random_number_t DHKeyCheck){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPSecurityRequest
void enqueue_BLEEncryptionImpl_send_SMP_SMPSecurityRequest(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, uint8_t Bonding, uint8_t MITM, uint8_t SecureConnection, uint8_t Keypress){
fifo_lock();
if ( fifo_byte_available() > 10 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPSigningInformation
void enqueue_BLEEncryptionImpl_send_SMP_SMPSigningInformation(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, ble_random_number_t SignatureKey){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPKeypressNotification
void enqueue_BLEEncryptionImpl_send_SMP_SMPKeypressNotification(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, uint8_t Type){
fifo_lock();
if ( fifo_byte_available() > 7 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPPairingRandom
void enqueue_BLEEncryptionImpl_send_SMP_SMPPairingRandom(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, ble_random_number_t RandomValue){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPPairingPublicKey
void enqueue_BLEEncryptionImpl_send_SMP_SMPPairingPublicKey(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, smp_public_key_t KeyX, smp_public_key_t KeyY){
fifo_lock();
if ( fifo_byte_available() > 70 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPPairingConfirm
void enqueue_BLEEncryptionImpl_send_SMP_SMPPairingConfirm(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, ble_random_number_t ConfirmValue){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPEncryptionInformation
void enqueue_BLEEncryptionImpl_send_SMP_SMPEncryptionInformation(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, ble_random_number_t LongTermKey){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPMasterIdentification
void enqueue_BLEEncryptionImpl_send_SMP_SMPMasterIdentification(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, uint16_t EDIV, ble_random_part_t Rand){
fifo_lock();
if ( fifo_byte_available() > 16 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPPairingRequest
void enqueue_BLEEncryptionImpl_send_SMP_SMPPairingRequest(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, uint8_t IOCapability, uint8_t OOBDataPresent, uint8_t Bonding, uint8_t MITM, uint8_t SecureConnection, uint8_t Keypress, uint8_t MaximumEncryptionKeySize, uint8_t InitiatorKeyDistribution, uint8_t ResponderKeyDistribution){
fifo_lock();
if ( fifo_byte_available() > 15 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPIdentityAddressInformation
void enqueue_BLEEncryptionImpl_send_SMP_SMPIdentityAddressInformation(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, uint8_t AddressType, bdaddr_t Address){
fifo_lock();
if ( fifo_byte_available() > 13 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPPairingFailed
void enqueue_BLEEncryptionImpl_send_SMP_SMPPairingFailed(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, uint8_t Reason){
fifo_lock();
if ( fifo_byte_available() > 7 ) {
...
// Enqueue of messages BLEEncryptionImpl::SMP::SMPIdentityInformation
void enqueue_BLEEncryptionImpl_send_SMP_SMPIdentityInformation(struct BLEEncryptionImpl_Instance *_instance, uint16_t Handle, ble_random_number_t IdentityResolvingKey){
fifo_lock();
if ( fifo_byte_available() > 22 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTReadByTypeRequest
void enqueue_BLEEncryptionImpl_send_ATT_ATTReadByTypeRequest(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t StartingHandle, uint16_t EndingHandle, ble_uuid_t AttributeType){
fifo_lock();
if ( fifo_byte_available() > 26 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTWriteRequest
void enqueue_BLEEncryptionImpl_send_ATT_ATTWriteRequest(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTHandleValueIndication
void enqueue_BLEEncryptionImpl_send_ATT_ATTHandleValueIndication(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTHandleValueNotification
void enqueue_BLEEncryptionImpl_send_ATT_ATTHandleValueNotification(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTReadByTypeResponse
void enqueue_BLEEncryptionImpl_send_ATT_ATTReadByTypeResponse(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint8_t Length, ble_gatt_data_t AttributeDataList){
fifo_lock();
if ( fifo_byte_available() > 31 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTFindInformationError
void enqueue_BLEEncryptionImpl_send_ATT_ATTFindInformationError(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTFindInformationRequest
void enqueue_BLEEncryptionImpl_send_ATT_ATTFindInformationRequest(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t StartingHandle, uint16_t EndingHandle){
fifo_lock();
if ( fifo_byte_available() > 10 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTReadByGroupTypeError
void enqueue_BLEEncryptionImpl_send_ATT_ATTReadByGroupTypeError(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTHandleValueConfirmation
void enqueue_BLEEncryptionImpl_send_ATT_ATTHandleValueConfirmation(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle){
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTReadByGroupTypeRequest
void enqueue_BLEEncryptionImpl_send_ATT_ATTReadByGroupTypeRequest(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t StartingHandle, uint16_t EndingHandle, ble_uuid_t AttributeGroupType){
fifo_lock();
if ( fifo_byte_available() > 26 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTReadResponse
void enqueue_BLEEncryptionImpl_send_ATT_ATTReadResponse(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 30 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTWriteError
void enqueue_BLEEncryptionImpl_send_ATT_ATTWriteError(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTFindInformationResponse
void enqueue_BLEEncryptionImpl_send_ATT_ATTFindInformationResponse(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint8_t Format, ble_gatt_data_t InformationData){
fifo_lock();
if ( fifo_byte_available() > 31 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTReadError
void enqueue_BLEEncryptionImpl_send_ATT_ATTReadError(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTWriteResponse
void enqueue_BLEEncryptionImpl_send_ATT_ATTWriteResponse(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle){
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTReadRequest
void enqueue_BLEEncryptionImpl_send_ATT_ATTReadRequest(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle){
fifo_lock();
if ( fifo_byte_available() > 8 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTWriteCommand
void enqueue_BLEEncryptionImpl_send_ATT_ATTWriteCommand(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTReadByTypeError
void enqueue_BLEEncryptionImpl_send_ATT_ATTReadByTypeError(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages BLEEncryptionImpl::ATT::ATTReadByGroupTypeResponse
void enqueue_BLEEncryptionImpl_send_ATT_ATTReadByGroupTypeResponse(struct BLEEncryptionImpl_Instance *_instance, uint16_t ConnectionHandle, uint8_t Length, ble_gatt_data_t AttributeDataList){
fifo_lock();
if ( fifo_byte_available() > 31 ) {
...
void dispatch_CheckConfirmCompleted(uint16_t sender, uint8_t param_Correct) {
if (sender == encrypter_var.id_Encrypter) {
Main_handle_Encrypter_CheckConfirmCompleted(&main_var, param_Correct);
...
Main_handle_HCIEvents_LEStartEncryptionStatus(&main_var, param_NumberAllowedCommandPackets, param_Status);
...
if (sender == encrypter_var.id_ATT) {
HCISocketProxyImpl_handle_ATT_ATTReadByTypeResponse(&hci_var, param_ConnectionHandle, param_Length, param_AttributeDataList);
...
BLEEncryptionImpl_handle_Socket_Closed(&encrypter_var);
...
if (sender == encrypter_var.id_SMP) {
HCISocketProxyImpl_handle_SMP_SMPPairingDHKeyCheck(&hci_var, param_Handle, param_DHKeyCheck);
...
//New dispatcher for messages
void dispatch_GenerateSTKCompleted(uint16_t sender, ble_random_number_t param_STK) {
if (sender == encrypter_var.id_Encrypter) {
Main_handle_Encrypter_GenerateSTKCompleted(&main_var, param_STK);
...
//New dispatcher for messages
void dispatch_GenerateConfirmCompleted(uint16_t sender, ble_random_number_t param_Confirm) {
if (sender == encrypter_var.id_Encrypter) {
Main_handle_Encrypter_GenerateConfirmCompleted(&main_var, param_Confirm);
...
//New dispatcher for messages
void dispatch_GenerateConfirm(uint16_t sender, ble_random_number_t param_Rand, uint8_t param_IAT, bdaddr_t param_IA, uint8_t param_RAT, bdaddr_t param_RA) {
if (sender == main_var.id_Encrypter) {
BLEEncryptionImpl_handle_Encrypter_GenerateConfirm(&encrypter_var, param_Rand, param_IAT, param_IA, param_RAT, param_RA);
...
if (sender == hci_var.id_SMP) {
Main_handle_SMP_SMPPairingRandom(&main_var, param_Handle, param_RandomValue);
...
if (sender == main_var.id_Encrypter) {
BLEEncryptionImpl_handle_Encrypter_GenerateRandomNumber(&encrypter_var);
...
if (sender == hci_var.id_SMP) {
Main_handle_SMP_SMPPairingFailed(&main_var, param_Handle, param_Reason);
...
//New dispatcher for messages
void dispatch_GenerateRandomNumberCompleted(uint16_t sender, ble_random_number_t param_Random) {
if (sender == encrypter_var.id_Encrypter) {
Main_handle_Encrypter_GenerateRandomNumberCompleted(&main_var, param_Random);
...
//New dispatcher for messages
void dispatch_CheckConfirm(uint16_t sender, ble_random_number_t param_Received, ble_random_number_t param_Calculated) {
if (sender == main_var.id_Encrypter) {
BLEEncryptionImpl_handle_Encrypter_CheckConfirm(&encrypter_var, param_Received, param_Calculated);
...
if (sender == main_var.id_Encrypter) {
BLEEncryptionImpl_handle_Encrypter_Start(&encrypter_var);
...
if (sender == hci_var.id_SMP) {
Main_handle_SMP_SMPPairingResponse(&main_var, param_Handle, param_IOCapability, param_OOBDataPresent, param_Bonding, param_MITM, param_SecureConnection, param_Keypress, param_MaximumEncryptionKeySize, param_InitiatorKeyDistribution, param_ResponderKeyDistribution);
...
if (sender == hci_var.id_SMP) {
Main_handle_SMP_SMPIdentityInformation(&main_var, param_Handle, param_IdentityResolvingKey);
...
if (sender == hci_var.id_Events) {
BLEEncryptionImpl_handle_HCIEvents_LEEncryptCompleted(&encrypter_var, param_NumberAllowedCommandPackets, param_Status, param_Encrypted);
...
if (sender == hci_var.id_Events) {
BLEEncryptionImpl_handle_HCIEvents_LERandCompleted(&encrypter_var, param_NumberAllowedCommandPackets, param_Status, param_Random);
...
if (sender == hci_var.id_SMP) {
Main_handle_SMP_SMPEncryptionInformation(&main_var, param_Handle, param_LongTermKey);
...
if (sender == hci_var.id_SMP) {
Main_handle_SMP_SMPSecurityRequest(&main_var, param_Handle, param_Bonding, param_MITM, param_SecureConnection, param_Keypress);
...
//New dispatcher for messages
void dispatch_GenerateSTK(uint16_t sender, ble_random_number_t param_Srand, ble_random_number_t param_Mrand) {
if (sender == main_var.id_Encrypter) {
BLEEncryptionImpl_handle_Encrypter_GenerateSTK(&encrypter_var, param_Srand, param_Mrand);
...
if (sender == hci_var.id_SMP) {
Main_handle_SMP_SMPPairingConfirm(&main_var, param_Handle, param_ConfirmValue);
...
if (sender == hci_var.id_SMP) {
Main_handle_SMP_SMPIdentityAddressInformation(&main_var, param_Handle, param_AddressType, param_Address);
...
BLEEncryptionImpl_handle_Socket_Opened(&encrypter_var, param_Address);
...
if (sender == hci_var.id_SMP) {
Main_handle_SMP_SMPMasterIdentification(&main_var, param_Handle, param_EDIV, param_Rand);
...
Main_handle_HCIEvents_EncryptionChanged(&main_var, param_Status, param_ConnectionHandle, param_Enabled);
...
dispatch_CheckConfirmCompleted((mbuf[0] << 8) + mbuf[1] /* instance port*/,
...
case 96:{
byte mbuf[20 - 2];
while (mbufi < (20 - 2)) mbuf[mbufi++] = fifo_dequeue();
fifo_unlock();
...
dispatch_GenerateSTKCompleted((mbuf[0] << 8) + mbuf[1] /* instance port*/,
...
dispatch_GenerateConfirmCompleted((mbuf[0] << 8) + mbuf[1] /* instance port*/,
...
fifo_unlock();
uint8_t mbufi_GenerateConfirm = 2;
union u_GenerateConfirm_Rand_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_GenerateConfirm_Rand;
u_GenerateConfirm_Rand.bytebuffer[15] = mbuf[mbufi_GenerateConfirm + 0];
u_GenerateConfirm_Rand.bytebuffer[14] = mbuf[mbufi_GenerateConfirm + 1];
u_GenerateConfirm_Rand.bytebuffer[13] = mbuf[mbufi_GenerateConfirm + 2];
u_GenerateConfirm_Rand.bytebuffer[12] = mbuf[mbufi_GenerateConfirm + 3];
u_GenerateConfirm_Rand.bytebuffer[11] = mbuf[mbufi_GenerateConfirm + 4];
u_GenerateConfirm_Rand.bytebuffer[10] = mbuf[mbufi_GenerateConfirm + 5];
u_GenerateConfirm_Rand.bytebuffer[9] = mbuf[mbufi_GenerateConfirm + 6];
u_GenerateConfirm_Rand.bytebuffer[8] = mbuf[mbufi_GenerateConfirm + 7];
u_GenerateConfirm_Rand.bytebuffer[7] = mbuf[mbufi_GenerateConfirm + 8];
u_GenerateConfirm_Rand.bytebuffer[6] = mbuf[mbufi_GenerateConfirm + 9];
u_GenerateConfirm_Rand.bytebuffer[5] = mbuf[mbufi_GenerateConfirm + 10];
u_GenerateConfirm_Rand.bytebuffer[4] = mbuf[mbufi_GenerateConfirm + 11];
u_GenerateConfirm_Rand.bytebuffer[3] = mbuf[mbufi_GenerateConfirm + 12];
u_GenerateConfirm_Rand.bytebuffer[2] = mbuf[mbufi_GenerateConfirm + 13];
u_GenerateConfirm_Rand.bytebuffer[1] = mbuf[mbufi_GenerateConfirm + 14];
u_GenerateConfirm_Rand.bytebuffer[0] = mbuf[mbufi_GenerateConfirm + 15];
mbufi_GenerateConfirm += 16;
union u_GenerateConfirm_IAT_t {
uint8_t p;
byte bytebuffer[1];
} u_GenerateConfirm_IAT;
u_GenerateConfirm_IAT.bytebuffer[0] = mbuf[mbufi_GenerateConfirm + 0];
mbufi_GenerateConfirm += 1;
union u_GenerateConfirm_IA_t {
bdaddr_t p;
byte bytebuffer[6];
} u_GenerateConfirm_IA;
u_GenerateConfirm_IA.bytebuffer[5] = mbuf[mbufi_GenerateConfirm + 0];
u_GenerateConfirm_IA.bytebuffer[4] = mbuf[mbufi_GenerateConfirm + 1];
u_GenerateConfirm_IA.bytebuffer[3] = mbuf[mbufi_GenerateConfirm + 2];
u_GenerateConfirm_IA.bytebuffer[2] = mbuf[mbufi_GenerateConfirm + 3];
u_GenerateConfirm_IA.bytebuffer[1] = mbuf[mbufi_GenerateConfirm + 4];
u_GenerateConfirm_IA.bytebuffer[0] = mbuf[mbufi_GenerateConfirm + 5];
mbufi_GenerateConfirm += 6;
union u_GenerateConfirm_RAT_t {
uint8_t p;
byte bytebuffer[1];
} u_GenerateConfirm_RAT;
u_GenerateConfirm_RAT.bytebuffer[0] = mbuf[mbufi_GenerateConfirm + 0];
mbufi_GenerateConfirm += 1;
union u_GenerateConfirm_RA_t {
bdaddr_t p;
byte bytebuffer[6];
} u_GenerateConfirm_RA;
u_GenerateConfirm_RA.bytebuffer[5] = mbuf[mbufi_GenerateConfirm + 0];
u_GenerateConfirm_RA.bytebuffer[4] = mbuf[mbufi_GenerateConfirm + 1];
u_GenerateConfirm_RA.bytebuffer[3] = mbuf[mbufi_GenerateConfirm + 2];
u_GenerateConfirm_RA.bytebuffer[2] = mbuf[mbufi_GenerateConfirm + 3];
u_GenerateConfirm_RA.bytebuffer[1] = mbuf[mbufi_GenerateConfirm + 4];
u_GenerateConfirm_RA.bytebuffer[0] = mbuf[mbufi_GenerateConfirm + 5];
mbufi_GenerateConfirm += 6;
dispatch_GenerateConfirm((mbuf[0] << 8) + mbuf[1] /* instance port*/,
 u_GenerateConfirm_Rand.p /* Rand */ ,
 u_GenerateConfirm_IAT.p /* IAT */ ,
 u_GenerateConfirm_IA.p /* IA */ ,
 u_GenerateConfirm_RAT.p /* RAT */ ,
 u_GenerateConfirm_RA.p /* RA */ );
break;
}
case 27:{
byte mbuf[7 - 2];
...
while (mbufi < (4 - 2)) mbuf[mbufi++] = fifo_dequeue();
fifo_unlock();
uint8_t mbufi_GenerateRandomNumber = 2;
dispatch_GenerateRandomNumber((mbuf[0] << 8) + mbuf[1] /* instance port*/);
break;
}
case 36:{
byte mbuf[7 - 2];
...
dispatch_GenerateRandomNumberCompleted((mbuf[0] << 8) + mbuf[1] /* instance port*/,
...
fifo_unlock();
uint8_t mbufi_CheckConfirm = 2;
union u_CheckConfirm_Received_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_CheckConfirm_Received;
u_CheckConfirm_Received.bytebuffer[15] = mbuf[mbufi_CheckConfirm + 0];
u_CheckConfirm_Received.bytebuffer[14] = mbuf[mbufi_CheckConfirm + 1];
u_CheckConfirm_Received.bytebuffer[13] = mbuf[mbufi_CheckConfirm + 2];
u_CheckConfirm_Received.bytebuffer[12] = mbuf[mbufi_CheckConfirm + 3];
u_CheckConfirm_Received.bytebuffer[11] = mbuf[mbufi_CheckConfirm + 4];
u_CheckConfirm_Received.bytebuffer[10] = mbuf[mbufi_CheckConfirm + 5];
u_CheckConfirm_Received.bytebuffer[9] = mbuf[mbufi_CheckConfirm + 6];
u_CheckConfirm_Received.bytebuffer[8] = mbuf[mbufi_CheckConfirm + 7];
u_CheckConfirm_Received.bytebuffer[7] = mbuf[mbufi_CheckConfirm + 8];
u_CheckConfirm_Received.bytebuffer[6] = mbuf[mbufi_CheckConfirm + 9];
u_CheckConfirm_Received.bytebuffer[5] = mbuf[mbufi_CheckConfirm + 10];
u_CheckConfirm_Received.bytebuffer[4] = mbuf[mbufi_CheckConfirm + 11];
u_CheckConfirm_Received.bytebuffer[3] = mbuf[mbufi_CheckConfirm + 12];
u_CheckConfirm_Received.bytebuffer[2] = mbuf[mbufi_CheckConfirm + 13];
u_CheckConfirm_Received.bytebuffer[1] = mbuf[mbufi_CheckConfirm + 14];
u_CheckConfirm_Received.bytebuffer[0] = mbuf[mbufi_CheckConfirm + 15];
mbufi_CheckConfirm += 16;
union u_CheckConfirm_Calculated_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_CheckConfirm_Calculated;
u_CheckConfirm_Calculated.bytebuffer[15] = mbuf[mbufi_CheckConfirm + 0];
u_CheckConfirm_Calculated.bytebuffer[14] = mbuf[mbufi_CheckConfirm + 1];
u_CheckConfirm_Calculated.bytebuffer[13] = mbuf[mbufi_CheckConfirm + 2];
u_CheckConfirm_Calculated.bytebuffer[12] = mbuf[mbufi_CheckConfirm + 3];
u_CheckConfirm_Calculated.bytebuffer[11] = mbuf[mbufi_CheckConfirm + 4];
u_CheckConfirm_Calculated.bytebuffer[10] = mbuf[mbufi_CheckConfirm + 5];
u_CheckConfirm_Calculated.bytebuffer[9] = mbuf[mbufi_CheckConfirm + 6];
u_CheckConfirm_Calculated.bytebuffer[8] = mbuf[mbufi_CheckConfirm + 7];
u_CheckConfirm_Calculated.bytebuffer[7] = mbuf[mbufi_CheckConfirm + 8];
u_CheckConfirm_Calculated.bytebuffer[6] = mbuf[mbufi_CheckConfirm + 9];
u_CheckConfirm_Calculated.bytebuffer[5] = mbuf[mbufi_CheckConfirm + 10];
u_CheckConfirm_Calculated.bytebuffer[4] = mbuf[mbufi_CheckConfirm + 11];
u_CheckConfirm_Calculated.bytebuffer[3] = mbuf[mbufi_CheckConfirm + 12];
u_CheckConfirm_Calculated.bytebuffer[2] = mbuf[mbufi_CheckConfirm + 13];
u_CheckConfirm_Calculated.bytebuffer[1] = mbuf[mbufi_CheckConfirm + 14];
u_CheckConfirm_Calculated.bytebuffer[0] = mbuf[mbufi_CheckConfirm + 15];
mbufi_CheckConfirm += 16;
dispatch_CheckConfirm((mbuf[0] << 8) + mbuf[1] /* instance port*/,
 u_CheckConfirm_Received.p /* Received */ ,
 u_CheckConfirm_Calculated.p /* Calculated */ );
break;
}
case 50:{
byte mbuf[31 - 2];
...
while (mbufi < (36 - 2)) mbuf[mbufi++] = fifo_dequeue();
fifo_unlock();
uint8_t mbufi_GenerateSTK = 2;
union u_GenerateSTK_Srand_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_GenerateSTK_Srand;
u_GenerateSTK_Srand.bytebuffer[15] = mbuf[mbufi_GenerateSTK + 0];
u_GenerateSTK_Srand.bytebuffer[14] = mbuf[mbufi_GenerateSTK + 1];
u_GenerateSTK_Srand.bytebuffer[13] = mbuf[mbufi_GenerateSTK + 2];
u_GenerateSTK_Srand.bytebuffer[12] = mbuf[mbufi_GenerateSTK + 3];
u_GenerateSTK_Srand.bytebuffer[11] = mbuf[mbufi_GenerateSTK + 4];
u_GenerateSTK_Srand.bytebuffer[10] = mbuf[mbufi_GenerateSTK + 5];
u_GenerateSTK_Srand.bytebuffer[9] = mbuf[mbufi_GenerateSTK + 6];
u_GenerateSTK_Srand.bytebuffer[8] = mbuf[mbufi_GenerateSTK + 7];
u_GenerateSTK_Srand.bytebuffer[7] = mbuf[mbufi_GenerateSTK + 8];
u_GenerateSTK_Srand.bytebuffer[6] = mbuf[mbufi_GenerateSTK + 9];
u_GenerateSTK_Srand.bytebuffer[5] = mbuf[mbufi_GenerateSTK + 10];
u_GenerateSTK_Srand.bytebuffer[4] = mbuf[mbufi_GenerateSTK + 11];
u_GenerateSTK_Srand.bytebuffer[3] = mbuf[mbufi_GenerateSTK + 12];
u_GenerateSTK_Srand.bytebuffer[2] = mbuf[mbufi_GenerateSTK + 13];
u_GenerateSTK_Srand.bytebuffer[1] = mbuf[mbufi_GenerateSTK + 14];
u_GenerateSTK_Srand.bytebuffer[0] = mbuf[mbufi_GenerateSTK + 15];
mbufi_GenerateSTK += 16;
union u_GenerateSTK_Mrand_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_GenerateSTK_Mrand;
u_GenerateSTK_Mrand.bytebuffer[15] = mbuf[mbufi_GenerateSTK + 0];
u_GenerateSTK_Mrand.bytebuffer[14] = mbuf[mbufi_GenerateSTK + 1];
u_GenerateSTK_Mrand.bytebuffer[13] = mbuf[mbufi_GenerateSTK + 2];
u_GenerateSTK_Mrand.bytebuffer[12] = mbuf[mbufi_GenerateSTK + 3];
u_GenerateSTK_Mrand.bytebuffer[11] = mbuf[mbufi_GenerateSTK + 4];
u_GenerateSTK_Mrand.bytebuffer[10] = mbuf[mbufi_GenerateSTK + 5];
u_GenerateSTK_Mrand.bytebuffer[9] = mbuf[mbufi_GenerateSTK + 6];
u_GenerateSTK_Mrand.bytebuffer[8] = mbuf[mbufi_GenerateSTK + 7];
u_GenerateSTK_Mrand.bytebuffer[7] = mbuf[mbufi_GenerateSTK + 8];
u_GenerateSTK_Mrand.bytebuffer[6] = mbuf[mbufi_GenerateSTK + 9];
u_GenerateSTK_Mrand.bytebuffer[5] = mbuf[mbufi_GenerateSTK + 10];
u_GenerateSTK_Mrand.bytebuffer[4] = mbuf[mbufi_GenerateSTK + 11];
u_GenerateSTK_Mrand.bytebuffer[3] = mbuf[mbufi_GenerateSTK + 12];
u_GenerateSTK_Mrand.bytebuffer[2] = mbuf[mbufi_GenerateSTK + 13];
u_GenerateSTK_Mrand.bytebuffer[1] = mbuf[mbufi_GenerateSTK + 14];
u_GenerateSTK_Mrand.bytebuffer[0] = mbuf[mbufi_GenerateSTK + 15];
mbufi_GenerateSTK += 16;
dispatch_GenerateSTK((mbuf[0] << 8) + mbuf[1] /* instance port*/,
 u_GenerateSTK_Srand.p /* Srand */ ,
 u_GenerateSTK_Mrand.p /* Mrand */ );
break;
}
case 81:{
byte mbuf[6 - 2];
...
register_Main_send_Encrypter_Start_listener(&enqueue_Main_send_Encrypter_Start);
register_Main_send_Encrypter_GenerateRandomNumber_listener(&enqueue_Main_send_Encrypter_GenerateRandomNumber);
register_Main_send_Encrypter_GenerateConfirm_listener(&enqueue_Main_send_Encrypter_GenerateConfirm);
register_Main_send_Encrypter_CheckConfirm_listener(&enqueue_Main_send_Encrypter_CheckConfirm);
register_Main_send_Encrypter_GenerateSTK_listener(&enqueue_Main_send_Encrypter_GenerateSTK);
register_Main_send_Socket_Open_listener(&enqueue_Main_send_Socket_Open);
register_Main_send_Socket_Close_listener(&enqueue_Main_send_Socket_Close);
register_Main_send_HCICommands_Reset_listener(&enqueue_Main_send_HCICommands_Reset);
register_Main_send_HCICommands_SetEventMask_listener(&enqueue_Main_send_HCICommands_SetEventMask);
register_Main_send_HCICommands_SetEventMaskAll_listener(&enqueue_Main_send_HCICommands_SetEventMaskAll);
register_Main_send_HCICommands_SetLocalName_listener(&enqueue_Main_send_HCICommands_SetLocalName);
register_Main_send_HCICommands_Disconnect_listener(&enqueue_Main_send_HCICommands_Disconnect);
register_Main_send_HCICommands_SetLEEventMask_listener(&enqueue_Main_send_HCICommands_SetLEEventMask);
register_Main_send_HCICommands_SetLEEventMaskAll_listener(&enqueue_Main_send_HCICommands_SetLEEventMaskAll);
register_Main_send_HCICommands_SetLEAdvertisementParameters_listener(&enqueue_Main_send_HCICommands_SetLEAdvertisementParameters);
register_Main_send_HCICommands_SetLEAdvertiseEnable_listener(&enqueue_Main_send_HCICommands_SetLEAdvertiseEnable);
register_Main_send_HCICommands_SetLEAdvertisingData_listener(&enqueue_Main_send_HCICommands_SetLEAdvertisingData);
register_Main_send_HCICommands_SetLEScanResponseData_listener(&enqueue_Main_send_HCICommands_SetLEScanResponseData);
register_Main_send_HCICommands_SetLEScanParameters_listener(&enqueue_Main_send_HCICommands_SetLEScanParameters);
register_Main_send_HCICommands_SetLEScanEnable_listener(&enqueue_Main_send_HCICommands_SetLEScanEnable);
register_Main_send_HCICommands_LECreateConnection_listener(&enqueue_Main_send_HCICommands_LECreateConnection);
register_Main_send_HCICommands_LECreateConnectionCancel_listener(&enqueue_Main_send_HCICommands_LECreateConnectionCancel);
register_Main_send_HCICommands_LERand_listener(&enqueue_Main_send_HCICommands_LERand);
register_Main_send_HCICommands_LEEncrypt_listener(&enqueue_Main_send_HCICommands_LEEncrypt);
register_Main_send_HCICommands_LEStartEncryption_listener(&enqueue_Main_send_HCICommands_LEStartEncryption);
register_Main_send_SMP_SMPPairingRequest_listener(&enqueue_Main_send_SMP_SMPPairingRequest);
register_Main_send_SMP_SMPPairingResponse_listener(&enqueue_Main_send_SMP_SMPPairingResponse);
register_Main_send_SMP_SMPPairingConfirm_listener(&enqueue_Main_send_SMP_SMPPairingConfirm);
register_Main_send_SMP_SMPPairingRandom_listener(&enqueue_Main_send_SMP_SMPPairingRandom);
register_Main_send_SMP_SMPPairingFailed_listener(&enqueue_Main_send_SMP_SMPPairingFailed);
register_Main_send_SMP_SMPPairingPublicKey_listener(&enqueue_Main_send_SMP_SMPPairingPublicKey);
register_Main_send_SMP_SMPPairingDHKeyCheck_listener(&enqueue_Main_send_SMP_SMPPairingDHKeyCheck);
register_Main_send_SMP_SMPKeypressNotification_listener(&enqueue_Main_send_SMP_SMPKeypressNotification);
register_Main_send_SMP_SMPEncryptionInformation_listener(&enqueue_Main_send_SMP_SMPEncryptionInformation);
register_Main_send_SMP_SMPMasterIdentification_listener(&enqueue_Main_send_SMP_SMPMasterIdentification);
register_Main_send_SMP_SMPIdentityInformation_listener(&enqueue_Main_send_SMP_SMPIdentityInformation);
register_Main_send_SMP_SMPIdentityAddressInformation_listener(&enqueue_Main_send_SMP_SMPIdentityAddressInformation);
register_Main_send_SMP_SMPSigningInformation_listener(&enqueue_Main_send_SMP_SMPSigningInformation);
register_Main_send_SMP_SMPSecurityRequest_listener(&enqueue_Main_send_SMP_SMPSecurityRequest);
...
register_BLEEncryptionImpl_send_Encrypter_Started_listener(&enqueue_BLEEncryptionImpl_send_Encrypter_Started);
register_BLEEncryptionImpl_send_Encrypter_Failure_listener(&enqueue_BLEEncryptionImpl_send_Encrypter_Failure);
register_BLEEncryptionImpl_send_Encrypter_GenerateRandomNumberCompleted_listener(&enqueue_BLEEncryptionImpl_send_Encrypter_GenerateRandomNumberCompleted);
register_BLEEncryptionImpl_send_Encrypter_GenerateConfirmCompleted_listener(&enqueue_BLEEncryptionImpl_send_Encrypter_GenerateConfirmCompleted);
register_BLEEncryptionImpl_send_Encrypter_CheckConfirmCompleted_listener(&enqueue_BLEEncryptionImpl_send_Encrypter_CheckConfirmCompleted);
register_BLEEncryptionImpl_send_Encrypter_GenerateSTKCompleted_listener(&enqueue_BLEEncryptionImpl_send_Encrypter_GenerateSTKCompleted);
register_BLEEncryptionImpl_send_Socket_Open_listener(&enqueue_BLEEncryptionImpl_send_Socket_Open);
register_BLEEncryptionImpl_send_Socket_Close_listener(&enqueue_BLEEncryptionImpl_send_Socket_Close);
register_BLEEncryptionImpl_send_HCICommands_Reset_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_Reset);
register_BLEEncryptionImpl_send_HCICommands_SetEventMask_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_SetEventMask);
register_BLEEncryptionImpl_send_HCICommands_SetEventMaskAll_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_SetEventMaskAll);
register_BLEEncryptionImpl_send_HCICommands_SetLocalName_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_SetLocalName);
register_BLEEncryptionImpl_send_HCICommands_Disconnect_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_Disconnect);
register_BLEEncryptionImpl_send_HCICommands_SetLEEventMask_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_SetLEEventMask);
register_BLEEncryptionImpl_send_HCICommands_SetLEEventMaskAll_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_SetLEEventMaskAll);
register_BLEEncryptionImpl_send_HCICommands_SetLEAdvertisementParameters_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_SetLEAdvertisementParameters);
register_BLEEncryptionImpl_send_HCICommands_SetLEAdvertiseEnable_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_SetLEAdvertiseEnable);
register_BLEEncryptionImpl_send_HCICommands_SetLEAdvertisingData_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_SetLEAdvertisingData);
register_BLEEncryptionImpl_send_HCICommands_SetLEScanResponseData_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_SetLEScanResponseData);
register_BLEEncryptionImpl_send_HCICommands_SetLEScanParameters_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_SetLEScanParameters);
register_BLEEncryptionImpl_send_HCICommands_SetLEScanEnable_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_SetLEScanEnable);
register_BLEEncryptionImpl_send_HCICommands_LECreateConnection_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_LECreateConnection);
register_BLEEncryptionImpl_send_HCICommands_LECreateConnectionCancel_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_LECreateConnectionCancel);
register_BLEEncryptionImpl_send_HCICommands_LERand_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_LERand);
register_BLEEncryptionImpl_send_HCICommands_LEEncrypt_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_LEEncrypt);
register_BLEEncryptionImpl_send_HCICommands_LEStartEncryption_listener(&enqueue_BLEEncryptionImpl_send_HCICommands_LEStartEncryption);
register_BLEEncryptionImpl_send_SMP_SMPPairingRequest_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPPairingRequest);
register_BLEEncryptionImpl_send_SMP_SMPPairingResponse_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPPairingResponse);
register_BLEEncryptionImpl_send_SMP_SMPPairingConfirm_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPPairingConfirm);
register_BLEEncryptionImpl_send_SMP_SMPPairingRandom_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPPairingRandom);
register_BLEEncryptionImpl_send_SMP_SMPPairingFailed_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPPairingFailed);
register_BLEEncryptionImpl_send_SMP_SMPPairingPublicKey_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPPairingPublicKey);
register_BLEEncryptionImpl_send_SMP_SMPPairingDHKeyCheck_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPPairingDHKeyCheck);
register_BLEEncryptionImpl_send_SMP_SMPKeypressNotification_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPKeypressNotification);
register_BLEEncryptionImpl_send_SMP_SMPEncryptionInformation_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPEncryptionInformation);
register_BLEEncryptionImpl_send_SMP_SMPMasterIdentification_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPMasterIdentification);
register_BLEEncryptionImpl_send_SMP_SMPIdentityInformation_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPIdentityInformation);
register_BLEEncryptionImpl_send_SMP_SMPIdentityAddressInformation_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPIdentityAddressInformation);
register_BLEEncryptionImpl_send_SMP_SMPSigningInformation_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPSigningInformation);
register_BLEEncryptionImpl_send_SMP_SMPSecurityRequest_listener(&enqueue_BLEEncryptionImpl_send_SMP_SMPSecurityRequest);
register_BLEEncryptionImpl_send_ATT_ATTFindInformationRequest_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTFindInformationRequest);
register_BLEEncryptionImpl_send_ATT_ATTFindInformationResponse_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTFindInformationResponse);
register_BLEEncryptionImpl_send_ATT_ATTFindInformationError_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTFindInformationError);
register_BLEEncryptionImpl_send_ATT_ATTReadByTypeRequest_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTReadByTypeRequest);
register_BLEEncryptionImpl_send_ATT_ATTReadByTypeResponse_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTReadByTypeResponse);
register_BLEEncryptionImpl_send_ATT_ATTReadByTypeError_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTReadByTypeError);
register_BLEEncryptionImpl_send_ATT_ATTReadRequest_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTReadRequest);
register_BLEEncryptionImpl_send_ATT_ATTReadResponse_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTReadResponse);
register_BLEEncryptionImpl_send_ATT_ATTReadError_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTReadError);
register_BLEEncryptionImpl_send_ATT_ATTReadByGroupTypeRequest_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTReadByGroupTypeRequest);
register_BLEEncryptionImpl_send_ATT_ATTReadByGroupTypeResponse_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTReadByGroupTypeResponse);
register_BLEEncryptionImpl_send_ATT_ATTReadByGroupTypeError_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTReadByGroupTypeError);
register_BLEEncryptionImpl_send_ATT_ATTWriteRequest_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTWriteRequest);
register_BLEEncryptionImpl_send_ATT_ATTWriteResponse_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTWriteResponse);
register_BLEEncryptionImpl_send_ATT_ATTWriteError_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTWriteError);
register_BLEEncryptionImpl_send_ATT_ATTWriteCommand_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTWriteCommand);
register_BLEEncryptionImpl_send_ATT_ATTHandleValueNotification_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTHandleValueNotification);
register_BLEEncryptionImpl_send_ATT_ATTHandleValueIndication_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTHandleValueIndication);
register_BLEEncryptionImpl_send_ATT_ATTHandleValueConfirmation_listener(&enqueue_BLEEncryptionImpl_send_ATT_ATTHandleValueConfirmation);
...
hci_var.debug = true;
hci_var.name = hci_var_name;
HCISocketProxyImpl_print_debug(&hci_var, " (HCISocketProxyImpl): Init\n");
...
connecter_var.BLEConnecterImpl_ConnectAddress_var = "5C:31:3E:00:4B:6B";
connecter_var.BLEConnecterImpl_ConnectAddressType_var = BLEADDRESSTYPE_PUBLIC;

connecter_var.debug = true;
connecter_var.name = connecter_var_name;
BLEConnecterImpl_print_debug(&connecter_var, " (BLEConnecterImpl): Init\n");
...
handler_var.debug = true;
handler_var.name = handler_var_name;
ExitHandler_print_debug(&handler_var, " (ExitHandler): Init\n");
...
encrypter_var.debug = true;
encrypter_var.name = encrypter_var_name;
BLEEncryptionImpl_print_debug(&encrypter_var, " (BLEEncryptionImpl): Init\n");
...
initialiser_var.debug = true;
initialiser_var.name = initialiser_var_name;
BLEInitialiserImpl_print_debug(&initialiser_var, " (BLEInitialiserImpl): Init\n");
...
main_var.Main_States_Pairing_State = MAIN_STATES_PAIRING_DONOTHING_STATE;
...
main_var.debug = true;
main_var.name = main_var_name;
Main_print_debug(&main_var, " (Main): Init\n");
