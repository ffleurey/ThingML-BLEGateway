...
#define BLECONNECTERIMPL_STATES_ENCRYPTED_STATE 0
#define BLECONNECTERIMPL_STATES_STATE 1
#define BLECONNECTERIMPL_STATES_FAILURE_STATE 2
#define BLECONNECTERIMPL_STATES_NOTCONNECTED_STATE 3
#define BLECONNECTERIMPL_STATES_CONNECTING_STATE 4
#define BLECONNECTERIMPL_STATES_CANCELCONNECTION_STATE 5
#define BLECONNECTERIMPL_STATES_CONNECTED_STATE 6
#define BLECONNECTERIMPL_STATES_DISCONNECTING_STATE 7
