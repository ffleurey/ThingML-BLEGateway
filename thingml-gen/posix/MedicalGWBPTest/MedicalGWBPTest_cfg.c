 ...
 *      Implementation for Application MedicalGWBPTest
...
/*****************************************************************************
 * Definitions for configuration : MedicalGWBPTest
 *****************************************************************************/
...
void initialize_configuration_MedicalGWBPTest() {
...
int main(int argc, char *argv[]) {
    ...
    initialize_configuration_MedicalGWBPTest();
