...
#define BLESCANNERIMPL_STATES_STANDBY_STATE 0
#define BLESCANNERIMPL_STATES_STATE 1
#define BLESCANNERIMPL_STATES_FAILURE_STATE 2
#define BLESCANNERIMPL_STATES_INITIATING_STATE 3
#define BLESCANNERIMPL_STATES_SCANNING_STATE 4
#define BLESCANNERIMPL_STATES_STOPPING_STATE 5
