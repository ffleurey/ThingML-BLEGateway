...
#define BLEINITIALISERIMPL_STATES_INITIALISE_STATE 1
#define BLEINITIALISERIMPL_STATES_STATE 2
#define BLEINITIALISERIMPL_STATES_CLOSED_STATE 3
#define BLEINITIALISERIMPL_STATES_OPEN_STATE 4
#define BLEINITIALISERIMPL_STATES_FAILURE_STATE 5
#define BLEINITIALISERIMPL_STATES_OPENING_STATE 6
