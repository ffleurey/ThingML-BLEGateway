...
#define HCISOCKETPROXY_SOCKET_CLOSED_STATE 0
#define HCISOCKETPROXY_SOCKET_OPEN_STATE 1
#define HCISOCKETPROXY_SOCKET_STATE 2
#define HCISOCKETPROXY_SOCKET_OPENING_STATE 3
