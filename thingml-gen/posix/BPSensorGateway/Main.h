...
#define MAIN_STATES_STANDBY_STATE 0
#define MAIN_STATES_STANDBY_CONNECT_STATE 1
#define MAIN_STATES_DEINITIALISE_STATE 2
#define MAIN_STATES_STANDBY_DISCONNECTED_STATE 3
#define MAIN_STATES_STANDBY_SYNC_READBATTERY_STATE 4
#define MAIN_STATES_STANDBY_CONNECTED_STATE 5
#define MAIN_STATES_STANDBY_SYNC_TIMESYNC_STATE 6
#define MAIN_STATES_STANDBY_SYNC_GETVALUES_STATE 7
#define MAIN_STATES_FAILED_STATE 8
#define MAIN_STATES_QUIT_STATE 9
#define MAIN_STATES_INITIALISE_STATE 10
#define MAIN_STATES_STANDBY_SCAN_STATE 11
#define MAIN_STATES_STATE 12
#define MAIN_STATES_STANDBY_ENCRYPTED_STATE 13
#define MAIN_STATES_STANDBY_SYNC_STATE 14
