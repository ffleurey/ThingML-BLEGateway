 ...
 *      Implementation for Application BPSensorGateway
...
/*****************************************************************************
 * Definitions for configuration : BPSensorGateway
 *****************************************************************************/
...
// Enqueue of messages Main::Connecter::ConnectToU
void enqueue_Main_send_Connecter_ConnectToU(struct Main_Instance *_instance, uint8_t AddressType, bdaddr_t Address){
fifo_lock();
if ( fifo_byte_available() > 11 ) {
...
// Enqueue of messages Main::Connecter::Stop
void enqueue_Main_send_Connecter_Stop(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::Connecter::Encrypt
void enqueue_Main_send_Connecter_Encrypt(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::Connecter::Connect
void enqueue_Main_send_Connecter_Connect(struct Main_Instance *_instance){
fifo_lock();
if ( fifo_byte_available() > 4 ) {
...
// Enqueue of messages Main::Connecter::ConnectTo
void enqueue_Main_send_Connecter_ConnectTo(struct Main_Instance *_instance, uint8_t AddressType, bdaddr_t Address, ble_random_number_t LongTermKey, uint16_t EncryptedDiversifier, ble_random_part_t RandomNumber){
fifo_lock();
...
// Enqueue of messages Main::ATT::ATTHandleValueIndication
void enqueue_Main_send_ATT_ATTHandleValueIndication(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages Main::ATT::ATTFindInformationError
void enqueue_Main_send_ATT_ATTFindInformationError(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages Main::ATT::ATTWriteCommand
void enqueue_Main_send_ATT_ATTWriteCommand(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages Main::ATT::ATTReadByTypeError
void enqueue_Main_send_ATT_ATTReadByTypeError(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages Main::ATT::ATTWriteResponse
void enqueue_Main_send_ATT_ATTWriteResponse(struct Main_Instance *_instance, uint16_t ConnectionHandle){
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
// Enqueue of messages Main::ATT::ATTFindInformationRequest
void enqueue_Main_send_ATT_ATTFindInformationRequest(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t StartingHandle, uint16_t EndingHandle){
fifo_lock();
if ( fifo_byte_available() > 10 ) {
...
// Enqueue of messages Main::ATT::ATTReadByTypeResponse
void enqueue_Main_send_ATT_ATTReadByTypeResponse(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint8_t Length, ble_gatt_data_t AttributeDataList){
fifo_lock();
if ( fifo_byte_available() > 31 ) {
...
// Enqueue of messages Main::ATT::ATTFindInformationResponse
void enqueue_Main_send_ATT_ATTFindInformationResponse(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint8_t Format, ble_gatt_data_t InformationData){
fifo_lock();
if ( fifo_byte_available() > 31 ) {
...
// Enqueue of messages Main::ATT::ATTReadByTypeRequest
void enqueue_Main_send_ATT_ATTReadByTypeRequest(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t StartingHandle, uint16_t EndingHandle, ble_uuid_t AttributeType){
fifo_lock();
if ( fifo_byte_available() > 26 ) {
...
// Enqueue of messages Main::ATT::ATTReadResponse
void enqueue_Main_send_ATT_ATTReadResponse(struct Main_Instance *_instance, uint16_t ConnectionHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 30 ) {
...
// Enqueue of messages Main::ATT::ATTReadRequest
void enqueue_Main_send_ATT_ATTReadRequest(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle){
fifo_lock();
if ( fifo_byte_available() > 8 ) {
...
// Enqueue of messages Main::ATT::ATTHandleValueConfirmation
void enqueue_Main_send_ATT_ATTHandleValueConfirmation(struct Main_Instance *_instance, uint16_t ConnectionHandle){
fifo_lock();
if ( fifo_byte_available() > 6 ) {
...
// Enqueue of messages Main::ATT::ATTReadByGroupTypeResponse
void enqueue_Main_send_ATT_ATTReadByGroupTypeResponse(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint8_t Length, ble_gatt_data_t AttributeDataList){
fifo_lock();
if ( fifo_byte_available() > 31 ) {
...
// Enqueue of messages Main::ATT::ATTWriteError
void enqueue_Main_send_ATT_ATTWriteError(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages Main::ATT::ATTReadByGroupTypeError
void enqueue_Main_send_ATT_ATTReadByGroupTypeError(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages Main::ATT::ATTHandleValueNotification
void enqueue_Main_send_ATT_ATTHandleValueNotification(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
// Enqueue of messages Main::ATT::ATTReadByGroupTypeRequest
void enqueue_Main_send_ATT_ATTReadByGroupTypeRequest(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t StartingHandle, uint16_t EndingHandle, ble_uuid_t AttributeGroupType){
fifo_lock();
if ( fifo_byte_available() > 26 ) {
...
// Enqueue of messages Main::ATT::ATTReadError
void enqueue_Main_send_ATT_ATTReadError(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, uint8_t Error){
fifo_lock();
if ( fifo_byte_available() > 9 ) {
...
// Enqueue of messages Main::ATT::ATTWriteRequest
void enqueue_Main_send_ATT_ATTWriteRequest(struct Main_Instance *_instance, uint16_t ConnectionHandle, uint16_t AttributeHandle, ble_gatt_data_t AttributeValue){
fifo_lock();
if ( fifo_byte_available() > 32 ) {
...
if (sender == hci_var.id_ATT) {
Main_handle_ATT_ATTWriteError(&main_var, param_ConnectionHandle, param_AttributeHandle, param_Error);
...
if (sender == hci_var.id_ATT) {
Main_handle_ATT_ATTReadError(&main_var, param_ConnectionHandle, param_AttributeHandle, param_Error);
...
if (sender == hci_var.id_ATT) {
Main_handle_ATT_ATTHandleValueIndication(&main_var, param_ConnectionHandle, param_AttributeHandle, param_AttributeValue);
...
Main_handle_Connecter_Connected(&main_var, param_Handle, param_AddressType, param_Address);
...
if (sender == hci_var.id_ATT) {
Main_handle_ATT_ATTWriteResponse(&main_var, param_ConnectionHandle);
...
if (sender == connecter_var.id_Connecter) {
Main_handle_Connecter_Encrypted(&main_var);
...
if (sender == connecter_var.id_Connecter) {
Main_handle_Connecter_Failure(&main_var);
...
if (sender == hci_var.id_ATT) {
Main_handle_ATT_ATTReadResponse(&main_var, param_ConnectionHandle, param_AttributeValue);
...
if (sender == connecter_var.id_Connecter) {
Main_handle_Connecter_Stopped(&main_var);
...
if (sender == scanner_var.id_Scanner) {
Main_handle_Scanner_ConnectableAdvertisement(&main_var, param_AddressType, param_Address);
...
u_ATTWriteCommand_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTWriteCommand + 0];
u_ATTWriteCommand_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTWriteCommand + 1];
mbufi_ATTWriteCommand += 2;
union u_ATTWriteCommand_AttributeHandle_t {
uint16_t p;
byte bytebuffer[2];
} u_ATTWriteCommand_AttributeHandle;
u_ATTWriteCommand_AttributeHandle.bytebuffer[0] = mbuf[mbufi_ATTWriteCommand + 0];
u_ATTWriteCommand_AttributeHandle.bytebuffer[1] = mbuf[mbufi_ATTWriteCommand + 1];
mbufi_ATTWriteCommand += 2;
union u_ATTWriteCommand_AttributeValue_t {
ble_gatt_data_t p;
byte bytebuffer[24];
} u_ATTWriteCommand_AttributeValue;
u_ATTWriteCommand_AttributeValue.bytebuffer[0] = mbuf[mbufi_ATTWriteCommand + 0];
u_ATTWriteCommand_AttributeValue.bytebuffer[1] = mbuf[mbufi_ATTWriteCommand + 1];
u_ATTWriteCommand_AttributeValue.bytebuffer[2] = mbuf[mbufi_ATTWriteCommand + 2];
u_ATTWriteCommand_AttributeValue.bytebuffer[3] = mbuf[mbufi_ATTWriteCommand + 3];
u_ATTWriteCommand_AttributeValue.bytebuffer[4] = mbuf[mbufi_ATTWriteCommand + 4];
u_ATTWriteCommand_AttributeValue.bytebuffer[5] = mbuf[mbufi_ATTWriteCommand + 5];
u_ATTWriteCommand_AttributeValue.bytebuffer[6] = mbuf[mbufi_ATTWriteCommand + 6];
u_ATTWriteCommand_AttributeValue.bytebuffer[7] = mbuf[mbufi_ATTWriteCommand + 7];
u_ATTWriteCommand_AttributeValue.bytebuffer[8] = mbuf[mbufi_ATTWriteCommand + 8];
u_ATTWriteCommand_AttributeValue.bytebuffer[9] = mbuf[mbufi_ATTWriteCommand + 9];
u_ATTWriteCommand_AttributeValue.bytebuffer[10] = mbuf[mbufi_ATTWriteCommand + 10];
u_ATTWriteCommand_AttributeValue.bytebuffer[11] = mbuf[mbufi_ATTWriteCommand + 11];
u_ATTWriteCommand_AttributeValue.bytebuffer[12] = mbuf[mbufi_ATTWriteCommand + 12];
u_ATTWriteCommand_AttributeValue.bytebuffer[13] = mbuf[mbufi_ATTWriteCommand + 13];
u_ATTWriteCommand_AttributeValue.bytebuffer[14] = mbuf[mbufi_ATTWriteCommand + 14];
u_ATTWriteCommand_AttributeValue.bytebuffer[15] = mbuf[mbufi_ATTWriteCommand + 15];
u_ATTWriteCommand_AttributeValue.bytebuffer[16] = mbuf[mbufi_ATTWriteCommand + 16];
u_ATTWriteCommand_AttributeValue.bytebuffer[17] = mbuf[mbufi_ATTWriteCommand + 17];
u_ATTWriteCommand_AttributeValue.bytebuffer[18] = mbuf[mbufi_ATTWriteCommand + 18];
u_ATTWriteCommand_AttributeValue.bytebuffer[19] = mbuf[mbufi_ATTWriteCommand + 19];
u_ATTWriteCommand_AttributeValue.bytebuffer[20] = mbuf[mbufi_ATTWriteCommand + 20];
u_ATTWriteCommand_AttributeValue.bytebuffer[21] = mbuf[mbufi_ATTWriteCommand + 21];
u_ATTWriteCommand_AttributeValue.bytebuffer[22] = mbuf[mbufi_ATTWriteCommand + 22];
u_ATTWriteCommand_AttributeValue.bytebuffer[23] = mbuf[mbufi_ATTWriteCommand + 23];
...
u_SMPPairingDHKeyCheck_Handle.bytebuffer[0] = mbuf[mbufi_SMPPairingDHKeyCheck + 0];
u_SMPPairingDHKeyCheck_Handle.bytebuffer[1] = mbuf[mbufi_SMPPairingDHKeyCheck + 1];
mbufi_SMPPairingDHKeyCheck += 2;
union u_SMPPairingDHKeyCheck_DHKeyCheck_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_SMPPairingDHKeyCheck_DHKeyCheck;
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[0] = mbuf[mbufi_SMPPairingDHKeyCheck + 0];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[1] = mbuf[mbufi_SMPPairingDHKeyCheck + 1];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[2] = mbuf[mbufi_SMPPairingDHKeyCheck + 2];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[3] = mbuf[mbufi_SMPPairingDHKeyCheck + 3];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[4] = mbuf[mbufi_SMPPairingDHKeyCheck + 4];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[5] = mbuf[mbufi_SMPPairingDHKeyCheck + 5];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[6] = mbuf[mbufi_SMPPairingDHKeyCheck + 6];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[7] = mbuf[mbufi_SMPPairingDHKeyCheck + 7];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[8] = mbuf[mbufi_SMPPairingDHKeyCheck + 8];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[9] = mbuf[mbufi_SMPPairingDHKeyCheck + 9];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[10] = mbuf[mbufi_SMPPairingDHKeyCheck + 10];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[11] = mbuf[mbufi_SMPPairingDHKeyCheck + 11];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[12] = mbuf[mbufi_SMPPairingDHKeyCheck + 12];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[13] = mbuf[mbufi_SMPPairingDHKeyCheck + 13];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[14] = mbuf[mbufi_SMPPairingDHKeyCheck + 14];
u_SMPPairingDHKeyCheck_DHKeyCheck.bytebuffer[15] = mbuf[mbufi_SMPPairingDHKeyCheck + 15];
...
u_SMPMasterIdentification_Handle.bytebuffer[0] = mbuf[mbufi_SMPMasterIdentification + 0];
u_SMPMasterIdentification_Handle.bytebuffer[1] = mbuf[mbufi_SMPMasterIdentification + 1];
mbufi_SMPMasterIdentification += 2;
union u_SMPMasterIdentification_EDIV_t {
uint16_t p;
byte bytebuffer[2];
} u_SMPMasterIdentification_EDIV;
u_SMPMasterIdentification_EDIV.bytebuffer[0] = mbuf[mbufi_SMPMasterIdentification + 0];
u_SMPMasterIdentification_EDIV.bytebuffer[1] = mbuf[mbufi_SMPMasterIdentification + 1];
mbufi_SMPMasterIdentification += 2;
union u_SMPMasterIdentification_Rand_t {
ble_random_part_t p;
byte bytebuffer[8];
} u_SMPMasterIdentification_Rand;
u_SMPMasterIdentification_Rand.bytebuffer[0] = mbuf[mbufi_SMPMasterIdentification + 0];
u_SMPMasterIdentification_Rand.bytebuffer[1] = mbuf[mbufi_SMPMasterIdentification + 1];
u_SMPMasterIdentification_Rand.bytebuffer[2] = mbuf[mbufi_SMPMasterIdentification + 2];
u_SMPMasterIdentification_Rand.bytebuffer[3] = mbuf[mbufi_SMPMasterIdentification + 3];
u_SMPMasterIdentification_Rand.bytebuffer[4] = mbuf[mbufi_SMPMasterIdentification + 4];
u_SMPMasterIdentification_Rand.bytebuffer[5] = mbuf[mbufi_SMPMasterIdentification + 5];
u_SMPMasterIdentification_Rand.bytebuffer[6] = mbuf[mbufi_SMPMasterIdentification + 6];
u_SMPMasterIdentification_Rand.bytebuffer[7] = mbuf[mbufi_SMPMasterIdentification + 7];
...
u_ConnectToU_Address.bytebuffer[0] = mbuf[mbufi_ConnectToU + 0];
u_ConnectToU_Address.bytebuffer[1] = mbuf[mbufi_ConnectToU + 1];
u_ConnectToU_Address.bytebuffer[2] = mbuf[mbufi_ConnectToU + 2];
u_ConnectToU_Address.bytebuffer[3] = mbuf[mbufi_ConnectToU + 3];
u_ConnectToU_Address.bytebuffer[4] = mbuf[mbufi_ConnectToU + 4];
u_ConnectToU_Address.bytebuffer[5] = mbuf[mbufi_ConnectToU + 5];
mbufi_ConnectToU += 6;
...
u_Quit_code.bytebuffer[0] = mbuf[mbufi_Quit + 0];
u_Quit_code.bytebuffer[1] = mbuf[mbufi_Quit + 1];
mbufi_Quit += 2;
...
u_ATTFindInformationResponse_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTFindInformationResponse + 0];
u_ATTFindInformationResponse_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTFindInformationResponse + 1];
...
u_ATTFindInformationResponse_InformationData.bytebuffer[0] = mbuf[mbufi_ATTFindInformationResponse + 0];
u_ATTFindInformationResponse_InformationData.bytebuffer[1] = mbuf[mbufi_ATTFindInformationResponse + 1];
u_ATTFindInformationResponse_InformationData.bytebuffer[2] = mbuf[mbufi_ATTFindInformationResponse + 2];
u_ATTFindInformationResponse_InformationData.bytebuffer[3] = mbuf[mbufi_ATTFindInformationResponse + 3];
u_ATTFindInformationResponse_InformationData.bytebuffer[4] = mbuf[mbufi_ATTFindInformationResponse + 4];
u_ATTFindInformationResponse_InformationData.bytebuffer[5] = mbuf[mbufi_ATTFindInformationResponse + 5];
u_ATTFindInformationResponse_InformationData.bytebuffer[6] = mbuf[mbufi_ATTFindInformationResponse + 6];
u_ATTFindInformationResponse_InformationData.bytebuffer[7] = mbuf[mbufi_ATTFindInformationResponse + 7];
u_ATTFindInformationResponse_InformationData.bytebuffer[8] = mbuf[mbufi_ATTFindInformationResponse + 8];
u_ATTFindInformationResponse_InformationData.bytebuffer[9] = mbuf[mbufi_ATTFindInformationResponse + 9];
u_ATTFindInformationResponse_InformationData.bytebuffer[10] = mbuf[mbufi_ATTFindInformationResponse + 10];
u_ATTFindInformationResponse_InformationData.bytebuffer[11] = mbuf[mbufi_ATTFindInformationResponse + 11];
u_ATTFindInformationResponse_InformationData.bytebuffer[12] = mbuf[mbufi_ATTFindInformationResponse + 12];
u_ATTFindInformationResponse_InformationData.bytebuffer[13] = mbuf[mbufi_ATTFindInformationResponse + 13];
u_ATTFindInformationResponse_InformationData.bytebuffer[14] = mbuf[mbufi_ATTFindInformationResponse + 14];
u_ATTFindInformationResponse_InformationData.bytebuffer[15] = mbuf[mbufi_ATTFindInformationResponse + 15];
u_ATTFindInformationResponse_InformationData.bytebuffer[16] = mbuf[mbufi_ATTFindInformationResponse + 16];
u_ATTFindInformationResponse_InformationData.bytebuffer[17] = mbuf[mbufi_ATTFindInformationResponse + 17];
u_ATTFindInformationResponse_InformationData.bytebuffer[18] = mbuf[mbufi_ATTFindInformationResponse + 18];
u_ATTFindInformationResponse_InformationData.bytebuffer[19] = mbuf[mbufi_ATTFindInformationResponse + 19];
u_ATTFindInformationResponse_InformationData.bytebuffer[20] = mbuf[mbufi_ATTFindInformationResponse + 20];
u_ATTFindInformationResponse_InformationData.bytebuffer[21] = mbuf[mbufi_ATTFindInformationResponse + 21];
u_ATTFindInformationResponse_InformationData.bytebuffer[22] = mbuf[mbufi_ATTFindInformationResponse + 22];
u_ATTFindInformationResponse_InformationData.bytebuffer[23] = mbuf[mbufi_ATTFindInformationResponse + 23];
...
u_ATTReadResponse_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTReadResponse + 0];
u_ATTReadResponse_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTReadResponse + 1];
mbufi_ATTReadResponse += 2;
union u_ATTReadResponse_AttributeValue_t {
ble_gatt_data_t p;
byte bytebuffer[24];
} u_ATTReadResponse_AttributeValue;
u_ATTReadResponse_AttributeValue.bytebuffer[0] = mbuf[mbufi_ATTReadResponse + 0];
u_ATTReadResponse_AttributeValue.bytebuffer[1] = mbuf[mbufi_ATTReadResponse + 1];
u_ATTReadResponse_AttributeValue.bytebuffer[2] = mbuf[mbufi_ATTReadResponse + 2];
u_ATTReadResponse_AttributeValue.bytebuffer[3] = mbuf[mbufi_ATTReadResponse + 3];
u_ATTReadResponse_AttributeValue.bytebuffer[4] = mbuf[mbufi_ATTReadResponse + 4];
u_ATTReadResponse_AttributeValue.bytebuffer[5] = mbuf[mbufi_ATTReadResponse + 5];
u_ATTReadResponse_AttributeValue.bytebuffer[6] = mbuf[mbufi_ATTReadResponse + 6];
u_ATTReadResponse_AttributeValue.bytebuffer[7] = mbuf[mbufi_ATTReadResponse + 7];
u_ATTReadResponse_AttributeValue.bytebuffer[8] = mbuf[mbufi_ATTReadResponse + 8];
u_ATTReadResponse_AttributeValue.bytebuffer[9] = mbuf[mbufi_ATTReadResponse + 9];
u_ATTReadResponse_AttributeValue.bytebuffer[10] = mbuf[mbufi_ATTReadResponse + 10];
u_ATTReadResponse_AttributeValue.bytebuffer[11] = mbuf[mbufi_ATTReadResponse + 11];
u_ATTReadResponse_AttributeValue.bytebuffer[12] = mbuf[mbufi_ATTReadResponse + 12];
u_ATTReadResponse_AttributeValue.bytebuffer[13] = mbuf[mbufi_ATTReadResponse + 13];
u_ATTReadResponse_AttributeValue.bytebuffer[14] = mbuf[mbufi_ATTReadResponse + 14];
u_ATTReadResponse_AttributeValue.bytebuffer[15] = mbuf[mbufi_ATTReadResponse + 15];
u_ATTReadResponse_AttributeValue.bytebuffer[16] = mbuf[mbufi_ATTReadResponse + 16];
u_ATTReadResponse_AttributeValue.bytebuffer[17] = mbuf[mbufi_ATTReadResponse + 17];
u_ATTReadResponse_AttributeValue.bytebuffer[18] = mbuf[mbufi_ATTReadResponse + 18];
u_ATTReadResponse_AttributeValue.bytebuffer[19] = mbuf[mbufi_ATTReadResponse + 19];
u_ATTReadResponse_AttributeValue.bytebuffer[20] = mbuf[mbufi_ATTReadResponse + 20];
u_ATTReadResponse_AttributeValue.bytebuffer[21] = mbuf[mbufi_ATTReadResponse + 21];
u_ATTReadResponse_AttributeValue.bytebuffer[22] = mbuf[mbufi_ATTReadResponse + 22];
u_ATTReadResponse_AttributeValue.bytebuffer[23] = mbuf[mbufi_ATTReadResponse + 23];
...
u_ATTWriteError_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTWriteError + 0];
u_ATTWriteError_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTWriteError + 1];
mbufi_ATTWriteError += 2;
union u_ATTWriteError_AttributeHandle_t {
uint16_t p;
byte bytebuffer[2];
} u_ATTWriteError_AttributeHandle;
u_ATTWriteError_AttributeHandle.bytebuffer[0] = mbuf[mbufi_ATTWriteError + 0];
u_ATTWriteError_AttributeHandle.bytebuffer[1] = mbuf[mbufi_ATTWriteError + 1];
mbufi_ATTWriteError += 2;
...
u_LEAdvertisementReport_Address.bytebuffer[0] = mbuf[mbufi_LEAdvertisementReport + 0];
u_LEAdvertisementReport_Address.bytebuffer[1] = mbuf[mbufi_LEAdvertisementReport + 1];
u_LEAdvertisementReport_Address.bytebuffer[2] = mbuf[mbufi_LEAdvertisementReport + 2];
u_LEAdvertisementReport_Address.bytebuffer[3] = mbuf[mbufi_LEAdvertisementReport + 3];
u_LEAdvertisementReport_Address.bytebuffer[4] = mbuf[mbufi_LEAdvertisementReport + 4];
u_LEAdvertisementReport_Address.bytebuffer[5] = mbuf[mbufi_LEAdvertisementReport + 5];
...
u_LEAdvertisementReport_Data.bytebuffer[0] = mbuf[mbufi_LEAdvertisementReport + 0];
u_LEAdvertisementReport_Data.bytebuffer[1] = mbuf[mbufi_LEAdvertisementReport + 1];
u_LEAdvertisementReport_Data.bytebuffer[2] = mbuf[mbufi_LEAdvertisementReport + 2];
u_LEAdvertisementReport_Data.bytebuffer[3] = mbuf[mbufi_LEAdvertisementReport + 3];
u_LEAdvertisementReport_Data.bytebuffer[4] = mbuf[mbufi_LEAdvertisementReport + 4];
u_LEAdvertisementReport_Data.bytebuffer[5] = mbuf[mbufi_LEAdvertisementReport + 5];
u_LEAdvertisementReport_Data.bytebuffer[6] = mbuf[mbufi_LEAdvertisementReport + 6];
u_LEAdvertisementReport_Data.bytebuffer[7] = mbuf[mbufi_LEAdvertisementReport + 7];
u_LEAdvertisementReport_Data.bytebuffer[8] = mbuf[mbufi_LEAdvertisementReport + 8];
u_LEAdvertisementReport_Data.bytebuffer[9] = mbuf[mbufi_LEAdvertisementReport + 9];
u_LEAdvertisementReport_Data.bytebuffer[10] = mbuf[mbufi_LEAdvertisementReport + 10];
u_LEAdvertisementReport_Data.bytebuffer[11] = mbuf[mbufi_LEAdvertisementReport + 11];
u_LEAdvertisementReport_Data.bytebuffer[12] = mbuf[mbufi_LEAdvertisementReport + 12];
u_LEAdvertisementReport_Data.bytebuffer[13] = mbuf[mbufi_LEAdvertisementReport + 13];
u_LEAdvertisementReport_Data.bytebuffer[14] = mbuf[mbufi_LEAdvertisementReport + 14];
u_LEAdvertisementReport_Data.bytebuffer[15] = mbuf[mbufi_LEAdvertisementReport + 15];
u_LEAdvertisementReport_Data.bytebuffer[16] = mbuf[mbufi_LEAdvertisementReport + 16];
u_LEAdvertisementReport_Data.bytebuffer[17] = mbuf[mbufi_LEAdvertisementReport + 17];
u_LEAdvertisementReport_Data.bytebuffer[18] = mbuf[mbufi_LEAdvertisementReport + 18];
u_LEAdvertisementReport_Data.bytebuffer[19] = mbuf[mbufi_LEAdvertisementReport + 19];
u_LEAdvertisementReport_Data.bytebuffer[20] = mbuf[mbufi_LEAdvertisementReport + 20];
u_LEAdvertisementReport_Data.bytebuffer[21] = mbuf[mbufi_LEAdvertisementReport + 21];
u_LEAdvertisementReport_Data.bytebuffer[22] = mbuf[mbufi_LEAdvertisementReport + 22];
u_LEAdvertisementReport_Data.bytebuffer[23] = mbuf[mbufi_LEAdvertisementReport + 23];
u_LEAdvertisementReport_Data.bytebuffer[24] = mbuf[mbufi_LEAdvertisementReport + 24];
u_LEAdvertisementReport_Data.bytebuffer[25] = mbuf[mbufi_LEAdvertisementReport + 25];
u_LEAdvertisementReport_Data.bytebuffer[26] = mbuf[mbufi_LEAdvertisementReport + 26];
u_LEAdvertisementReport_Data.bytebuffer[27] = mbuf[mbufi_LEAdvertisementReport + 27];
u_LEAdvertisementReport_Data.bytebuffer[28] = mbuf[mbufi_LEAdvertisementReport + 28];
u_LEAdvertisementReport_Data.bytebuffer[29] = mbuf[mbufi_LEAdvertisementReport + 29];
u_LEAdvertisementReport_Data.bytebuffer[30] = mbuf[mbufi_LEAdvertisementReport + 30];
...
u_LECreateConnection_Interval.bytebuffer[0] = mbuf[mbufi_LECreateConnection + 0];
u_LECreateConnection_Interval.bytebuffer[1] = mbuf[mbufi_LECreateConnection + 1];
mbufi_LECreateConnection += 2;
union u_LECreateConnection_Window_t {
uint16_t p;
byte bytebuffer[2];
} u_LECreateConnection_Window;
u_LECreateConnection_Window.bytebuffer[0] = mbuf[mbufi_LECreateConnection + 0];
u_LECreateConnection_Window.bytebuffer[1] = mbuf[mbufi_LECreateConnection + 1];
mbufi_LECreateConnection += 2;
...
u_LECreateConnection_PeerAddress.bytebuffer[0] = mbuf[mbufi_LECreateConnection + 0];
u_LECreateConnection_PeerAddress.bytebuffer[1] = mbuf[mbufi_LECreateConnection + 1];
u_LECreateConnection_PeerAddress.bytebuffer[2] = mbuf[mbufi_LECreateConnection + 2];
u_LECreateConnection_PeerAddress.bytebuffer[3] = mbuf[mbufi_LECreateConnection + 3];
u_LECreateConnection_PeerAddress.bytebuffer[4] = mbuf[mbufi_LECreateConnection + 4];
u_LECreateConnection_PeerAddress.bytebuffer[5] = mbuf[mbufi_LECreateConnection + 5];
...
u_LECreateConnection_ConnIntervalMin.bytebuffer[0] = mbuf[mbufi_LECreateConnection + 0];
u_LECreateConnection_ConnIntervalMin.bytebuffer[1] = mbuf[mbufi_LECreateConnection + 1];
mbufi_LECreateConnection += 2;
union u_LECreateConnection_ConnIntervalMax_t {
uint16_t p;
byte bytebuffer[2];
} u_LECreateConnection_ConnIntervalMax;
u_LECreateConnection_ConnIntervalMax.bytebuffer[0] = mbuf[mbufi_LECreateConnection + 0];
u_LECreateConnection_ConnIntervalMax.bytebuffer[1] = mbuf[mbufi_LECreateConnection + 1];
mbufi_LECreateConnection += 2;
union u_LECreateConnection_ConnLatency_t {
uint16_t p;
byte bytebuffer[2];
} u_LECreateConnection_ConnLatency;
u_LECreateConnection_ConnLatency.bytebuffer[0] = mbuf[mbufi_LECreateConnection + 0];
u_LECreateConnection_ConnLatency.bytebuffer[1] = mbuf[mbufi_LECreateConnection + 1];
mbufi_LECreateConnection += 2;
union u_LECreateConnection_SupervisionTimeout_t {
uint16_t p;
byte bytebuffer[2];
} u_LECreateConnection_SupervisionTimeout;
u_LECreateConnection_SupervisionTimeout.bytebuffer[0] = mbuf[mbufi_LECreateConnection + 0];
u_LECreateConnection_SupervisionTimeout.bytebuffer[1] = mbuf[mbufi_LECreateConnection + 1];
mbufi_LECreateConnection += 2;
union u_LECreateConnection_CELengthMin_t {
uint16_t p;
byte bytebuffer[2];
} u_LECreateConnection_CELengthMin;
u_LECreateConnection_CELengthMin.bytebuffer[0] = mbuf[mbufi_LECreateConnection + 0];
u_LECreateConnection_CELengthMin.bytebuffer[1] = mbuf[mbufi_LECreateConnection + 1];
mbufi_LECreateConnection += 2;
union u_LECreateConnection_CELengthMax_t {
uint16_t p;
byte bytebuffer[2];
} u_LECreateConnection_CELengthMax;
u_LECreateConnection_CELengthMax.bytebuffer[0] = mbuf[mbufi_LECreateConnection + 0];
u_LECreateConnection_CELengthMax.bytebuffer[1] = mbuf[mbufi_LECreateConnection + 1];
mbufi_LECreateConnection += 2;
...
u_SetLEAdvertisementParameters_MinInterval.bytebuffer[0] = mbuf[mbufi_SetLEAdvertisementParameters + 0];
u_SetLEAdvertisementParameters_MinInterval.bytebuffer[1] = mbuf[mbufi_SetLEAdvertisementParameters + 1];
...
u_SetLEAdvertisementParameters_MaxInterval.bytebuffer[0] = mbuf[mbufi_SetLEAdvertisementParameters + 0];
u_SetLEAdvertisementParameters_MaxInterval.bytebuffer[1] = mbuf[mbufi_SetLEAdvertisementParameters + 1];
mbufi_SetLEAdvertisementParameters += 2;
...
u_SetLEAdvertisementParameters_PeerAddress.bytebuffer[0] = mbuf[mbufi_SetLEAdvertisementParameters + 0];
u_SetLEAdvertisementParameters_PeerAddress.bytebuffer[1] = mbuf[mbufi_SetLEAdvertisementParameters + 1];
u_SetLEAdvertisementParameters_PeerAddress.bytebuffer[2] = mbuf[mbufi_SetLEAdvertisementParameters + 2];
u_SetLEAdvertisementParameters_PeerAddress.bytebuffer[3] = mbuf[mbufi_SetLEAdvertisementParameters + 3];
u_SetLEAdvertisementParameters_PeerAddress.bytebuffer[4] = mbuf[mbufi_SetLEAdvertisementParameters + 4];
u_SetLEAdvertisementParameters_PeerAddress.bytebuffer[5] = mbuf[mbufi_SetLEAdvertisementParameters + 5];
...
u_LEEncrypt_Key.bytebuffer[0] = mbuf[mbufi_LEEncrypt + 0];
u_LEEncrypt_Key.bytebuffer[1] = mbuf[mbufi_LEEncrypt + 1];
u_LEEncrypt_Key.bytebuffer[2] = mbuf[mbufi_LEEncrypt + 2];
u_LEEncrypt_Key.bytebuffer[3] = mbuf[mbufi_LEEncrypt + 3];
u_LEEncrypt_Key.bytebuffer[4] = mbuf[mbufi_LEEncrypt + 4];
u_LEEncrypt_Key.bytebuffer[5] = mbuf[mbufi_LEEncrypt + 5];
u_LEEncrypt_Key.bytebuffer[6] = mbuf[mbufi_LEEncrypt + 6];
u_LEEncrypt_Key.bytebuffer[7] = mbuf[mbufi_LEEncrypt + 7];
u_LEEncrypt_Key.bytebuffer[8] = mbuf[mbufi_LEEncrypt + 8];
u_LEEncrypt_Key.bytebuffer[9] = mbuf[mbufi_LEEncrypt + 9];
u_LEEncrypt_Key.bytebuffer[10] = mbuf[mbufi_LEEncrypt + 10];
u_LEEncrypt_Key.bytebuffer[11] = mbuf[mbufi_LEEncrypt + 11];
u_LEEncrypt_Key.bytebuffer[12] = mbuf[mbufi_LEEncrypt + 12];
u_LEEncrypt_Key.bytebuffer[13] = mbuf[mbufi_LEEncrypt + 13];
u_LEEncrypt_Key.bytebuffer[14] = mbuf[mbufi_LEEncrypt + 14];
u_LEEncrypt_Key.bytebuffer[15] = mbuf[mbufi_LEEncrypt + 15];
mbufi_LEEncrypt += 16;
union u_LEEncrypt_Plaintext_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_LEEncrypt_Plaintext;
u_LEEncrypt_Plaintext.bytebuffer[0] = mbuf[mbufi_LEEncrypt + 0];
u_LEEncrypt_Plaintext.bytebuffer[1] = mbuf[mbufi_LEEncrypt + 1];
u_LEEncrypt_Plaintext.bytebuffer[2] = mbuf[mbufi_LEEncrypt + 2];
u_LEEncrypt_Plaintext.bytebuffer[3] = mbuf[mbufi_LEEncrypt + 3];
u_LEEncrypt_Plaintext.bytebuffer[4] = mbuf[mbufi_LEEncrypt + 4];
u_LEEncrypt_Plaintext.bytebuffer[5] = mbuf[mbufi_LEEncrypt + 5];
u_LEEncrypt_Plaintext.bytebuffer[6] = mbuf[mbufi_LEEncrypt + 6];
u_LEEncrypt_Plaintext.bytebuffer[7] = mbuf[mbufi_LEEncrypt + 7];
u_LEEncrypt_Plaintext.bytebuffer[8] = mbuf[mbufi_LEEncrypt + 8];
u_LEEncrypt_Plaintext.bytebuffer[9] = mbuf[mbufi_LEEncrypt + 9];
u_LEEncrypt_Plaintext.bytebuffer[10] = mbuf[mbufi_LEEncrypt + 10];
u_LEEncrypt_Plaintext.bytebuffer[11] = mbuf[mbufi_LEEncrypt + 11];
u_LEEncrypt_Plaintext.bytebuffer[12] = mbuf[mbufi_LEEncrypt + 12];
u_LEEncrypt_Plaintext.bytebuffer[13] = mbuf[mbufi_LEEncrypt + 13];
u_LEEncrypt_Plaintext.bytebuffer[14] = mbuf[mbufi_LEEncrypt + 14];
u_LEEncrypt_Plaintext.bytebuffer[15] = mbuf[mbufi_LEEncrypt + 15];
mbufi_LEEncrypt += 16;
...
u_ATTReadByGroupTypeRequest_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByGroupTypeRequest + 0];
u_ATTReadByGroupTypeRequest_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByGroupTypeRequest + 1];
...
u_ATTReadByGroupTypeRequest_StartingHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByGroupTypeRequest + 0];
u_ATTReadByGroupTypeRequest_StartingHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByGroupTypeRequest + 1];
mbufi_ATTReadByGroupTypeRequest += 2;
union u_ATTReadByGroupTypeRequest_EndingHandle_t {
uint16_t p;
byte bytebuffer[2];
} u_ATTReadByGroupTypeRequest_EndingHandle;
u_ATTReadByGroupTypeRequest_EndingHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByGroupTypeRequest + 0];
u_ATTReadByGroupTypeRequest_EndingHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByGroupTypeRequest + 1];
mbufi_ATTReadByGroupTypeRequest += 2;
union u_ATTReadByGroupTypeRequest_AttributeGroupType_t {
ble_uuid_t p;
byte bytebuffer[16];
} u_ATTReadByGroupTypeRequest_AttributeGroupType;
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[0] = mbuf[mbufi_ATTReadByGroupTypeRequest + 0];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[1] = mbuf[mbufi_ATTReadByGroupTypeRequest + 1];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[2] = mbuf[mbufi_ATTReadByGroupTypeRequest + 2];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[3] = mbuf[mbufi_ATTReadByGroupTypeRequest + 3];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[4] = mbuf[mbufi_ATTReadByGroupTypeRequest + 4];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[5] = mbuf[mbufi_ATTReadByGroupTypeRequest + 5];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[6] = mbuf[mbufi_ATTReadByGroupTypeRequest + 6];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[7] = mbuf[mbufi_ATTReadByGroupTypeRequest + 7];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[8] = mbuf[mbufi_ATTReadByGroupTypeRequest + 8];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[9] = mbuf[mbufi_ATTReadByGroupTypeRequest + 9];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[10] = mbuf[mbufi_ATTReadByGroupTypeRequest + 10];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[11] = mbuf[mbufi_ATTReadByGroupTypeRequest + 11];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[12] = mbuf[mbufi_ATTReadByGroupTypeRequest + 12];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[13] = mbuf[mbufi_ATTReadByGroupTypeRequest + 13];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[14] = mbuf[mbufi_ATTReadByGroupTypeRequest + 14];
u_ATTReadByGroupTypeRequest_AttributeGroupType.bytebuffer[15] = mbuf[mbufi_ATTReadByGroupTypeRequest + 15];
...
u_ATTReadError_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTReadError + 0];
u_ATTReadError_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTReadError + 1];
mbufi_ATTReadError += 2;
union u_ATTReadError_AttributeHandle_t {
uint16_t p;
byte bytebuffer[2];
} u_ATTReadError_AttributeHandle;
u_ATTReadError_AttributeHandle.bytebuffer[0] = mbuf[mbufi_ATTReadError + 0];
u_ATTReadError_AttributeHandle.bytebuffer[1] = mbuf[mbufi_ATTReadError + 1];
mbufi_ATTReadError += 2;
...
u_SMPKeypressNotification_Handle.bytebuffer[0] = mbuf[mbufi_SMPKeypressNotification + 0];
u_SMPKeypressNotification_Handle.bytebuffer[1] = mbuf[mbufi_SMPKeypressNotification + 1];
...
u_ATTHandleValueConfirmation_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTHandleValueConfirmation + 0];
u_ATTHandleValueConfirmation_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTHandleValueConfirmation + 1];
...
u_ConnectableAdvertisement_Address.bytebuffer[0] = mbuf[mbufi_ConnectableAdvertisement + 0];
u_ConnectableAdvertisement_Address.bytebuffer[1] = mbuf[mbufi_ConnectableAdvertisement + 1];
u_ConnectableAdvertisement_Address.bytebuffer[2] = mbuf[mbufi_ConnectableAdvertisement + 2];
u_ConnectableAdvertisement_Address.bytebuffer[3] = mbuf[mbufi_ConnectableAdvertisement + 3];
u_ConnectableAdvertisement_Address.bytebuffer[4] = mbuf[mbufi_ConnectableAdvertisement + 4];
u_ConnectableAdvertisement_Address.bytebuffer[5] = mbuf[mbufi_ConnectableAdvertisement + 5];
...
u_Opened_Address.bytebuffer[0] = mbuf[mbufi_Opened + 0];
u_Opened_Address.bytebuffer[1] = mbuf[mbufi_Opened + 1];
u_Opened_Address.bytebuffer[2] = mbuf[mbufi_Opened + 2];
u_Opened_Address.bytebuffer[3] = mbuf[mbufi_Opened + 3];
u_Opened_Address.bytebuffer[4] = mbuf[mbufi_Opened + 4];
u_Opened_Address.bytebuffer[5] = mbuf[mbufi_Opened + 5];
mbufi_Opened += 6;
...
u_SetLEScanParameters_Interval.bytebuffer[0] = mbuf[mbufi_SetLEScanParameters + 0];
u_SetLEScanParameters_Interval.bytebuffer[1] = mbuf[mbufi_SetLEScanParameters + 1];
mbufi_SetLEScanParameters += 2;
union u_SetLEScanParameters_Window_t {
uint16_t p;
byte bytebuffer[2];
} u_SetLEScanParameters_Window;
u_SetLEScanParameters_Window.bytebuffer[0] = mbuf[mbufi_SetLEScanParameters + 0];
u_SetLEScanParameters_Window.bytebuffer[1] = mbuf[mbufi_SetLEScanParameters + 1];
mbufi_SetLEScanParameters += 2;
...
u_SetLocalName_Name.bytebuffer[0] = mbuf[mbufi_SetLocalName + 0];
u_SetLocalName_Name.bytebuffer[1] = mbuf[mbufi_SetLocalName + 1];
u_SetLocalName_Name.bytebuffer[2] = mbuf[mbufi_SetLocalName + 2];
u_SetLocalName_Name.bytebuffer[3] = mbuf[mbufi_SetLocalName + 3];
u_SetLocalName_Name.bytebuffer[4] = mbuf[mbufi_SetLocalName + 4];
u_SetLocalName_Name.bytebuffer[5] = mbuf[mbufi_SetLocalName + 5];
u_SetLocalName_Name.bytebuffer[6] = mbuf[mbufi_SetLocalName + 6];
u_SetLocalName_Name.bytebuffer[7] = mbuf[mbufi_SetLocalName + 7];
u_SetLocalName_Name.bytebuffer[8] = mbuf[mbufi_SetLocalName + 8];
u_SetLocalName_Name.bytebuffer[9] = mbuf[mbufi_SetLocalName + 9];
u_SetLocalName_Name.bytebuffer[10] = mbuf[mbufi_SetLocalName + 10];
u_SetLocalName_Name.bytebuffer[11] = mbuf[mbufi_SetLocalName + 11];
u_SetLocalName_Name.bytebuffer[12] = mbuf[mbufi_SetLocalName + 12];
u_SetLocalName_Name.bytebuffer[13] = mbuf[mbufi_SetLocalName + 13];
u_SetLocalName_Name.bytebuffer[14] = mbuf[mbufi_SetLocalName + 14];
u_SetLocalName_Name.bytebuffer[15] = mbuf[mbufi_SetLocalName + 15];
u_SetLocalName_Name.bytebuffer[16] = mbuf[mbufi_SetLocalName + 16];
u_SetLocalName_Name.bytebuffer[17] = mbuf[mbufi_SetLocalName + 17];
u_SetLocalName_Name.bytebuffer[18] = mbuf[mbufi_SetLocalName + 18];
u_SetLocalName_Name.bytebuffer[19] = mbuf[mbufi_SetLocalName + 19];
u_SetLocalName_Name.bytebuffer[20] = mbuf[mbufi_SetLocalName + 20];
u_SetLocalName_Name.bytebuffer[21] = mbuf[mbufi_SetLocalName + 21];
u_SetLocalName_Name.bytebuffer[22] = mbuf[mbufi_SetLocalName + 22];
u_SetLocalName_Name.bytebuffer[23] = mbuf[mbufi_SetLocalName + 23];
u_SetLocalName_Name.bytebuffer[24] = mbuf[mbufi_SetLocalName + 24];
u_SetLocalName_Name.bytebuffer[25] = mbuf[mbufi_SetLocalName + 25];
u_SetLocalName_Name.bytebuffer[26] = mbuf[mbufi_SetLocalName + 26];
u_SetLocalName_Name.bytebuffer[27] = mbuf[mbufi_SetLocalName + 27];
u_SetLocalName_Name.bytebuffer[28] = mbuf[mbufi_SetLocalName + 28];
u_SetLocalName_Name.bytebuffer[29] = mbuf[mbufi_SetLocalName + 29];
u_SetLocalName_Name.bytebuffer[30] = mbuf[mbufi_SetLocalName + 30];
u_SetLocalName_Name.bytebuffer[31] = mbuf[mbufi_SetLocalName + 31];
u_SetLocalName_Name.bytebuffer[32] = mbuf[mbufi_SetLocalName + 32];
u_SetLocalName_Name.bytebuffer[33] = mbuf[mbufi_SetLocalName + 33];
u_SetLocalName_Name.bytebuffer[34] = mbuf[mbufi_SetLocalName + 34];
u_SetLocalName_Name.bytebuffer[35] = mbuf[mbufi_SetLocalName + 35];
u_SetLocalName_Name.bytebuffer[36] = mbuf[mbufi_SetLocalName + 36];
u_SetLocalName_Name.bytebuffer[37] = mbuf[mbufi_SetLocalName + 37];
u_SetLocalName_Name.bytebuffer[38] = mbuf[mbufi_SetLocalName + 38];
u_SetLocalName_Name.bytebuffer[39] = mbuf[mbufi_SetLocalName + 39];
u_SetLocalName_Name.bytebuffer[40] = mbuf[mbufi_SetLocalName + 40];
u_SetLocalName_Name.bytebuffer[41] = mbuf[mbufi_SetLocalName + 41];
u_SetLocalName_Name.bytebuffer[42] = mbuf[mbufi_SetLocalName + 42];
u_SetLocalName_Name.bytebuffer[43] = mbuf[mbufi_SetLocalName + 43];
u_SetLocalName_Name.bytebuffer[44] = mbuf[mbufi_SetLocalName + 44];
u_SetLocalName_Name.bytebuffer[45] = mbuf[mbufi_SetLocalName + 45];
u_SetLocalName_Name.bytebuffer[46] = mbuf[mbufi_SetLocalName + 46];
u_SetLocalName_Name.bytebuffer[47] = mbuf[mbufi_SetLocalName + 47];
u_SetLocalName_Name.bytebuffer[48] = mbuf[mbufi_SetLocalName + 48];
u_SetLocalName_Name.bytebuffer[49] = mbuf[mbufi_SetLocalName + 49];
u_SetLocalName_Name.bytebuffer[50] = mbuf[mbufi_SetLocalName + 50];
u_SetLocalName_Name.bytebuffer[51] = mbuf[mbufi_SetLocalName + 51];
u_SetLocalName_Name.bytebuffer[52] = mbuf[mbufi_SetLocalName + 52];
u_SetLocalName_Name.bytebuffer[53] = mbuf[mbufi_SetLocalName + 53];
u_SetLocalName_Name.bytebuffer[54] = mbuf[mbufi_SetLocalName + 54];
u_SetLocalName_Name.bytebuffer[55] = mbuf[mbufi_SetLocalName + 55];
u_SetLocalName_Name.bytebuffer[56] = mbuf[mbufi_SetLocalName + 56];
u_SetLocalName_Name.bytebuffer[57] = mbuf[mbufi_SetLocalName + 57];
u_SetLocalName_Name.bytebuffer[58] = mbuf[mbufi_SetLocalName + 58];
u_SetLocalName_Name.bytebuffer[59] = mbuf[mbufi_SetLocalName + 59];
u_SetLocalName_Name.bytebuffer[60] = mbuf[mbufi_SetLocalName + 60];
u_SetLocalName_Name.bytebuffer[61] = mbuf[mbufi_SetLocalName + 61];
u_SetLocalName_Name.bytebuffer[62] = mbuf[mbufi_SetLocalName + 62];
u_SetLocalName_Name.bytebuffer[63] = mbuf[mbufi_SetLocalName + 63];
u_SetLocalName_Name.bytebuffer[64] = mbuf[mbufi_SetLocalName + 64];
u_SetLocalName_Name.bytebuffer[65] = mbuf[mbufi_SetLocalName + 65];
u_SetLocalName_Name.bytebuffer[66] = mbuf[mbufi_SetLocalName + 66];
u_SetLocalName_Name.bytebuffer[67] = mbuf[mbufi_SetLocalName + 67];
u_SetLocalName_Name.bytebuffer[68] = mbuf[mbufi_SetLocalName + 68];
u_SetLocalName_Name.bytebuffer[69] = mbuf[mbufi_SetLocalName + 69];
u_SetLocalName_Name.bytebuffer[70] = mbuf[mbufi_SetLocalName + 70];
u_SetLocalName_Name.bytebuffer[71] = mbuf[mbufi_SetLocalName + 71];
u_SetLocalName_Name.bytebuffer[72] = mbuf[mbufi_SetLocalName + 72];
u_SetLocalName_Name.bytebuffer[73] = mbuf[mbufi_SetLocalName + 73];
u_SetLocalName_Name.bytebuffer[74] = mbuf[mbufi_SetLocalName + 74];
u_SetLocalName_Name.bytebuffer[75] = mbuf[mbufi_SetLocalName + 75];
u_SetLocalName_Name.bytebuffer[76] = mbuf[mbufi_SetLocalName + 76];
u_SetLocalName_Name.bytebuffer[77] = mbuf[mbufi_SetLocalName + 77];
u_SetLocalName_Name.bytebuffer[78] = mbuf[mbufi_SetLocalName + 78];
u_SetLocalName_Name.bytebuffer[79] = mbuf[mbufi_SetLocalName + 79];
u_SetLocalName_Name.bytebuffer[80] = mbuf[mbufi_SetLocalName + 80];
u_SetLocalName_Name.bytebuffer[81] = mbuf[mbufi_SetLocalName + 81];
u_SetLocalName_Name.bytebuffer[82] = mbuf[mbufi_SetLocalName + 82];
u_SetLocalName_Name.bytebuffer[83] = mbuf[mbufi_SetLocalName + 83];
u_SetLocalName_Name.bytebuffer[84] = mbuf[mbufi_SetLocalName + 84];
u_SetLocalName_Name.bytebuffer[85] = mbuf[mbufi_SetLocalName + 85];
u_SetLocalName_Name.bytebuffer[86] = mbuf[mbufi_SetLocalName + 86];
u_SetLocalName_Name.bytebuffer[87] = mbuf[mbufi_SetLocalName + 87];
u_SetLocalName_Name.bytebuffer[88] = mbuf[mbufi_SetLocalName + 88];
u_SetLocalName_Name.bytebuffer[89] = mbuf[mbufi_SetLocalName + 89];
u_SetLocalName_Name.bytebuffer[90] = mbuf[mbufi_SetLocalName + 90];
u_SetLocalName_Name.bytebuffer[91] = mbuf[mbufi_SetLocalName + 91];
u_SetLocalName_Name.bytebuffer[92] = mbuf[mbufi_SetLocalName + 92];
u_SetLocalName_Name.bytebuffer[93] = mbuf[mbufi_SetLocalName + 93];
u_SetLocalName_Name.bytebuffer[94] = mbuf[mbufi_SetLocalName + 94];
u_SetLocalName_Name.bytebuffer[95] = mbuf[mbufi_SetLocalName + 95];
u_SetLocalName_Name.bytebuffer[96] = mbuf[mbufi_SetLocalName + 96];
u_SetLocalName_Name.bytebuffer[97] = mbuf[mbufi_SetLocalName + 97];
u_SetLocalName_Name.bytebuffer[98] = mbuf[mbufi_SetLocalName + 98];
u_SetLocalName_Name.bytebuffer[99] = mbuf[mbufi_SetLocalName + 99];
u_SetLocalName_Name.bytebuffer[100] = mbuf[mbufi_SetLocalName + 100];
u_SetLocalName_Name.bytebuffer[101] = mbuf[mbufi_SetLocalName + 101];
u_SetLocalName_Name.bytebuffer[102] = mbuf[mbufi_SetLocalName + 102];
u_SetLocalName_Name.bytebuffer[103] = mbuf[mbufi_SetLocalName + 103];
u_SetLocalName_Name.bytebuffer[104] = mbuf[mbufi_SetLocalName + 104];
u_SetLocalName_Name.bytebuffer[105] = mbuf[mbufi_SetLocalName + 105];
u_SetLocalName_Name.bytebuffer[106] = mbuf[mbufi_SetLocalName + 106];
u_SetLocalName_Name.bytebuffer[107] = mbuf[mbufi_SetLocalName + 107];
u_SetLocalName_Name.bytebuffer[108] = mbuf[mbufi_SetLocalName + 108];
u_SetLocalName_Name.bytebuffer[109] = mbuf[mbufi_SetLocalName + 109];
u_SetLocalName_Name.bytebuffer[110] = mbuf[mbufi_SetLocalName + 110];
u_SetLocalName_Name.bytebuffer[111] = mbuf[mbufi_SetLocalName + 111];
u_SetLocalName_Name.bytebuffer[112] = mbuf[mbufi_SetLocalName + 112];
u_SetLocalName_Name.bytebuffer[113] = mbuf[mbufi_SetLocalName + 113];
u_SetLocalName_Name.bytebuffer[114] = mbuf[mbufi_SetLocalName + 114];
u_SetLocalName_Name.bytebuffer[115] = mbuf[mbufi_SetLocalName + 115];
u_SetLocalName_Name.bytebuffer[116] = mbuf[mbufi_SetLocalName + 116];
u_SetLocalName_Name.bytebuffer[117] = mbuf[mbufi_SetLocalName + 117];
u_SetLocalName_Name.bytebuffer[118] = mbuf[mbufi_SetLocalName + 118];
u_SetLocalName_Name.bytebuffer[119] = mbuf[mbufi_SetLocalName + 119];
u_SetLocalName_Name.bytebuffer[120] = mbuf[mbufi_SetLocalName + 120];
u_SetLocalName_Name.bytebuffer[121] = mbuf[mbufi_SetLocalName + 121];
u_SetLocalName_Name.bytebuffer[122] = mbuf[mbufi_SetLocalName + 122];
u_SetLocalName_Name.bytebuffer[123] = mbuf[mbufi_SetLocalName + 123];
u_SetLocalName_Name.bytebuffer[124] = mbuf[mbufi_SetLocalName + 124];
u_SetLocalName_Name.bytebuffer[125] = mbuf[mbufi_SetLocalName + 125];
u_SetLocalName_Name.bytebuffer[126] = mbuf[mbufi_SetLocalName + 126];
u_SetLocalName_Name.bytebuffer[127] = mbuf[mbufi_SetLocalName + 127];
u_SetLocalName_Name.bytebuffer[128] = mbuf[mbufi_SetLocalName + 128];
u_SetLocalName_Name.bytebuffer[129] = mbuf[mbufi_SetLocalName + 129];
u_SetLocalName_Name.bytebuffer[130] = mbuf[mbufi_SetLocalName + 130];
u_SetLocalName_Name.bytebuffer[131] = mbuf[mbufi_SetLocalName + 131];
u_SetLocalName_Name.bytebuffer[132] = mbuf[mbufi_SetLocalName + 132];
u_SetLocalName_Name.bytebuffer[133] = mbuf[mbufi_SetLocalName + 133];
u_SetLocalName_Name.bytebuffer[134] = mbuf[mbufi_SetLocalName + 134];
u_SetLocalName_Name.bytebuffer[135] = mbuf[mbufi_SetLocalName + 135];
u_SetLocalName_Name.bytebuffer[136] = mbuf[mbufi_SetLocalName + 136];
u_SetLocalName_Name.bytebuffer[137] = mbuf[mbufi_SetLocalName + 137];
u_SetLocalName_Name.bytebuffer[138] = mbuf[mbufi_SetLocalName + 138];
u_SetLocalName_Name.bytebuffer[139] = mbuf[mbufi_SetLocalName + 139];
u_SetLocalName_Name.bytebuffer[140] = mbuf[mbufi_SetLocalName + 140];
u_SetLocalName_Name.bytebuffer[141] = mbuf[mbufi_SetLocalName + 141];
u_SetLocalName_Name.bytebuffer[142] = mbuf[mbufi_SetLocalName + 142];
u_SetLocalName_Name.bytebuffer[143] = mbuf[mbufi_SetLocalName + 143];
u_SetLocalName_Name.bytebuffer[144] = mbuf[mbufi_SetLocalName + 144];
u_SetLocalName_Name.bytebuffer[145] = mbuf[mbufi_SetLocalName + 145];
u_SetLocalName_Name.bytebuffer[146] = mbuf[mbufi_SetLocalName + 146];
u_SetLocalName_Name.bytebuffer[147] = mbuf[mbufi_SetLocalName + 147];
u_SetLocalName_Name.bytebuffer[148] = mbuf[mbufi_SetLocalName + 148];
u_SetLocalName_Name.bytebuffer[149] = mbuf[mbufi_SetLocalName + 149];
u_SetLocalName_Name.bytebuffer[150] = mbuf[mbufi_SetLocalName + 150];
u_SetLocalName_Name.bytebuffer[151] = mbuf[mbufi_SetLocalName + 151];
u_SetLocalName_Name.bytebuffer[152] = mbuf[mbufi_SetLocalName + 152];
u_SetLocalName_Name.bytebuffer[153] = mbuf[mbufi_SetLocalName + 153];
u_SetLocalName_Name.bytebuffer[154] = mbuf[mbufi_SetLocalName + 154];
u_SetLocalName_Name.bytebuffer[155] = mbuf[mbufi_SetLocalName + 155];
u_SetLocalName_Name.bytebuffer[156] = mbuf[mbufi_SetLocalName + 156];
u_SetLocalName_Name.bytebuffer[157] = mbuf[mbufi_SetLocalName + 157];
u_SetLocalName_Name.bytebuffer[158] = mbuf[mbufi_SetLocalName + 158];
u_SetLocalName_Name.bytebuffer[159] = mbuf[mbufi_SetLocalName + 159];
u_SetLocalName_Name.bytebuffer[160] = mbuf[mbufi_SetLocalName + 160];
u_SetLocalName_Name.bytebuffer[161] = mbuf[mbufi_SetLocalName + 161];
u_SetLocalName_Name.bytebuffer[162] = mbuf[mbufi_SetLocalName + 162];
u_SetLocalName_Name.bytebuffer[163] = mbuf[mbufi_SetLocalName + 163];
u_SetLocalName_Name.bytebuffer[164] = mbuf[mbufi_SetLocalName + 164];
u_SetLocalName_Name.bytebuffer[165] = mbuf[mbufi_SetLocalName + 165];
u_SetLocalName_Name.bytebuffer[166] = mbuf[mbufi_SetLocalName + 166];
u_SetLocalName_Name.bytebuffer[167] = mbuf[mbufi_SetLocalName + 167];
u_SetLocalName_Name.bytebuffer[168] = mbuf[mbufi_SetLocalName + 168];
u_SetLocalName_Name.bytebuffer[169] = mbuf[mbufi_SetLocalName + 169];
u_SetLocalName_Name.bytebuffer[170] = mbuf[mbufi_SetLocalName + 170];
u_SetLocalName_Name.bytebuffer[171] = mbuf[mbufi_SetLocalName + 171];
u_SetLocalName_Name.bytebuffer[172] = mbuf[mbufi_SetLocalName + 172];
u_SetLocalName_Name.bytebuffer[173] = mbuf[mbufi_SetLocalName + 173];
u_SetLocalName_Name.bytebuffer[174] = mbuf[mbufi_SetLocalName + 174];
u_SetLocalName_Name.bytebuffer[175] = mbuf[mbufi_SetLocalName + 175];
u_SetLocalName_Name.bytebuffer[176] = mbuf[mbufi_SetLocalName + 176];
u_SetLocalName_Name.bytebuffer[177] = mbuf[mbufi_SetLocalName + 177];
u_SetLocalName_Name.bytebuffer[178] = mbuf[mbufi_SetLocalName + 178];
u_SetLocalName_Name.bytebuffer[179] = mbuf[mbufi_SetLocalName + 179];
u_SetLocalName_Name.bytebuffer[180] = mbuf[mbufi_SetLocalName + 180];
u_SetLocalName_Name.bytebuffer[181] = mbuf[mbufi_SetLocalName + 181];
u_SetLocalName_Name.bytebuffer[182] = mbuf[mbufi_SetLocalName + 182];
u_SetLocalName_Name.bytebuffer[183] = mbuf[mbufi_SetLocalName + 183];
u_SetLocalName_Name.bytebuffer[184] = mbuf[mbufi_SetLocalName + 184];
u_SetLocalName_Name.bytebuffer[185] = mbuf[mbufi_SetLocalName + 185];
u_SetLocalName_Name.bytebuffer[186] = mbuf[mbufi_SetLocalName + 186];
u_SetLocalName_Name.bytebuffer[187] = mbuf[mbufi_SetLocalName + 187];
u_SetLocalName_Name.bytebuffer[188] = mbuf[mbufi_SetLocalName + 188];
u_SetLocalName_Name.bytebuffer[189] = mbuf[mbufi_SetLocalName + 189];
u_SetLocalName_Name.bytebuffer[190] = mbuf[mbufi_SetLocalName + 190];
u_SetLocalName_Name.bytebuffer[191] = mbuf[mbufi_SetLocalName + 191];
u_SetLocalName_Name.bytebuffer[192] = mbuf[mbufi_SetLocalName + 192];
u_SetLocalName_Name.bytebuffer[193] = mbuf[mbufi_SetLocalName + 193];
u_SetLocalName_Name.bytebuffer[194] = mbuf[mbufi_SetLocalName + 194];
u_SetLocalName_Name.bytebuffer[195] = mbuf[mbufi_SetLocalName + 195];
u_SetLocalName_Name.bytebuffer[196] = mbuf[mbufi_SetLocalName + 196];
u_SetLocalName_Name.bytebuffer[197] = mbuf[mbufi_SetLocalName + 197];
u_SetLocalName_Name.bytebuffer[198] = mbuf[mbufi_SetLocalName + 198];
u_SetLocalName_Name.bytebuffer[199] = mbuf[mbufi_SetLocalName + 199];
u_SetLocalName_Name.bytebuffer[200] = mbuf[mbufi_SetLocalName + 200];
u_SetLocalName_Name.bytebuffer[201] = mbuf[mbufi_SetLocalName + 201];
u_SetLocalName_Name.bytebuffer[202] = mbuf[mbufi_SetLocalName + 202];
u_SetLocalName_Name.bytebuffer[203] = mbuf[mbufi_SetLocalName + 203];
u_SetLocalName_Name.bytebuffer[204] = mbuf[mbufi_SetLocalName + 204];
u_SetLocalName_Name.bytebuffer[205] = mbuf[mbufi_SetLocalName + 205];
u_SetLocalName_Name.bytebuffer[206] = mbuf[mbufi_SetLocalName + 206];
u_SetLocalName_Name.bytebuffer[207] = mbuf[mbufi_SetLocalName + 207];
u_SetLocalName_Name.bytebuffer[208] = mbuf[mbufi_SetLocalName + 208];
u_SetLocalName_Name.bytebuffer[209] = mbuf[mbufi_SetLocalName + 209];
u_SetLocalName_Name.bytebuffer[210] = mbuf[mbufi_SetLocalName + 210];
u_SetLocalName_Name.bytebuffer[211] = mbuf[mbufi_SetLocalName + 211];
u_SetLocalName_Name.bytebuffer[212] = mbuf[mbufi_SetLocalName + 212];
u_SetLocalName_Name.bytebuffer[213] = mbuf[mbufi_SetLocalName + 213];
u_SetLocalName_Name.bytebuffer[214] = mbuf[mbufi_SetLocalName + 214];
u_SetLocalName_Name.bytebuffer[215] = mbuf[mbufi_SetLocalName + 215];
u_SetLocalName_Name.bytebuffer[216] = mbuf[mbufi_SetLocalName + 216];
u_SetLocalName_Name.bytebuffer[217] = mbuf[mbufi_SetLocalName + 217];
u_SetLocalName_Name.bytebuffer[218] = mbuf[mbufi_SetLocalName + 218];
u_SetLocalName_Name.bytebuffer[219] = mbuf[mbufi_SetLocalName + 219];
u_SetLocalName_Name.bytebuffer[220] = mbuf[mbufi_SetLocalName + 220];
u_SetLocalName_Name.bytebuffer[221] = mbuf[mbufi_SetLocalName + 221];
u_SetLocalName_Name.bytebuffer[222] = mbuf[mbufi_SetLocalName + 222];
u_SetLocalName_Name.bytebuffer[223] = mbuf[mbufi_SetLocalName + 223];
u_SetLocalName_Name.bytebuffer[224] = mbuf[mbufi_SetLocalName + 224];
u_SetLocalName_Name.bytebuffer[225] = mbuf[mbufi_SetLocalName + 225];
u_SetLocalName_Name.bytebuffer[226] = mbuf[mbufi_SetLocalName + 226];
u_SetLocalName_Name.bytebuffer[227] = mbuf[mbufi_SetLocalName + 227];
u_SetLocalName_Name.bytebuffer[228] = mbuf[mbufi_SetLocalName + 228];
u_SetLocalName_Name.bytebuffer[229] = mbuf[mbufi_SetLocalName + 229];
u_SetLocalName_Name.bytebuffer[230] = mbuf[mbufi_SetLocalName + 230];
u_SetLocalName_Name.bytebuffer[231] = mbuf[mbufi_SetLocalName + 231];
u_SetLocalName_Name.bytebuffer[232] = mbuf[mbufi_SetLocalName + 232];
u_SetLocalName_Name.bytebuffer[233] = mbuf[mbufi_SetLocalName + 233];
u_SetLocalName_Name.bytebuffer[234] = mbuf[mbufi_SetLocalName + 234];
u_SetLocalName_Name.bytebuffer[235] = mbuf[mbufi_SetLocalName + 235];
u_SetLocalName_Name.bytebuffer[236] = mbuf[mbufi_SetLocalName + 236];
u_SetLocalName_Name.bytebuffer[237] = mbuf[mbufi_SetLocalName + 237];
u_SetLocalName_Name.bytebuffer[238] = mbuf[mbufi_SetLocalName + 238];
u_SetLocalName_Name.bytebuffer[239] = mbuf[mbufi_SetLocalName + 239];
u_SetLocalName_Name.bytebuffer[240] = mbuf[mbufi_SetLocalName + 240];
u_SetLocalName_Name.bytebuffer[241] = mbuf[mbufi_SetLocalName + 241];
u_SetLocalName_Name.bytebuffer[242] = mbuf[mbufi_SetLocalName + 242];
u_SetLocalName_Name.bytebuffer[243] = mbuf[mbufi_SetLocalName + 243];
u_SetLocalName_Name.bytebuffer[244] = mbuf[mbufi_SetLocalName + 244];
u_SetLocalName_Name.bytebuffer[245] = mbuf[mbufi_SetLocalName + 245];
u_SetLocalName_Name.bytebuffer[246] = mbuf[mbufi_SetLocalName + 246];
u_SetLocalName_Name.bytebuffer[247] = mbuf[mbufi_SetLocalName + 247];
...
u_SMPEncryptionInformation_Handle.bytebuffer[0] = mbuf[mbufi_SMPEncryptionInformation + 0];
u_SMPEncryptionInformation_Handle.bytebuffer[1] = mbuf[mbufi_SMPEncryptionInformation + 1];
mbufi_SMPEncryptionInformation += 2;
union u_SMPEncryptionInformation_LongTermKey_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_SMPEncryptionInformation_LongTermKey;
u_SMPEncryptionInformation_LongTermKey.bytebuffer[0] = mbuf[mbufi_SMPEncryptionInformation + 0];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[1] = mbuf[mbufi_SMPEncryptionInformation + 1];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[2] = mbuf[mbufi_SMPEncryptionInformation + 2];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[3] = mbuf[mbufi_SMPEncryptionInformation + 3];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[4] = mbuf[mbufi_SMPEncryptionInformation + 4];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[5] = mbuf[mbufi_SMPEncryptionInformation + 5];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[6] = mbuf[mbufi_SMPEncryptionInformation + 6];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[7] = mbuf[mbufi_SMPEncryptionInformation + 7];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[8] = mbuf[mbufi_SMPEncryptionInformation + 8];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[9] = mbuf[mbufi_SMPEncryptionInformation + 9];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[10] = mbuf[mbufi_SMPEncryptionInformation + 10];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[11] = mbuf[mbufi_SMPEncryptionInformation + 11];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[12] = mbuf[mbufi_SMPEncryptionInformation + 12];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[13] = mbuf[mbufi_SMPEncryptionInformation + 13];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[14] = mbuf[mbufi_SMPEncryptionInformation + 14];
u_SMPEncryptionInformation_LongTermKey.bytebuffer[15] = mbuf[mbufi_SMPEncryptionInformation + 15];
...
u_ATTWriteRequest_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTWriteRequest + 0];
u_ATTWriteRequest_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTWriteRequest + 1];
mbufi_ATTWriteRequest += 2;
union u_ATTWriteRequest_AttributeHandle_t {
uint16_t p;
byte bytebuffer[2];
} u_ATTWriteRequest_AttributeHandle;
u_ATTWriteRequest_AttributeHandle.bytebuffer[0] = mbuf[mbufi_ATTWriteRequest + 0];
u_ATTWriteRequest_AttributeHandle.bytebuffer[1] = mbuf[mbufi_ATTWriteRequest + 1];
mbufi_ATTWriteRequest += 2;
union u_ATTWriteRequest_AttributeValue_t {
ble_gatt_data_t p;
byte bytebuffer[24];
} u_ATTWriteRequest_AttributeValue;
u_ATTWriteRequest_AttributeValue.bytebuffer[0] = mbuf[mbufi_ATTWriteRequest + 0];
u_ATTWriteRequest_AttributeValue.bytebuffer[1] = mbuf[mbufi_ATTWriteRequest + 1];
u_ATTWriteRequest_AttributeValue.bytebuffer[2] = mbuf[mbufi_ATTWriteRequest + 2];
u_ATTWriteRequest_AttributeValue.bytebuffer[3] = mbuf[mbufi_ATTWriteRequest + 3];
u_ATTWriteRequest_AttributeValue.bytebuffer[4] = mbuf[mbufi_ATTWriteRequest + 4];
u_ATTWriteRequest_AttributeValue.bytebuffer[5] = mbuf[mbufi_ATTWriteRequest + 5];
u_ATTWriteRequest_AttributeValue.bytebuffer[6] = mbuf[mbufi_ATTWriteRequest + 6];
u_ATTWriteRequest_AttributeValue.bytebuffer[7] = mbuf[mbufi_ATTWriteRequest + 7];
u_ATTWriteRequest_AttributeValue.bytebuffer[8] = mbuf[mbufi_ATTWriteRequest + 8];
u_ATTWriteRequest_AttributeValue.bytebuffer[9] = mbuf[mbufi_ATTWriteRequest + 9];
u_ATTWriteRequest_AttributeValue.bytebuffer[10] = mbuf[mbufi_ATTWriteRequest + 10];
u_ATTWriteRequest_AttributeValue.bytebuffer[11] = mbuf[mbufi_ATTWriteRequest + 11];
u_ATTWriteRequest_AttributeValue.bytebuffer[12] = mbuf[mbufi_ATTWriteRequest + 12];
u_ATTWriteRequest_AttributeValue.bytebuffer[13] = mbuf[mbufi_ATTWriteRequest + 13];
u_ATTWriteRequest_AttributeValue.bytebuffer[14] = mbuf[mbufi_ATTWriteRequest + 14];
u_ATTWriteRequest_AttributeValue.bytebuffer[15] = mbuf[mbufi_ATTWriteRequest + 15];
u_ATTWriteRequest_AttributeValue.bytebuffer[16] = mbuf[mbufi_ATTWriteRequest + 16];
u_ATTWriteRequest_AttributeValue.bytebuffer[17] = mbuf[mbufi_ATTWriteRequest + 17];
u_ATTWriteRequest_AttributeValue.bytebuffer[18] = mbuf[mbufi_ATTWriteRequest + 18];
u_ATTWriteRequest_AttributeValue.bytebuffer[19] = mbuf[mbufi_ATTWriteRequest + 19];
u_ATTWriteRequest_AttributeValue.bytebuffer[20] = mbuf[mbufi_ATTWriteRequest + 20];
u_ATTWriteRequest_AttributeValue.bytebuffer[21] = mbuf[mbufi_ATTWriteRequest + 21];
u_ATTWriteRequest_AttributeValue.bytebuffer[22] = mbuf[mbufi_ATTWriteRequest + 22];
u_ATTWriteRequest_AttributeValue.bytebuffer[23] = mbuf[mbufi_ATTWriteRequest + 23];
...
u_ATTHandleValueIndication_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTHandleValueIndication + 0];
u_ATTHandleValueIndication_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTHandleValueIndication + 1];
...
u_ATTHandleValueIndication_AttributeHandle.bytebuffer[0] = mbuf[mbufi_ATTHandleValueIndication + 0];
u_ATTHandleValueIndication_AttributeHandle.bytebuffer[1] = mbuf[mbufi_ATTHandleValueIndication + 1];
mbufi_ATTHandleValueIndication += 2;
union u_ATTHandleValueIndication_AttributeValue_t {
ble_gatt_data_t p;
byte bytebuffer[24];
} u_ATTHandleValueIndication_AttributeValue;
u_ATTHandleValueIndication_AttributeValue.bytebuffer[0] = mbuf[mbufi_ATTHandleValueIndication + 0];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[1] = mbuf[mbufi_ATTHandleValueIndication + 1];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[2] = mbuf[mbufi_ATTHandleValueIndication + 2];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[3] = mbuf[mbufi_ATTHandleValueIndication + 3];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[4] = mbuf[mbufi_ATTHandleValueIndication + 4];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[5] = mbuf[mbufi_ATTHandleValueIndication + 5];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[6] = mbuf[mbufi_ATTHandleValueIndication + 6];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[7] = mbuf[mbufi_ATTHandleValueIndication + 7];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[8] = mbuf[mbufi_ATTHandleValueIndication + 8];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[9] = mbuf[mbufi_ATTHandleValueIndication + 9];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[10] = mbuf[mbufi_ATTHandleValueIndication + 10];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[11] = mbuf[mbufi_ATTHandleValueIndication + 11];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[12] = mbuf[mbufi_ATTHandleValueIndication + 12];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[13] = mbuf[mbufi_ATTHandleValueIndication + 13];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[14] = mbuf[mbufi_ATTHandleValueIndication + 14];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[15] = mbuf[mbufi_ATTHandleValueIndication + 15];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[16] = mbuf[mbufi_ATTHandleValueIndication + 16];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[17] = mbuf[mbufi_ATTHandleValueIndication + 17];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[18] = mbuf[mbufi_ATTHandleValueIndication + 18];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[19] = mbuf[mbufi_ATTHandleValueIndication + 19];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[20] = mbuf[mbufi_ATTHandleValueIndication + 20];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[21] = mbuf[mbufi_ATTHandleValueIndication + 21];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[22] = mbuf[mbufi_ATTHandleValueIndication + 22];
u_ATTHandleValueIndication_AttributeValue.bytebuffer[23] = mbuf[mbufi_ATTHandleValueIndication + 23];
...
u_LERandCompleted_Random.bytebuffer[0] = mbuf[mbufi_LERandCompleted + 0];
u_LERandCompleted_Random.bytebuffer[1] = mbuf[mbufi_LERandCompleted + 1];
u_LERandCompleted_Random.bytebuffer[2] = mbuf[mbufi_LERandCompleted + 2];
u_LERandCompleted_Random.bytebuffer[3] = mbuf[mbufi_LERandCompleted + 3];
u_LERandCompleted_Random.bytebuffer[4] = mbuf[mbufi_LERandCompleted + 4];
u_LERandCompleted_Random.bytebuffer[5] = mbuf[mbufi_LERandCompleted + 5];
u_LERandCompleted_Random.bytebuffer[6] = mbuf[mbufi_LERandCompleted + 6];
u_LERandCompleted_Random.bytebuffer[7] = mbuf[mbufi_LERandCompleted + 7];
...
u_Disconnect_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_Disconnect + 0];
u_Disconnect_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_Disconnect + 1];
mbufi_Disconnect += 2;
...
u_DisconnectionCompleted_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_DisconnectionCompleted + 0];
u_DisconnectionCompleted_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_DisconnectionCompleted + 1];
...
u_ATTFindInformationRequest_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTFindInformationRequest + 0];
u_ATTFindInformationRequest_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTFindInformationRequest + 1];
...
u_ATTFindInformationRequest_StartingHandle.bytebuffer[0] = mbuf[mbufi_ATTFindInformationRequest + 0];
u_ATTFindInformationRequest_StartingHandle.bytebuffer[1] = mbuf[mbufi_ATTFindInformationRequest + 1];
mbufi_ATTFindInformationRequest += 2;
union u_ATTFindInformationRequest_EndingHandle_t {
uint16_t p;
byte bytebuffer[2];
} u_ATTFindInformationRequest_EndingHandle;
u_ATTFindInformationRequest_EndingHandle.bytebuffer[0] = mbuf[mbufi_ATTFindInformationRequest + 0];
u_ATTFindInformationRequest_EndingHandle.bytebuffer[1] = mbuf[mbufi_ATTFindInformationRequest + 1];
mbufi_ATTFindInformationRequest += 2;
...
u_ATTReadByTypeResponse_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByTypeResponse + 0];
u_ATTReadByTypeResponse_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByTypeResponse + 1];
...
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[0] = mbuf[mbufi_ATTReadByTypeResponse + 0];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[1] = mbuf[mbufi_ATTReadByTypeResponse + 1];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[2] = mbuf[mbufi_ATTReadByTypeResponse + 2];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[3] = mbuf[mbufi_ATTReadByTypeResponse + 3];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[4] = mbuf[mbufi_ATTReadByTypeResponse + 4];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[5] = mbuf[mbufi_ATTReadByTypeResponse + 5];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[6] = mbuf[mbufi_ATTReadByTypeResponse + 6];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[7] = mbuf[mbufi_ATTReadByTypeResponse + 7];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[8] = mbuf[mbufi_ATTReadByTypeResponse + 8];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[9] = mbuf[mbufi_ATTReadByTypeResponse + 9];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[10] = mbuf[mbufi_ATTReadByTypeResponse + 10];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[11] = mbuf[mbufi_ATTReadByTypeResponse + 11];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[12] = mbuf[mbufi_ATTReadByTypeResponse + 12];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[13] = mbuf[mbufi_ATTReadByTypeResponse + 13];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[14] = mbuf[mbufi_ATTReadByTypeResponse + 14];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[15] = mbuf[mbufi_ATTReadByTypeResponse + 15];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[16] = mbuf[mbufi_ATTReadByTypeResponse + 16];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[17] = mbuf[mbufi_ATTReadByTypeResponse + 17];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[18] = mbuf[mbufi_ATTReadByTypeResponse + 18];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[19] = mbuf[mbufi_ATTReadByTypeResponse + 19];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[20] = mbuf[mbufi_ATTReadByTypeResponse + 20];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[21] = mbuf[mbufi_ATTReadByTypeResponse + 21];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[22] = mbuf[mbufi_ATTReadByTypeResponse + 22];
u_ATTReadByTypeResponse_AttributeDataList.bytebuffer[23] = mbuf[mbufi_ATTReadByTypeResponse + 23];
...
u_SMPIdentityInformation_Handle.bytebuffer[0] = mbuf[mbufi_SMPIdentityInformation + 0];
u_SMPIdentityInformation_Handle.bytebuffer[1] = mbuf[mbufi_SMPIdentityInformation + 1];
...
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[0] = mbuf[mbufi_SMPIdentityInformation + 0];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[1] = mbuf[mbufi_SMPIdentityInformation + 1];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[2] = mbuf[mbufi_SMPIdentityInformation + 2];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[3] = mbuf[mbufi_SMPIdentityInformation + 3];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[4] = mbuf[mbufi_SMPIdentityInformation + 4];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[5] = mbuf[mbufi_SMPIdentityInformation + 5];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[6] = mbuf[mbufi_SMPIdentityInformation + 6];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[7] = mbuf[mbufi_SMPIdentityInformation + 7];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[8] = mbuf[mbufi_SMPIdentityInformation + 8];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[9] = mbuf[mbufi_SMPIdentityInformation + 9];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[10] = mbuf[mbufi_SMPIdentityInformation + 10];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[11] = mbuf[mbufi_SMPIdentityInformation + 11];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[12] = mbuf[mbufi_SMPIdentityInformation + 12];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[13] = mbuf[mbufi_SMPIdentityInformation + 13];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[14] = mbuf[mbufi_SMPIdentityInformation + 14];
u_SMPIdentityInformation_IdentityResolvingKey.bytebuffer[15] = mbuf[mbufi_SMPIdentityInformation + 15];
...
u_Connected_Handle.bytebuffer[0] = mbuf[mbufi_Connected + 0];
u_Connected_Handle.bytebuffer[1] = mbuf[mbufi_Connected + 1];
mbufi_Connected += 2;
...
u_Connected_Address.bytebuffer[0] = mbuf[mbufi_Connected + 0];
u_Connected_Address.bytebuffer[1] = mbuf[mbufi_Connected + 1];
u_Connected_Address.bytebuffer[2] = mbuf[mbufi_Connected + 2];
u_Connected_Address.bytebuffer[3] = mbuf[mbufi_Connected + 3];
u_Connected_Address.bytebuffer[4] = mbuf[mbufi_Connected + 4];
u_Connected_Address.bytebuffer[5] = mbuf[mbufi_Connected + 5];
mbufi_Connected += 6;
...
u_LEEnhancedConnectionComplete_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_LEEnhancedConnectionComplete + 0];
u_LEEnhancedConnectionComplete_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_LEEnhancedConnectionComplete + 1];
...
u_LEEnhancedConnectionComplete_PeerAddress.bytebuffer[0] = mbuf[mbufi_LEEnhancedConnectionComplete + 0];
u_LEEnhancedConnectionComplete_PeerAddress.bytebuffer[1] = mbuf[mbufi_LEEnhancedConnectionComplete + 1];
u_LEEnhancedConnectionComplete_PeerAddress.bytebuffer[2] = mbuf[mbufi_LEEnhancedConnectionComplete + 2];
u_LEEnhancedConnectionComplete_PeerAddress.bytebuffer[3] = mbuf[mbufi_LEEnhancedConnectionComplete + 3];
u_LEEnhancedConnectionComplete_PeerAddress.bytebuffer[4] = mbuf[mbufi_LEEnhancedConnectionComplete + 4];
u_LEEnhancedConnectionComplete_PeerAddress.bytebuffer[5] = mbuf[mbufi_LEEnhancedConnectionComplete + 5];
...
u_LEEnhancedConnectionComplete_LocalResolvablePrivateAddress.bytebuffer[0] = mbuf[mbufi_LEEnhancedConnectionComplete + 0];
u_LEEnhancedConnectionComplete_LocalResolvablePrivateAddress.bytebuffer[1] = mbuf[mbufi_LEEnhancedConnectionComplete + 1];
u_LEEnhancedConnectionComplete_LocalResolvablePrivateAddress.bytebuffer[2] = mbuf[mbufi_LEEnhancedConnectionComplete + 2];
u_LEEnhancedConnectionComplete_LocalResolvablePrivateAddress.bytebuffer[3] = mbuf[mbufi_LEEnhancedConnectionComplete + 3];
u_LEEnhancedConnectionComplete_LocalResolvablePrivateAddress.bytebuffer[4] = mbuf[mbufi_LEEnhancedConnectionComplete + 4];
u_LEEnhancedConnectionComplete_LocalResolvablePrivateAddress.bytebuffer[5] = mbuf[mbufi_LEEnhancedConnectionComplete + 5];
mbufi_LEEnhancedConnectionComplete += 6;
...
u_LEEnhancedConnectionComplete_PeerResolvablePrivateAddress.bytebuffer[0] = mbuf[mbufi_LEEnhancedConnectionComplete + 0];
u_LEEnhancedConnectionComplete_PeerResolvablePrivateAddress.bytebuffer[1] = mbuf[mbufi_LEEnhancedConnectionComplete + 1];
u_LEEnhancedConnectionComplete_PeerResolvablePrivateAddress.bytebuffer[2] = mbuf[mbufi_LEEnhancedConnectionComplete + 2];
u_LEEnhancedConnectionComplete_PeerResolvablePrivateAddress.bytebuffer[3] = mbuf[mbufi_LEEnhancedConnectionComplete + 3];
u_LEEnhancedConnectionComplete_PeerResolvablePrivateAddress.bytebuffer[4] = mbuf[mbufi_LEEnhancedConnectionComplete + 4];
u_LEEnhancedConnectionComplete_PeerResolvablePrivateAddress.bytebuffer[5] = mbuf[mbufi_LEEnhancedConnectionComplete + 5];
mbufi_LEEnhancedConnectionComplete += 6;
union u_LEEnhancedConnectionComplete_ConnInterval_t {
uint16_t p;
byte bytebuffer[2];
} u_LEEnhancedConnectionComplete_ConnInterval;
u_LEEnhancedConnectionComplete_ConnInterval.bytebuffer[0] = mbuf[mbufi_LEEnhancedConnectionComplete + 0];
u_LEEnhancedConnectionComplete_ConnInterval.bytebuffer[1] = mbuf[mbufi_LEEnhancedConnectionComplete + 1];
mbufi_LEEnhancedConnectionComplete += 2;
union u_LEEnhancedConnectionComplete_ConnLatency_t {
uint16_t p;
byte bytebuffer[2];
} u_LEEnhancedConnectionComplete_ConnLatency;
u_LEEnhancedConnectionComplete_ConnLatency.bytebuffer[0] = mbuf[mbufi_LEEnhancedConnectionComplete + 0];
u_LEEnhancedConnectionComplete_ConnLatency.bytebuffer[1] = mbuf[mbufi_LEEnhancedConnectionComplete + 1];
mbufi_LEEnhancedConnectionComplete += 2;
union u_LEEnhancedConnectionComplete_SupervisionTimeout_t {
uint16_t p;
byte bytebuffer[2];
} u_LEEnhancedConnectionComplete_SupervisionTimeout;
u_LEEnhancedConnectionComplete_SupervisionTimeout.bytebuffer[0] = mbuf[mbufi_LEEnhancedConnectionComplete + 0];
u_LEEnhancedConnectionComplete_SupervisionTimeout.bytebuffer[1] = mbuf[mbufi_LEEnhancedConnectionComplete + 1];
mbufi_LEEnhancedConnectionComplete += 2;
...
u_SetLEEventMask_Mask.bytebuffer[0] = mbuf[mbufi_SetLEEventMask + 0];
u_SetLEEventMask_Mask.bytebuffer[1] = mbuf[mbufi_SetLEEventMask + 1];
u_SetLEEventMask_Mask.bytebuffer[2] = mbuf[mbufi_SetLEEventMask + 2];
u_SetLEEventMask_Mask.bytebuffer[3] = mbuf[mbufi_SetLEEventMask + 3];
u_SetLEEventMask_Mask.bytebuffer[4] = mbuf[mbufi_SetLEEventMask + 4];
u_SetLEEventMask_Mask.bytebuffer[5] = mbuf[mbufi_SetLEEventMask + 5];
u_SetLEEventMask_Mask.bytebuffer[6] = mbuf[mbufi_SetLEEventMask + 6];
u_SetLEEventMask_Mask.bytebuffer[7] = mbuf[mbufi_SetLEEventMask + 7];
...
u_ConnectTo_Address.bytebuffer[0] = mbuf[mbufi_ConnectTo + 0];
u_ConnectTo_Address.bytebuffer[1] = mbuf[mbufi_ConnectTo + 1];
u_ConnectTo_Address.bytebuffer[2] = mbuf[mbufi_ConnectTo + 2];
u_ConnectTo_Address.bytebuffer[3] = mbuf[mbufi_ConnectTo + 3];
u_ConnectTo_Address.bytebuffer[4] = mbuf[mbufi_ConnectTo + 4];
u_ConnectTo_Address.bytebuffer[5] = mbuf[mbufi_ConnectTo + 5];
mbufi_ConnectTo += 6;
union u_ConnectTo_LongTermKey_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_ConnectTo_LongTermKey;
u_ConnectTo_LongTermKey.bytebuffer[0] = mbuf[mbufi_ConnectTo + 0];
u_ConnectTo_LongTermKey.bytebuffer[1] = mbuf[mbufi_ConnectTo + 1];
u_ConnectTo_LongTermKey.bytebuffer[2] = mbuf[mbufi_ConnectTo + 2];
u_ConnectTo_LongTermKey.bytebuffer[3] = mbuf[mbufi_ConnectTo + 3];
u_ConnectTo_LongTermKey.bytebuffer[4] = mbuf[mbufi_ConnectTo + 4];
u_ConnectTo_LongTermKey.bytebuffer[5] = mbuf[mbufi_ConnectTo + 5];
u_ConnectTo_LongTermKey.bytebuffer[6] = mbuf[mbufi_ConnectTo + 6];
u_ConnectTo_LongTermKey.bytebuffer[7] = mbuf[mbufi_ConnectTo + 7];
u_ConnectTo_LongTermKey.bytebuffer[8] = mbuf[mbufi_ConnectTo + 8];
u_ConnectTo_LongTermKey.bytebuffer[9] = mbuf[mbufi_ConnectTo + 9];
u_ConnectTo_LongTermKey.bytebuffer[10] = mbuf[mbufi_ConnectTo + 10];
u_ConnectTo_LongTermKey.bytebuffer[11] = mbuf[mbufi_ConnectTo + 11];
u_ConnectTo_LongTermKey.bytebuffer[12] = mbuf[mbufi_ConnectTo + 12];
u_ConnectTo_LongTermKey.bytebuffer[13] = mbuf[mbufi_ConnectTo + 13];
u_ConnectTo_LongTermKey.bytebuffer[14] = mbuf[mbufi_ConnectTo + 14];
u_ConnectTo_LongTermKey.bytebuffer[15] = mbuf[mbufi_ConnectTo + 15];
mbufi_ConnectTo += 16;
union u_ConnectTo_EncryptedDiversifier_t {
uint16_t p;
byte bytebuffer[2];
} u_ConnectTo_EncryptedDiversifier;
u_ConnectTo_EncryptedDiversifier.bytebuffer[0] = mbuf[mbufi_ConnectTo + 0];
u_ConnectTo_EncryptedDiversifier.bytebuffer[1] = mbuf[mbufi_ConnectTo + 1];
mbufi_ConnectTo += 2;
union u_ConnectTo_RandomNumber_t {
ble_random_part_t p;
byte bytebuffer[8];
} u_ConnectTo_RandomNumber;
u_ConnectTo_RandomNumber.bytebuffer[0] = mbuf[mbufi_ConnectTo + 0];
u_ConnectTo_RandomNumber.bytebuffer[1] = mbuf[mbufi_ConnectTo + 1];
u_ConnectTo_RandomNumber.bytebuffer[2] = mbuf[mbufi_ConnectTo + 2];
u_ConnectTo_RandomNumber.bytebuffer[3] = mbuf[mbufi_ConnectTo + 3];
u_ConnectTo_RandomNumber.bytebuffer[4] = mbuf[mbufi_ConnectTo + 4];
u_ConnectTo_RandomNumber.bytebuffer[5] = mbuf[mbufi_ConnectTo + 5];
u_ConnectTo_RandomNumber.bytebuffer[6] = mbuf[mbufi_ConnectTo + 6];
u_ConnectTo_RandomNumber.bytebuffer[7] = mbuf[mbufi_ConnectTo + 7];
mbufi_ConnectTo += 8;
...
u_SMPPairingFailed_Handle.bytebuffer[0] = mbuf[mbufi_SMPPairingFailed + 0];
u_SMPPairingFailed_Handle.bytebuffer[1] = mbuf[mbufi_SMPPairingFailed + 1];
...
u_ATTReadRequest_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTReadRequest + 0];
u_ATTReadRequest_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTReadRequest + 1];
mbufi_ATTReadRequest += 2;
union u_ATTReadRequest_AttributeHandle_t {
uint16_t p;
byte bytebuffer[2];
} u_ATTReadRequest_AttributeHandle;
u_ATTReadRequest_AttributeHandle.bytebuffer[0] = mbuf[mbufi_ATTReadRequest + 0];
u_ATTReadRequest_AttributeHandle.bytebuffer[1] = mbuf[mbufi_ATTReadRequest + 1];
mbufi_ATTReadRequest += 2;
...
u_LEConnectionComplete_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_LEConnectionComplete + 0];
u_LEConnectionComplete_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_LEConnectionComplete + 1];
...
u_LEConnectionComplete_PeerAddress.bytebuffer[0] = mbuf[mbufi_LEConnectionComplete + 0];
u_LEConnectionComplete_PeerAddress.bytebuffer[1] = mbuf[mbufi_LEConnectionComplete + 1];
u_LEConnectionComplete_PeerAddress.bytebuffer[2] = mbuf[mbufi_LEConnectionComplete + 2];
u_LEConnectionComplete_PeerAddress.bytebuffer[3] = mbuf[mbufi_LEConnectionComplete + 3];
u_LEConnectionComplete_PeerAddress.bytebuffer[4] = mbuf[mbufi_LEConnectionComplete + 4];
u_LEConnectionComplete_PeerAddress.bytebuffer[5] = mbuf[mbufi_LEConnectionComplete + 5];
mbufi_LEConnectionComplete += 6;
union u_LEConnectionComplete_ConnInterval_t {
uint16_t p;
byte bytebuffer[2];
} u_LEConnectionComplete_ConnInterval;
u_LEConnectionComplete_ConnInterval.bytebuffer[0] = mbuf[mbufi_LEConnectionComplete + 0];
u_LEConnectionComplete_ConnInterval.bytebuffer[1] = mbuf[mbufi_LEConnectionComplete + 1];
mbufi_LEConnectionComplete += 2;
union u_LEConnectionComplete_ConnLatency_t {
uint16_t p;
byte bytebuffer[2];
} u_LEConnectionComplete_ConnLatency;
u_LEConnectionComplete_ConnLatency.bytebuffer[0] = mbuf[mbufi_LEConnectionComplete + 0];
u_LEConnectionComplete_ConnLatency.bytebuffer[1] = mbuf[mbufi_LEConnectionComplete + 1];
mbufi_LEConnectionComplete += 2;
union u_LEConnectionComplete_SupervisionTimeout_t {
uint16_t p;
byte bytebuffer[2];
} u_LEConnectionComplete_SupervisionTimeout;
u_LEConnectionComplete_SupervisionTimeout.bytebuffer[0] = mbuf[mbufi_LEConnectionComplete + 0];
u_LEConnectionComplete_SupervisionTimeout.bytebuffer[1] = mbuf[mbufi_LEConnectionComplete + 1];
mbufi_LEConnectionComplete += 2;
...
u_DeviceInitialised_Address.bytebuffer[0] = mbuf[mbufi_DeviceInitialised + 0];
u_DeviceInitialised_Address.bytebuffer[1] = mbuf[mbufi_DeviceInitialised + 1];
u_DeviceInitialised_Address.bytebuffer[2] = mbuf[mbufi_DeviceInitialised + 2];
u_DeviceInitialised_Address.bytebuffer[3] = mbuf[mbufi_DeviceInitialised + 3];
u_DeviceInitialised_Address.bytebuffer[4] = mbuf[mbufi_DeviceInitialised + 4];
u_DeviceInitialised_Address.bytebuffer[5] = mbuf[mbufi_DeviceInitialised + 5];
...
u_SetLEAdvertisingData_Data.bytebuffer[0] = mbuf[mbufi_SetLEAdvertisingData + 0];
u_SetLEAdvertisingData_Data.bytebuffer[1] = mbuf[mbufi_SetLEAdvertisingData + 1];
u_SetLEAdvertisingData_Data.bytebuffer[2] = mbuf[mbufi_SetLEAdvertisingData + 2];
u_SetLEAdvertisingData_Data.bytebuffer[3] = mbuf[mbufi_SetLEAdvertisingData + 3];
u_SetLEAdvertisingData_Data.bytebuffer[4] = mbuf[mbufi_SetLEAdvertisingData + 4];
u_SetLEAdvertisingData_Data.bytebuffer[5] = mbuf[mbufi_SetLEAdvertisingData + 5];
u_SetLEAdvertisingData_Data.bytebuffer[6] = mbuf[mbufi_SetLEAdvertisingData + 6];
u_SetLEAdvertisingData_Data.bytebuffer[7] = mbuf[mbufi_SetLEAdvertisingData + 7];
u_SetLEAdvertisingData_Data.bytebuffer[8] = mbuf[mbufi_SetLEAdvertisingData + 8];
u_SetLEAdvertisingData_Data.bytebuffer[9] = mbuf[mbufi_SetLEAdvertisingData + 9];
u_SetLEAdvertisingData_Data.bytebuffer[10] = mbuf[mbufi_SetLEAdvertisingData + 10];
u_SetLEAdvertisingData_Data.bytebuffer[11] = mbuf[mbufi_SetLEAdvertisingData + 11];
u_SetLEAdvertisingData_Data.bytebuffer[12] = mbuf[mbufi_SetLEAdvertisingData + 12];
u_SetLEAdvertisingData_Data.bytebuffer[13] = mbuf[mbufi_SetLEAdvertisingData + 13];
u_SetLEAdvertisingData_Data.bytebuffer[14] = mbuf[mbufi_SetLEAdvertisingData + 14];
u_SetLEAdvertisingData_Data.bytebuffer[15] = mbuf[mbufi_SetLEAdvertisingData + 15];
u_SetLEAdvertisingData_Data.bytebuffer[16] = mbuf[mbufi_SetLEAdvertisingData + 16];
u_SetLEAdvertisingData_Data.bytebuffer[17] = mbuf[mbufi_SetLEAdvertisingData + 17];
u_SetLEAdvertisingData_Data.bytebuffer[18] = mbuf[mbufi_SetLEAdvertisingData + 18];
u_SetLEAdvertisingData_Data.bytebuffer[19] = mbuf[mbufi_SetLEAdvertisingData + 19];
u_SetLEAdvertisingData_Data.bytebuffer[20] = mbuf[mbufi_SetLEAdvertisingData + 20];
u_SetLEAdvertisingData_Data.bytebuffer[21] = mbuf[mbufi_SetLEAdvertisingData + 21];
u_SetLEAdvertisingData_Data.bytebuffer[22] = mbuf[mbufi_SetLEAdvertisingData + 22];
u_SetLEAdvertisingData_Data.bytebuffer[23] = mbuf[mbufi_SetLEAdvertisingData + 23];
u_SetLEAdvertisingData_Data.bytebuffer[24] = mbuf[mbufi_SetLEAdvertisingData + 24];
u_SetLEAdvertisingData_Data.bytebuffer[25] = mbuf[mbufi_SetLEAdvertisingData + 25];
u_SetLEAdvertisingData_Data.bytebuffer[26] = mbuf[mbufi_SetLEAdvertisingData + 26];
u_SetLEAdvertisingData_Data.bytebuffer[27] = mbuf[mbufi_SetLEAdvertisingData + 27];
u_SetLEAdvertisingData_Data.bytebuffer[28] = mbuf[mbufi_SetLEAdvertisingData + 28];
u_SetLEAdvertisingData_Data.bytebuffer[29] = mbuf[mbufi_SetLEAdvertisingData + 29];
u_SetLEAdvertisingData_Data.bytebuffer[30] = mbuf[mbufi_SetLEAdvertisingData + 30];
...
u_SMPPairingResponse_Handle.bytebuffer[0] = mbuf[mbufi_SMPPairingResponse + 0];
u_SMPPairingResponse_Handle.bytebuffer[1] = mbuf[mbufi_SMPPairingResponse + 1];
...
u_ATTHandleValueNotification_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTHandleValueNotification + 0];
u_ATTHandleValueNotification_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTHandleValueNotification + 1];
...
u_ATTHandleValueNotification_AttributeHandle.bytebuffer[0] = mbuf[mbufi_ATTHandleValueNotification + 0];
u_ATTHandleValueNotification_AttributeHandle.bytebuffer[1] = mbuf[mbufi_ATTHandleValueNotification + 1];
mbufi_ATTHandleValueNotification += 2;
union u_ATTHandleValueNotification_AttributeValue_t {
ble_gatt_data_t p;
byte bytebuffer[24];
} u_ATTHandleValueNotification_AttributeValue;
u_ATTHandleValueNotification_AttributeValue.bytebuffer[0] = mbuf[mbufi_ATTHandleValueNotification + 0];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[1] = mbuf[mbufi_ATTHandleValueNotification + 1];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[2] = mbuf[mbufi_ATTHandleValueNotification + 2];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[3] = mbuf[mbufi_ATTHandleValueNotification + 3];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[4] = mbuf[mbufi_ATTHandleValueNotification + 4];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[5] = mbuf[mbufi_ATTHandleValueNotification + 5];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[6] = mbuf[mbufi_ATTHandleValueNotification + 6];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[7] = mbuf[mbufi_ATTHandleValueNotification + 7];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[8] = mbuf[mbufi_ATTHandleValueNotification + 8];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[9] = mbuf[mbufi_ATTHandleValueNotification + 9];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[10] = mbuf[mbufi_ATTHandleValueNotification + 10];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[11] = mbuf[mbufi_ATTHandleValueNotification + 11];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[12] = mbuf[mbufi_ATTHandleValueNotification + 12];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[13] = mbuf[mbufi_ATTHandleValueNotification + 13];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[14] = mbuf[mbufi_ATTHandleValueNotification + 14];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[15] = mbuf[mbufi_ATTHandleValueNotification + 15];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[16] = mbuf[mbufi_ATTHandleValueNotification + 16];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[17] = mbuf[mbufi_ATTHandleValueNotification + 17];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[18] = mbuf[mbufi_ATTHandleValueNotification + 18];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[19] = mbuf[mbufi_ATTHandleValueNotification + 19];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[20] = mbuf[mbufi_ATTHandleValueNotification + 20];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[21] = mbuf[mbufi_ATTHandleValueNotification + 21];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[22] = mbuf[mbufi_ATTHandleValueNotification + 22];
u_ATTHandleValueNotification_AttributeValue.bytebuffer[23] = mbuf[mbufi_ATTHandleValueNotification + 23];
...
u_LEStartEncryption_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_LEStartEncryption + 0];
u_LEStartEncryption_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_LEStartEncryption + 1];
mbufi_LEStartEncryption += 2;
union u_LEStartEncryption_Random_t {
ble_random_part_t p;
byte bytebuffer[8];
} u_LEStartEncryption_Random;
u_LEStartEncryption_Random.bytebuffer[0] = mbuf[mbufi_LEStartEncryption + 0];
u_LEStartEncryption_Random.bytebuffer[1] = mbuf[mbufi_LEStartEncryption + 1];
u_LEStartEncryption_Random.bytebuffer[2] = mbuf[mbufi_LEStartEncryption + 2];
u_LEStartEncryption_Random.bytebuffer[3] = mbuf[mbufi_LEStartEncryption + 3];
u_LEStartEncryption_Random.bytebuffer[4] = mbuf[mbufi_LEStartEncryption + 4];
u_LEStartEncryption_Random.bytebuffer[5] = mbuf[mbufi_LEStartEncryption + 5];
u_LEStartEncryption_Random.bytebuffer[6] = mbuf[mbufi_LEStartEncryption + 6];
u_LEStartEncryption_Random.bytebuffer[7] = mbuf[mbufi_LEStartEncryption + 7];
mbufi_LEStartEncryption += 8;
union u_LEStartEncryption_EDIV_t {
uint16_t p;
byte bytebuffer[2];
} u_LEStartEncryption_EDIV;
u_LEStartEncryption_EDIV.bytebuffer[0] = mbuf[mbufi_LEStartEncryption + 0];
u_LEStartEncryption_EDIV.bytebuffer[1] = mbuf[mbufi_LEStartEncryption + 1];
mbufi_LEStartEncryption += 2;
union u_LEStartEncryption_LTK_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_LEStartEncryption_LTK;
u_LEStartEncryption_LTK.bytebuffer[0] = mbuf[mbufi_LEStartEncryption + 0];
u_LEStartEncryption_LTK.bytebuffer[1] = mbuf[mbufi_LEStartEncryption + 1];
u_LEStartEncryption_LTK.bytebuffer[2] = mbuf[mbufi_LEStartEncryption + 2];
u_LEStartEncryption_LTK.bytebuffer[3] = mbuf[mbufi_LEStartEncryption + 3];
u_LEStartEncryption_LTK.bytebuffer[4] = mbuf[mbufi_LEStartEncryption + 4];
u_LEStartEncryption_LTK.bytebuffer[5] = mbuf[mbufi_LEStartEncryption + 5];
u_LEStartEncryption_LTK.bytebuffer[6] = mbuf[mbufi_LEStartEncryption + 6];
u_LEStartEncryption_LTK.bytebuffer[7] = mbuf[mbufi_LEStartEncryption + 7];
u_LEStartEncryption_LTK.bytebuffer[8] = mbuf[mbufi_LEStartEncryption + 8];
u_LEStartEncryption_LTK.bytebuffer[9] = mbuf[mbufi_LEStartEncryption + 9];
u_LEStartEncryption_LTK.bytebuffer[10] = mbuf[mbufi_LEStartEncryption + 10];
u_LEStartEncryption_LTK.bytebuffer[11] = mbuf[mbufi_LEStartEncryption + 11];
u_LEStartEncryption_LTK.bytebuffer[12] = mbuf[mbufi_LEStartEncryption + 12];
u_LEStartEncryption_LTK.bytebuffer[13] = mbuf[mbufi_LEStartEncryption + 13];
u_LEStartEncryption_LTK.bytebuffer[14] = mbuf[mbufi_LEStartEncryption + 14];
u_LEStartEncryption_LTK.bytebuffer[15] = mbuf[mbufi_LEStartEncryption + 15];
...
u_SMPSecurityRequest_Handle.bytebuffer[0] = mbuf[mbufi_SMPSecurityRequest + 0];
u_SMPSecurityRequest_Handle.bytebuffer[1] = mbuf[mbufi_SMPSecurityRequest + 1];
...
u_SMPPairingRandom_Handle.bytebuffer[0] = mbuf[mbufi_SMPPairingRandom + 0];
u_SMPPairingRandom_Handle.bytebuffer[1] = mbuf[mbufi_SMPPairingRandom + 1];
mbufi_SMPPairingRandom += 2;
union u_SMPPairingRandom_RandomValue_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_SMPPairingRandom_RandomValue;
u_SMPPairingRandom_RandomValue.bytebuffer[0] = mbuf[mbufi_SMPPairingRandom + 0];
u_SMPPairingRandom_RandomValue.bytebuffer[1] = mbuf[mbufi_SMPPairingRandom + 1];
u_SMPPairingRandom_RandomValue.bytebuffer[2] = mbuf[mbufi_SMPPairingRandom + 2];
u_SMPPairingRandom_RandomValue.bytebuffer[3] = mbuf[mbufi_SMPPairingRandom + 3];
u_SMPPairingRandom_RandomValue.bytebuffer[4] = mbuf[mbufi_SMPPairingRandom + 4];
u_SMPPairingRandom_RandomValue.bytebuffer[5] = mbuf[mbufi_SMPPairingRandom + 5];
u_SMPPairingRandom_RandomValue.bytebuffer[6] = mbuf[mbufi_SMPPairingRandom + 6];
u_SMPPairingRandom_RandomValue.bytebuffer[7] = mbuf[mbufi_SMPPairingRandom + 7];
u_SMPPairingRandom_RandomValue.bytebuffer[8] = mbuf[mbufi_SMPPairingRandom + 8];
u_SMPPairingRandom_RandomValue.bytebuffer[9] = mbuf[mbufi_SMPPairingRandom + 9];
u_SMPPairingRandom_RandomValue.bytebuffer[10] = mbuf[mbufi_SMPPairingRandom + 10];
u_SMPPairingRandom_RandomValue.bytebuffer[11] = mbuf[mbufi_SMPPairingRandom + 11];
u_SMPPairingRandom_RandomValue.bytebuffer[12] = mbuf[mbufi_SMPPairingRandom + 12];
u_SMPPairingRandom_RandomValue.bytebuffer[13] = mbuf[mbufi_SMPPairingRandom + 13];
u_SMPPairingRandom_RandomValue.bytebuffer[14] = mbuf[mbufi_SMPPairingRandom + 14];
u_SMPPairingRandom_RandomValue.bytebuffer[15] = mbuf[mbufi_SMPPairingRandom + 15];
...
u_ATTFindInformationError_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTFindInformationError + 0];
u_ATTFindInformationError_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTFindInformationError + 1];
...
u_ATTFindInformationError_AttributeHandle.bytebuffer[0] = mbuf[mbufi_ATTFindInformationError + 0];
u_ATTFindInformationError_AttributeHandle.bytebuffer[1] = mbuf[mbufi_ATTFindInformationError + 1];
mbufi_ATTFindInformationError += 2;
...
u_SMPSigningInformation_Handle.bytebuffer[0] = mbuf[mbufi_SMPSigningInformation + 0];
u_SMPSigningInformation_Handle.bytebuffer[1] = mbuf[mbufi_SMPSigningInformation + 1];
mbufi_SMPSigningInformation += 2;
union u_SMPSigningInformation_SignatureKey_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_SMPSigningInformation_SignatureKey;
u_SMPSigningInformation_SignatureKey.bytebuffer[0] = mbuf[mbufi_SMPSigningInformation + 0];
u_SMPSigningInformation_SignatureKey.bytebuffer[1] = mbuf[mbufi_SMPSigningInformation + 1];
u_SMPSigningInformation_SignatureKey.bytebuffer[2] = mbuf[mbufi_SMPSigningInformation + 2];
u_SMPSigningInformation_SignatureKey.bytebuffer[3] = mbuf[mbufi_SMPSigningInformation + 3];
u_SMPSigningInformation_SignatureKey.bytebuffer[4] = mbuf[mbufi_SMPSigningInformation + 4];
u_SMPSigningInformation_SignatureKey.bytebuffer[5] = mbuf[mbufi_SMPSigningInformation + 5];
u_SMPSigningInformation_SignatureKey.bytebuffer[6] = mbuf[mbufi_SMPSigningInformation + 6];
u_SMPSigningInformation_SignatureKey.bytebuffer[7] = mbuf[mbufi_SMPSigningInformation + 7];
u_SMPSigningInformation_SignatureKey.bytebuffer[8] = mbuf[mbufi_SMPSigningInformation + 8];
u_SMPSigningInformation_SignatureKey.bytebuffer[9] = mbuf[mbufi_SMPSigningInformation + 9];
u_SMPSigningInformation_SignatureKey.bytebuffer[10] = mbuf[mbufi_SMPSigningInformation + 10];
u_SMPSigningInformation_SignatureKey.bytebuffer[11] = mbuf[mbufi_SMPSigningInformation + 11];
u_SMPSigningInformation_SignatureKey.bytebuffer[12] = mbuf[mbufi_SMPSigningInformation + 12];
u_SMPSigningInformation_SignatureKey.bytebuffer[13] = mbuf[mbufi_SMPSigningInformation + 13];
u_SMPSigningInformation_SignatureKey.bytebuffer[14] = mbuf[mbufi_SMPSigningInformation + 14];
u_SMPSigningInformation_SignatureKey.bytebuffer[15] = mbuf[mbufi_SMPSigningInformation + 15];
...
u_ATTReadByTypeError_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByTypeError + 0];
u_ATTReadByTypeError_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByTypeError + 1];
mbufi_ATTReadByTypeError += 2;
union u_ATTReadByTypeError_AttributeHandle_t {
uint16_t p;
byte bytebuffer[2];
} u_ATTReadByTypeError_AttributeHandle;
u_ATTReadByTypeError_AttributeHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByTypeError + 0];
u_ATTReadByTypeError_AttributeHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByTypeError + 1];
mbufi_ATTReadByTypeError += 2;
...
u_ATTWriteResponse_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTWriteResponse + 0];
u_ATTWriteResponse_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTWriteResponse + 1];
...
u_SMPPairingConfirm_Handle.bytebuffer[0] = mbuf[mbufi_SMPPairingConfirm + 0];
u_SMPPairingConfirm_Handle.bytebuffer[1] = mbuf[mbufi_SMPPairingConfirm + 1];
mbufi_SMPPairingConfirm += 2;
union u_SMPPairingConfirm_ConfirmValue_t {
ble_random_number_t p;
byte bytebuffer[16];
} u_SMPPairingConfirm_ConfirmValue;
u_SMPPairingConfirm_ConfirmValue.bytebuffer[0] = mbuf[mbufi_SMPPairingConfirm + 0];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[1] = mbuf[mbufi_SMPPairingConfirm + 1];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[2] = mbuf[mbufi_SMPPairingConfirm + 2];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[3] = mbuf[mbufi_SMPPairingConfirm + 3];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[4] = mbuf[mbufi_SMPPairingConfirm + 4];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[5] = mbuf[mbufi_SMPPairingConfirm + 5];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[6] = mbuf[mbufi_SMPPairingConfirm + 6];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[7] = mbuf[mbufi_SMPPairingConfirm + 7];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[8] = mbuf[mbufi_SMPPairingConfirm + 8];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[9] = mbuf[mbufi_SMPPairingConfirm + 9];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[10] = mbuf[mbufi_SMPPairingConfirm + 10];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[11] = mbuf[mbufi_SMPPairingConfirm + 11];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[12] = mbuf[mbufi_SMPPairingConfirm + 12];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[13] = mbuf[mbufi_SMPPairingConfirm + 13];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[14] = mbuf[mbufi_SMPPairingConfirm + 14];
u_SMPPairingConfirm_ConfirmValue.bytebuffer[15] = mbuf[mbufi_SMPPairingConfirm + 15];
...
u_SetLEScanResponseData_Data.bytebuffer[0] = mbuf[mbufi_SetLEScanResponseData + 0];
u_SetLEScanResponseData_Data.bytebuffer[1] = mbuf[mbufi_SetLEScanResponseData + 1];
u_SetLEScanResponseData_Data.bytebuffer[2] = mbuf[mbufi_SetLEScanResponseData + 2];
u_SetLEScanResponseData_Data.bytebuffer[3] = mbuf[mbufi_SetLEScanResponseData + 3];
u_SetLEScanResponseData_Data.bytebuffer[4] = mbuf[mbufi_SetLEScanResponseData + 4];
u_SetLEScanResponseData_Data.bytebuffer[5] = mbuf[mbufi_SetLEScanResponseData + 5];
u_SetLEScanResponseData_Data.bytebuffer[6] = mbuf[mbufi_SetLEScanResponseData + 6];
u_SetLEScanResponseData_Data.bytebuffer[7] = mbuf[mbufi_SetLEScanResponseData + 7];
u_SetLEScanResponseData_Data.bytebuffer[8] = mbuf[mbufi_SetLEScanResponseData + 8];
u_SetLEScanResponseData_Data.bytebuffer[9] = mbuf[mbufi_SetLEScanResponseData + 9];
u_SetLEScanResponseData_Data.bytebuffer[10] = mbuf[mbufi_SetLEScanResponseData + 10];
u_SetLEScanResponseData_Data.bytebuffer[11] = mbuf[mbufi_SetLEScanResponseData + 11];
u_SetLEScanResponseData_Data.bytebuffer[12] = mbuf[mbufi_SetLEScanResponseData + 12];
u_SetLEScanResponseData_Data.bytebuffer[13] = mbuf[mbufi_SetLEScanResponseData + 13];
u_SetLEScanResponseData_Data.bytebuffer[14] = mbuf[mbufi_SetLEScanResponseData + 14];
u_SetLEScanResponseData_Data.bytebuffer[15] = mbuf[mbufi_SetLEScanResponseData + 15];
u_SetLEScanResponseData_Data.bytebuffer[16] = mbuf[mbufi_SetLEScanResponseData + 16];
u_SetLEScanResponseData_Data.bytebuffer[17] = mbuf[mbufi_SetLEScanResponseData + 17];
u_SetLEScanResponseData_Data.bytebuffer[18] = mbuf[mbufi_SetLEScanResponseData + 18];
u_SetLEScanResponseData_Data.bytebuffer[19] = mbuf[mbufi_SetLEScanResponseData + 19];
u_SetLEScanResponseData_Data.bytebuffer[20] = mbuf[mbufi_SetLEScanResponseData + 20];
u_SetLEScanResponseData_Data.bytebuffer[21] = mbuf[mbufi_SetLEScanResponseData + 21];
u_SetLEScanResponseData_Data.bytebuffer[22] = mbuf[mbufi_SetLEScanResponseData + 22];
u_SetLEScanResponseData_Data.bytebuffer[23] = mbuf[mbufi_SetLEScanResponseData + 23];
u_SetLEScanResponseData_Data.bytebuffer[24] = mbuf[mbufi_SetLEScanResponseData + 24];
u_SetLEScanResponseData_Data.bytebuffer[25] = mbuf[mbufi_SetLEScanResponseData + 25];
u_SetLEScanResponseData_Data.bytebuffer[26] = mbuf[mbufi_SetLEScanResponseData + 26];
u_SetLEScanResponseData_Data.bytebuffer[27] = mbuf[mbufi_SetLEScanResponseData + 27];
u_SetLEScanResponseData_Data.bytebuffer[28] = mbuf[mbufi_SetLEScanResponseData + 28];
u_SetLEScanResponseData_Data.bytebuffer[29] = mbuf[mbufi_SetLEScanResponseData + 29];
u_SetLEScanResponseData_Data.bytebuffer[30] = mbuf[mbufi_SetLEScanResponseData + 30];
...
u_SMPPairingPublicKey_Handle.bytebuffer[0] = mbuf[mbufi_SMPPairingPublicKey + 0];
u_SMPPairingPublicKey_Handle.bytebuffer[1] = mbuf[mbufi_SMPPairingPublicKey + 1];
mbufi_SMPPairingPublicKey += 2;
union u_SMPPairingPublicKey_KeyX_t {
smp_public_key_t p;
byte bytebuffer[32];
} u_SMPPairingPublicKey_KeyX;
u_SMPPairingPublicKey_KeyX.bytebuffer[0] = mbuf[mbufi_SMPPairingPublicKey + 0];
u_SMPPairingPublicKey_KeyX.bytebuffer[1] = mbuf[mbufi_SMPPairingPublicKey + 1];
u_SMPPairingPublicKey_KeyX.bytebuffer[2] = mbuf[mbufi_SMPPairingPublicKey + 2];
u_SMPPairingPublicKey_KeyX.bytebuffer[3] = mbuf[mbufi_SMPPairingPublicKey + 3];
u_SMPPairingPublicKey_KeyX.bytebuffer[4] = mbuf[mbufi_SMPPairingPublicKey + 4];
u_SMPPairingPublicKey_KeyX.bytebuffer[5] = mbuf[mbufi_SMPPairingPublicKey + 5];
u_SMPPairingPublicKey_KeyX.bytebuffer[6] = mbuf[mbufi_SMPPairingPublicKey + 6];
u_SMPPairingPublicKey_KeyX.bytebuffer[7] = mbuf[mbufi_SMPPairingPublicKey + 7];
u_SMPPairingPublicKey_KeyX.bytebuffer[8] = mbuf[mbufi_SMPPairingPublicKey + 8];
u_SMPPairingPublicKey_KeyX.bytebuffer[9] = mbuf[mbufi_SMPPairingPublicKey + 9];
u_SMPPairingPublicKey_KeyX.bytebuffer[10] = mbuf[mbufi_SMPPairingPublicKey + 10];
u_SMPPairingPublicKey_KeyX.bytebuffer[11] = mbuf[mbufi_SMPPairingPublicKey + 11];
u_SMPPairingPublicKey_KeyX.bytebuffer[12] = mbuf[mbufi_SMPPairingPublicKey + 12];
u_SMPPairingPublicKey_KeyX.bytebuffer[13] = mbuf[mbufi_SMPPairingPublicKey + 13];
u_SMPPairingPublicKey_KeyX.bytebuffer[14] = mbuf[mbufi_SMPPairingPublicKey + 14];
u_SMPPairingPublicKey_KeyX.bytebuffer[15] = mbuf[mbufi_SMPPairingPublicKey + 15];
u_SMPPairingPublicKey_KeyX.bytebuffer[16] = mbuf[mbufi_SMPPairingPublicKey + 16];
u_SMPPairingPublicKey_KeyX.bytebuffer[17] = mbuf[mbufi_SMPPairingPublicKey + 17];
u_SMPPairingPublicKey_KeyX.bytebuffer[18] = mbuf[mbufi_SMPPairingPublicKey + 18];
u_SMPPairingPublicKey_KeyX.bytebuffer[19] = mbuf[mbufi_SMPPairingPublicKey + 19];
u_SMPPairingPublicKey_KeyX.bytebuffer[20] = mbuf[mbufi_SMPPairingPublicKey + 20];
u_SMPPairingPublicKey_KeyX.bytebuffer[21] = mbuf[mbufi_SMPPairingPublicKey + 21];
u_SMPPairingPublicKey_KeyX.bytebuffer[22] = mbuf[mbufi_SMPPairingPublicKey + 22];
u_SMPPairingPublicKey_KeyX.bytebuffer[23] = mbuf[mbufi_SMPPairingPublicKey + 23];
u_SMPPairingPublicKey_KeyX.bytebuffer[24] = mbuf[mbufi_SMPPairingPublicKey + 24];
u_SMPPairingPublicKey_KeyX.bytebuffer[25] = mbuf[mbufi_SMPPairingPublicKey + 25];
u_SMPPairingPublicKey_KeyX.bytebuffer[26] = mbuf[mbufi_SMPPairingPublicKey + 26];
u_SMPPairingPublicKey_KeyX.bytebuffer[27] = mbuf[mbufi_SMPPairingPublicKey + 27];
u_SMPPairingPublicKey_KeyX.bytebuffer[28] = mbuf[mbufi_SMPPairingPublicKey + 28];
u_SMPPairingPublicKey_KeyX.bytebuffer[29] = mbuf[mbufi_SMPPairingPublicKey + 29];
u_SMPPairingPublicKey_KeyX.bytebuffer[30] = mbuf[mbufi_SMPPairingPublicKey + 30];
u_SMPPairingPublicKey_KeyX.bytebuffer[31] = mbuf[mbufi_SMPPairingPublicKey + 31];
mbufi_SMPPairingPublicKey += 32;
union u_SMPPairingPublicKey_KeyY_t {
smp_public_key_t p;
byte bytebuffer[32];
} u_SMPPairingPublicKey_KeyY;
u_SMPPairingPublicKey_KeyY.bytebuffer[0] = mbuf[mbufi_SMPPairingPublicKey + 0];
u_SMPPairingPublicKey_KeyY.bytebuffer[1] = mbuf[mbufi_SMPPairingPublicKey + 1];
u_SMPPairingPublicKey_KeyY.bytebuffer[2] = mbuf[mbufi_SMPPairingPublicKey + 2];
u_SMPPairingPublicKey_KeyY.bytebuffer[3] = mbuf[mbufi_SMPPairingPublicKey + 3];
u_SMPPairingPublicKey_KeyY.bytebuffer[4] = mbuf[mbufi_SMPPairingPublicKey + 4];
u_SMPPairingPublicKey_KeyY.bytebuffer[5] = mbuf[mbufi_SMPPairingPublicKey + 5];
u_SMPPairingPublicKey_KeyY.bytebuffer[6] = mbuf[mbufi_SMPPairingPublicKey + 6];
u_SMPPairingPublicKey_KeyY.bytebuffer[7] = mbuf[mbufi_SMPPairingPublicKey + 7];
u_SMPPairingPublicKey_KeyY.bytebuffer[8] = mbuf[mbufi_SMPPairingPublicKey + 8];
u_SMPPairingPublicKey_KeyY.bytebuffer[9] = mbuf[mbufi_SMPPairingPublicKey + 9];
u_SMPPairingPublicKey_KeyY.bytebuffer[10] = mbuf[mbufi_SMPPairingPublicKey + 10];
u_SMPPairingPublicKey_KeyY.bytebuffer[11] = mbuf[mbufi_SMPPairingPublicKey + 11];
u_SMPPairingPublicKey_KeyY.bytebuffer[12] = mbuf[mbufi_SMPPairingPublicKey + 12];
u_SMPPairingPublicKey_KeyY.bytebuffer[13] = mbuf[mbufi_SMPPairingPublicKey + 13];
u_SMPPairingPublicKey_KeyY.bytebuffer[14] = mbuf[mbufi_SMPPairingPublicKey + 14];
u_SMPPairingPublicKey_KeyY.bytebuffer[15] = mbuf[mbufi_SMPPairingPublicKey + 15];
u_SMPPairingPublicKey_KeyY.bytebuffer[16] = mbuf[mbufi_SMPPairingPublicKey + 16];
u_SMPPairingPublicKey_KeyY.bytebuffer[17] = mbuf[mbufi_SMPPairingPublicKey + 17];
u_SMPPairingPublicKey_KeyY.bytebuffer[18] = mbuf[mbufi_SMPPairingPublicKey + 18];
u_SMPPairingPublicKey_KeyY.bytebuffer[19] = mbuf[mbufi_SMPPairingPublicKey + 19];
u_SMPPairingPublicKey_KeyY.bytebuffer[20] = mbuf[mbufi_SMPPairingPublicKey + 20];
u_SMPPairingPublicKey_KeyY.bytebuffer[21] = mbuf[mbufi_SMPPairingPublicKey + 21];
u_SMPPairingPublicKey_KeyY.bytebuffer[22] = mbuf[mbufi_SMPPairingPublicKey + 22];
u_SMPPairingPublicKey_KeyY.bytebuffer[23] = mbuf[mbufi_SMPPairingPublicKey + 23];
u_SMPPairingPublicKey_KeyY.bytebuffer[24] = mbuf[mbufi_SMPPairingPublicKey + 24];
u_SMPPairingPublicKey_KeyY.bytebuffer[25] = mbuf[mbufi_SMPPairingPublicKey + 25];
u_SMPPairingPublicKey_KeyY.bytebuffer[26] = mbuf[mbufi_SMPPairingPublicKey + 26];
u_SMPPairingPublicKey_KeyY.bytebuffer[27] = mbuf[mbufi_SMPPairingPublicKey + 27];
u_SMPPairingPublicKey_KeyY.bytebuffer[28] = mbuf[mbufi_SMPPairingPublicKey + 28];
u_SMPPairingPublicKey_KeyY.bytebuffer[29] = mbuf[mbufi_SMPPairingPublicKey + 29];
u_SMPPairingPublicKey_KeyY.bytebuffer[30] = mbuf[mbufi_SMPPairingPublicKey + 30];
u_SMPPairingPublicKey_KeyY.bytebuffer[31] = mbuf[mbufi_SMPPairingPublicKey + 31];
mbufi_SMPPairingPublicKey += 32;
...
u_SetEventMask_Mask.bytebuffer[0] = mbuf[mbufi_SetEventMask + 0];
u_SetEventMask_Mask.bytebuffer[1] = mbuf[mbufi_SetEventMask + 1];
u_SetEventMask_Mask.bytebuffer[2] = mbuf[mbufi_SetEventMask + 2];
u_SetEventMask_Mask.bytebuffer[3] = mbuf[mbufi_SetEventMask + 3];
u_SetEventMask_Mask.bytebuffer[4] = mbuf[mbufi_SetEventMask + 4];
u_SetEventMask_Mask.bytebuffer[5] = mbuf[mbufi_SetEventMask + 5];
u_SetEventMask_Mask.bytebuffer[6] = mbuf[mbufi_SetEventMask + 6];
u_SetEventMask_Mask.bytebuffer[7] = mbuf[mbufi_SetEventMask + 7];
...
u_LEEncryptCompleted_Encrypted.bytebuffer[0] = mbuf[mbufi_LEEncryptCompleted + 0];
u_LEEncryptCompleted_Encrypted.bytebuffer[1] = mbuf[mbufi_LEEncryptCompleted + 1];
u_LEEncryptCompleted_Encrypted.bytebuffer[2] = mbuf[mbufi_LEEncryptCompleted + 2];
u_LEEncryptCompleted_Encrypted.bytebuffer[3] = mbuf[mbufi_LEEncryptCompleted + 3];
u_LEEncryptCompleted_Encrypted.bytebuffer[4] = mbuf[mbufi_LEEncryptCompleted + 4];
u_LEEncryptCompleted_Encrypted.bytebuffer[5] = mbuf[mbufi_LEEncryptCompleted + 5];
u_LEEncryptCompleted_Encrypted.bytebuffer[6] = mbuf[mbufi_LEEncryptCompleted + 6];
u_LEEncryptCompleted_Encrypted.bytebuffer[7] = mbuf[mbufi_LEEncryptCompleted + 7];
u_LEEncryptCompleted_Encrypted.bytebuffer[8] = mbuf[mbufi_LEEncryptCompleted + 8];
u_LEEncryptCompleted_Encrypted.bytebuffer[9] = mbuf[mbufi_LEEncryptCompleted + 9];
u_LEEncryptCompleted_Encrypted.bytebuffer[10] = mbuf[mbufi_LEEncryptCompleted + 10];
u_LEEncryptCompleted_Encrypted.bytebuffer[11] = mbuf[mbufi_LEEncryptCompleted + 11];
u_LEEncryptCompleted_Encrypted.bytebuffer[12] = mbuf[mbufi_LEEncryptCompleted + 12];
u_LEEncryptCompleted_Encrypted.bytebuffer[13] = mbuf[mbufi_LEEncryptCompleted + 13];
u_LEEncryptCompleted_Encrypted.bytebuffer[14] = mbuf[mbufi_LEEncryptCompleted + 14];
u_LEEncryptCompleted_Encrypted.bytebuffer[15] = mbuf[mbufi_LEEncryptCompleted + 15];
...
u_ATTReadByTypeRequest_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByTypeRequest + 0];
u_ATTReadByTypeRequest_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByTypeRequest + 1];
mbufi_ATTReadByTypeRequest += 2;
union u_ATTReadByTypeRequest_StartingHandle_t {
uint16_t p;
byte bytebuffer[2];
} u_ATTReadByTypeRequest_StartingHandle;
u_ATTReadByTypeRequest_StartingHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByTypeRequest + 0];
u_ATTReadByTypeRequest_StartingHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByTypeRequest + 1];
mbufi_ATTReadByTypeRequest += 2;
union u_ATTReadByTypeRequest_EndingHandle_t {
uint16_t p;
byte bytebuffer[2];
} u_ATTReadByTypeRequest_EndingHandle;
u_ATTReadByTypeRequest_EndingHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByTypeRequest + 0];
u_ATTReadByTypeRequest_EndingHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByTypeRequest + 1];
mbufi_ATTReadByTypeRequest += 2;
union u_ATTReadByTypeRequest_AttributeType_t {
ble_uuid_t p;
byte bytebuffer[16];
} u_ATTReadByTypeRequest_AttributeType;
u_ATTReadByTypeRequest_AttributeType.bytebuffer[0] = mbuf[mbufi_ATTReadByTypeRequest + 0];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[1] = mbuf[mbufi_ATTReadByTypeRequest + 1];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[2] = mbuf[mbufi_ATTReadByTypeRequest + 2];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[3] = mbuf[mbufi_ATTReadByTypeRequest + 3];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[4] = mbuf[mbufi_ATTReadByTypeRequest + 4];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[5] = mbuf[mbufi_ATTReadByTypeRequest + 5];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[6] = mbuf[mbufi_ATTReadByTypeRequest + 6];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[7] = mbuf[mbufi_ATTReadByTypeRequest + 7];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[8] = mbuf[mbufi_ATTReadByTypeRequest + 8];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[9] = mbuf[mbufi_ATTReadByTypeRequest + 9];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[10] = mbuf[mbufi_ATTReadByTypeRequest + 10];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[11] = mbuf[mbufi_ATTReadByTypeRequest + 11];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[12] = mbuf[mbufi_ATTReadByTypeRequest + 12];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[13] = mbuf[mbufi_ATTReadByTypeRequest + 13];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[14] = mbuf[mbufi_ATTReadByTypeRequest + 14];
u_ATTReadByTypeRequest_AttributeType.bytebuffer[15] = mbuf[mbufi_ATTReadByTypeRequest + 15];
...
u_SMPPairingRequest_Handle.bytebuffer[0] = mbuf[mbufi_SMPPairingRequest + 0];
u_SMPPairingRequest_Handle.bytebuffer[1] = mbuf[mbufi_SMPPairingRequest + 1];
...
u_ATTReadByGroupTypeResponse_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByGroupTypeResponse + 0];
u_ATTReadByGroupTypeResponse_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByGroupTypeResponse + 1];
...
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[0] = mbuf[mbufi_ATTReadByGroupTypeResponse + 0];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[1] = mbuf[mbufi_ATTReadByGroupTypeResponse + 1];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[2] = mbuf[mbufi_ATTReadByGroupTypeResponse + 2];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[3] = mbuf[mbufi_ATTReadByGroupTypeResponse + 3];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[4] = mbuf[mbufi_ATTReadByGroupTypeResponse + 4];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[5] = mbuf[mbufi_ATTReadByGroupTypeResponse + 5];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[6] = mbuf[mbufi_ATTReadByGroupTypeResponse + 6];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[7] = mbuf[mbufi_ATTReadByGroupTypeResponse + 7];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[8] = mbuf[mbufi_ATTReadByGroupTypeResponse + 8];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[9] = mbuf[mbufi_ATTReadByGroupTypeResponse + 9];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[10] = mbuf[mbufi_ATTReadByGroupTypeResponse + 10];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[11] = mbuf[mbufi_ATTReadByGroupTypeResponse + 11];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[12] = mbuf[mbufi_ATTReadByGroupTypeResponse + 12];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[13] = mbuf[mbufi_ATTReadByGroupTypeResponse + 13];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[14] = mbuf[mbufi_ATTReadByGroupTypeResponse + 14];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[15] = mbuf[mbufi_ATTReadByGroupTypeResponse + 15];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[16] = mbuf[mbufi_ATTReadByGroupTypeResponse + 16];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[17] = mbuf[mbufi_ATTReadByGroupTypeResponse + 17];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[18] = mbuf[mbufi_ATTReadByGroupTypeResponse + 18];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[19] = mbuf[mbufi_ATTReadByGroupTypeResponse + 19];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[20] = mbuf[mbufi_ATTReadByGroupTypeResponse + 20];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[21] = mbuf[mbufi_ATTReadByGroupTypeResponse + 21];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[22] = mbuf[mbufi_ATTReadByGroupTypeResponse + 22];
u_ATTReadByGroupTypeResponse_AttributeDataList.bytebuffer[23] = mbuf[mbufi_ATTReadByGroupTypeResponse + 23];
...
u_ATTReadByGroupTypeError_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByGroupTypeError + 0];
u_ATTReadByGroupTypeError_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByGroupTypeError + 1];
...
u_ATTReadByGroupTypeError_AttributeHandle.bytebuffer[0] = mbuf[mbufi_ATTReadByGroupTypeError + 0];
u_ATTReadByGroupTypeError_AttributeHandle.bytebuffer[1] = mbuf[mbufi_ATTReadByGroupTypeError + 1];
mbufi_ATTReadByGroupTypeError += 2;
...
u_SMPIdentityAddressInformation_Handle.bytebuffer[0] = mbuf[mbufi_SMPIdentityAddressInformation + 0];
u_SMPIdentityAddressInformation_Handle.bytebuffer[1] = mbuf[mbufi_SMPIdentityAddressInformation + 1];
...
u_SMPIdentityAddressInformation_Address.bytebuffer[0] = mbuf[mbufi_SMPIdentityAddressInformation + 0];
u_SMPIdentityAddressInformation_Address.bytebuffer[1] = mbuf[mbufi_SMPIdentityAddressInformation + 1];
u_SMPIdentityAddressInformation_Address.bytebuffer[2] = mbuf[mbufi_SMPIdentityAddressInformation + 2];
u_SMPIdentityAddressInformation_Address.bytebuffer[3] = mbuf[mbufi_SMPIdentityAddressInformation + 3];
u_SMPIdentityAddressInformation_Address.bytebuffer[4] = mbuf[mbufi_SMPIdentityAddressInformation + 4];
u_SMPIdentityAddressInformation_Address.bytebuffer[5] = mbuf[mbufi_SMPIdentityAddressInformation + 5];
...
u_EncryptionChanged_ConnectionHandle.bytebuffer[0] = mbuf[mbufi_EncryptionChanged + 0];
u_EncryptionChanged_ConnectionHandle.bytebuffer[1] = mbuf[mbufi_EncryptionChanged + 1];
...
void forward_Main_send_tryggi3d_bpsensor_connected(struct Main_Instance *_instance){
if(_instance->id_tryggi3d == main_var.id_tryggi3d) {
forward_MQTT_Main_send_tryggi3d_bpsensor_connected(_instance);
}
}
void forward_Main_send_tryggi3d_bpsensor_disconnected(struct Main_Instance *_instance){
if(_instance->id_tryggi3d == main_var.id_tryggi3d) {
forward_MQTT_Main_send_tryggi3d_bpsensor_disconnected(_instance);
}
}
void forward_Main_send_tryggi3d_bpsensor_gw_exit(struct Main_Instance *_instance){
if(_instance->id_tryggi3d == main_var.id_tryggi3d) {
forward_MQTT_Main_send_tryggi3d_bpsensor_gw_exit(_instance);
}
}
void forward_Main_send_tryggi3d_bpsensor_gw_ready(struct Main_Instance *_instance){
if(_instance->id_tryggi3d == main_var.id_tryggi3d) {
forward_MQTT_Main_send_tryggi3d_bpsensor_gw_ready(_instance);
}
}
void forward_Main_send_tryggi3d_bpsensor_measurement(struct Main_Instance *_instance, int16_t PressureSystolic, int16_t PressureDiastolic, int16_t PressureMean, int16_t PulseRate, uint8_t IrregularPulse){
if(_instance->id_tryggi3d == main_var.id_tryggi3d) {
forward_MQTT_Main_send_tryggi3d_bpsensor_measurement(_instance, PressureSystolic, PressureDiastolic, PressureMean, PulseRate, IrregularPulse);
}
}
void forward_Main_send_tryggi3d_bpsensor_error(struct Main_Instance *_instance){
if(_instance->id_tryggi3d == main_var.id_tryggi3d) {
forward_MQTT_Main_send_tryggi3d_bpsensor_error(_instance);
}
}
void forward_Main_send_tryggi3d_bpsensor_batterylevel(struct Main_Instance *_instance, int16_t percent){
if(_instance->id_tryggi3d == main_var.id_tryggi3d) {
forward_MQTT_Main_send_tryggi3d_bpsensor_batterylevel(_instance, percent);
}
}
...
void initialize_configuration_BPSensorGateway() {
// Initialize connectors
register_external_Main_send_tryggi3d_bpsensor_connected_listener(&forward_Main_send_tryggi3d_bpsensor_connected);
register_external_Main_send_tryggi3d_bpsensor_disconnected_listener(&forward_Main_send_tryggi3d_bpsensor_disconnected);
register_external_Main_send_tryggi3d_bpsensor_error_listener(&forward_Main_send_tryggi3d_bpsensor_error);
register_external_Main_send_tryggi3d_bpsensor_measurement_listener(&forward_Main_send_tryggi3d_bpsensor_measurement);
register_external_Main_send_tryggi3d_bpsensor_gw_ready_listener(&forward_Main_send_tryggi3d_bpsensor_gw_ready);
register_external_Main_send_tryggi3d_bpsensor_gw_exit_listener(&forward_Main_send_tryggi3d_bpsensor_gw_exit);
register_external_Main_send_tryggi3d_bpsensor_batterylevel_listener(&forward_Main_send_tryggi3d_bpsensor_batterylevel);
...
register_Main_send_Connecter_Connect_listener(&enqueue_Main_send_Connecter_Connect);
register_Main_send_Connecter_ConnectTo_listener(&enqueue_Main_send_Connecter_ConnectTo);
register_Main_send_Connecter_ConnectToU_listener(&enqueue_Main_send_Connecter_ConnectToU);
register_Main_send_Connecter_Stop_listener(&enqueue_Main_send_Connecter_Stop);
register_Main_send_Connecter_Encrypt_listener(&enqueue_Main_send_Connecter_Encrypt);
register_Main_send_ATT_ATTFindInformationRequest_listener(&enqueue_Main_send_ATT_ATTFindInformationRequest);
register_Main_send_ATT_ATTFindInformationResponse_listener(&enqueue_Main_send_ATT_ATTFindInformationResponse);
register_Main_send_ATT_ATTFindInformationError_listener(&enqueue_Main_send_ATT_ATTFindInformationError);
register_Main_send_ATT_ATTReadByTypeRequest_listener(&enqueue_Main_send_ATT_ATTReadByTypeRequest);
register_Main_send_ATT_ATTReadByTypeResponse_listener(&enqueue_Main_send_ATT_ATTReadByTypeResponse);
register_Main_send_ATT_ATTReadByTypeError_listener(&enqueue_Main_send_ATT_ATTReadByTypeError);
register_Main_send_ATT_ATTReadRequest_listener(&enqueue_Main_send_ATT_ATTReadRequest);
register_Main_send_ATT_ATTReadResponse_listener(&enqueue_Main_send_ATT_ATTReadResponse);
register_Main_send_ATT_ATTReadError_listener(&enqueue_Main_send_ATT_ATTReadError);
register_Main_send_ATT_ATTReadByGroupTypeRequest_listener(&enqueue_Main_send_ATT_ATTReadByGroupTypeRequest);
register_Main_send_ATT_ATTReadByGroupTypeResponse_listener(&enqueue_Main_send_ATT_ATTReadByGroupTypeResponse);
register_Main_send_ATT_ATTReadByGroupTypeError_listener(&enqueue_Main_send_ATT_ATTReadByGroupTypeError);
register_Main_send_ATT_ATTWriteRequest_listener(&enqueue_Main_send_ATT_ATTWriteRequest);
register_Main_send_ATT_ATTWriteResponse_listener(&enqueue_Main_send_ATT_ATTWriteResponse);
register_Main_send_ATT_ATTWriteError_listener(&enqueue_Main_send_ATT_ATTWriteError);
register_Main_send_ATT_ATTWriteCommand_listener(&enqueue_Main_send_ATT_ATTWriteCommand);
register_Main_send_ATT_ATTHandleValueNotification_listener(&enqueue_Main_send_ATT_ATTHandleValueNotification);
register_Main_send_ATT_ATTHandleValueIndication_listener(&enqueue_Main_send_ATT_ATTHandleValueIndication);
register_Main_send_ATT_ATTHandleValueConfirmation_listener(&enqueue_Main_send_ATT_ATTHandleValueConfirmation);
...
main_var.id_tryggi3d = add_instance( (void*) &main_var);
...
main_var.Main_States_Standby_Sync_State = MAIN_STATES_STANDBY_SYNC_READBATTERY_STATE;
main_var.Main_BatteryValueHandle_var = 0x002B;
main_var.Main_BPAddress_var = "5C:31:3E:5F:4A:5C";
main_var.Main_BloodPressureConfigurationHandle_var = 0x0013;
main_var.Main_BloodPressureValueHandle_var = 0x0012;
...
int main(int argc, char *argv[]) {
    ...
    initialize_configuration_BPSensorGateway();
...
emptyEventConsumed += Main_handle_empty_event(&main_var);
